...
class ReceiptVoucher extends Model {
    ...
    protected $fillable = ['voucher_id','debit','credit','difference'];
    ...
    protected static function boot()
{
    ...
    public function ReceiptVoucherAdd()
    {
        return $this->hasMany('App\Models\ReceiptVoucherEntry')->where('status',1);
    }
}
