...
class QuotationController extends Controller
{
	...
	public function save(Request $request) {
		...
		$this->quotation->create(Input::all());
	...
	public function checkRefNo() {
		...
		$check = $this->quotation->check_reference_no(Input::get('reference_no'), Input::get('id'));
	...
	// {
	// 	$this->accountmaster->update($id, Input::all());
	...
	public function checkVchrNo() { 
		...
		$check = $this->quotation->check_voucher_no(Input::get('voucher_no'), Input::get('id'));
		$isAvailable = ($check) ? false : true;
		echo json_encode(array(
							'valid' => $isAvailable,
						));
	...
	public function getSearch()
	{
	   // echo '<pre>';print_r(Input::all());exit;
		...
		$reports = $this->quotation->getPendingReport(Input::all());
	...
	public function dataExport()
	{
		...
		Input::merge(['job_id' => Input::get('job_id')]);
		$reports = $this->quotation->getPendingReport(Input::all());
