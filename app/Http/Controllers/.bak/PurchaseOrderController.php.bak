...
class PurchaseOrderController extends Controller
{
	...
	public function save(Request $request) {
		...
		if( $this->purchase_order->create(Input::all()) )
	...
	public function checkRefNo() {
		...
		$check = $this->purchase_order->check_reference_no(Input::get('reference_no'), Input::get('id'));
	...
	public function update(Request $request)
	{
		...
		if($this->purchase_order->update($id, Input::all()))
	...
	public function checkVchrNo() { 
		...
		$check = $this->purchase_order->check_voucher_no(Input::get('voucher_no'), Input::get('id'));
		$isAvailable = ($check) ? false : true;
		echo json_encode(array(
							'valid' => $isAvailable,
						));
	...
	public function getSearch2()
	{
		...
		//$report = $this->purchase_order->getPendingReport(Input::all());
