...
class VatReportController extends Controller
{
	...
	public function getSearch()
	{
		...
		Input::merge(['search_type' => 'detail']);
			//$result = $this->accountmaster->getVatDetail(Input::all()); echo '<pre>';print_r($result);exit;
			$result = $this->getVatSummary( $this->GroupByAccount($this->accountmaster->getVatDetail(Input::all())) ); //echo '<pre>';print_r($result);exit;
	...
	//	echo '<pre>';print_r($reports);exit;
		return view('body.vatreport.'.$view)
					...
					->withCodetype($code_type)
				     ->withDepartment(Input::get('department_id'))
					->withType($type)
					->withPayable($payable)
