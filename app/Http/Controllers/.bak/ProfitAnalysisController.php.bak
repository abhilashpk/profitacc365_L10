...
//$repor=  $this->profitCalc($this->makeTree($this->sales_invoice->getProfitSummary(Input::all())));
//echo '<pre>';print_r($repor); exit();
			
			//$report = $this->sales_invoice->getProfitSummary(Input::all()); echo '<pre>';print_r($report);exit;
			//$res=$this->makeTree( $this->sales_invoice->getProfitSummary(Input::all()) ); echo '<pre>';print_r($res);exit;
