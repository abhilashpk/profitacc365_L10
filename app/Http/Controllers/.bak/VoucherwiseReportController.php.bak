...
class VoucherwiseReportController extends Controller
{
	...
	protected function index() {
		...
		if(Input::all()!=null) { 
			$reports = $this->voucherwise_report->getReportResult(Input::all()); 
		}
		...
		return view('body.voucherwisereport.index')
					->withReports($reports)
					->withType(Input::get('voucher_type'))
					->withDateto('')
					->withDatefrom('')
	...
	public function printReport($id,$type) { 
		...
		return view('body.voucherwisereport.print')
					...
					->withTitles($titles)
					->withDateto(Input::get('date_from'))
					->withDatefrom(Input::get('date_to'))
					->withData($data);
	...
	public function getPrint()
	{
		...
		$results = $this->voucherwise_report->getReportResult(Input::all());  
		//echo '<pre>';print_r($results);exit;
		if(Input::get('voucher_type')=='ALL')
	...
	public function getPisiPrint()
	{
		$data = array();
		$results = $this->voucherwise_report->getReportPisi(Input::all());
		//echo '<pre>';print_r($results);exit;
		...
		return view('body.voucherwisereport.pisipreprint')
					...
					->withDateto(Input::get('date_from'))
					->withDatefrom(Input::get('date_to'))
					->withCustomer(Input::get('customer_id'))
					->withJob(Input::get('job_id'))
					->withData($data);
	}
	...
	public function dataExport()
	{
		...
		$results = $this->voucherwise_report->getReportResult(Input::all());  //echo '<pre>';print_r($results);exit;
		if(Input::get('voucher_type')=='ALL')
	...
	public function datapisiExport()
	{
		$data = array();
	...
	public function getPisirtnPrint()
	{
		$data = array();
		$results = $this->voucherwise_report->getReportPisi(Input::all());
		//echo '<pre>';print_r($results);exit;
	...
	public function getPisirvPrint()
	{
		$data = array();
		$results = $this->voucherwise_report->getReportPisi(Input::all());
		$rvres = $this->voucherwise_report->getReportPisiRv(Input::all());
	...
	public function datapisirvExport()
	{
		$data = array();
		$voucher_head = 'Submission of Payment Report & Sales Invoice Report';
	...
	{
		$data = array();
		$results = $this->check_balance($this->voucherwise_report->getReportPisiPending(Input::all()));
		//echo '<pre>';print_r($results);exit;
	...
	public function datapisisummaryExport()
	{
		$data = array();
