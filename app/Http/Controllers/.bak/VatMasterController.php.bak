...
class VatMasterController extends Controller
{
	...
	public function save() {
		try { 
			$this->vat_master->create(Input::all());
	...
	{	//echo '<pre>';print_r(Input::all());exit;
		$this->vat_master->update($id, Input::all());
	...
	public function checkcode() {
		...
		$check = $this->vat_master->check_vat_master_code(Input::get('code'), Input::get('id'));
	...
	public function checkname() {
		...
		$check = $this->vat_master->check_vat_master_name(Input::get('name'), Input::get('id'));
		$isAvailable = ($check) ? false : true;
		echo json_encode(array(
							'valid' => $isAvailable,
						));
