...
class LocationTransferController extends Controller
{
   ...
   protected $location_transfer;
	...
	public function save() {
		...
		if( $this->location_transfer->create(Input::all()) )
	...
	public function checkRefNo() {
		...
		$check = $this->location_transfer->check_reference_no(Input::get('reference_no'), Input::get('id'));
	...
	public function update($id)
	{
		...
		if($this->location_transfer->update($id, Input::all()))
