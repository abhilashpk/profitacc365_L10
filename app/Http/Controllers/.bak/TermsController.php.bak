...
class TermsController extends Controller
{
	...
	{
		$this->terms->update($id, Input::all());//print_r(Input::all());exit;
	...
	public function checkcode() {
		...
		$check = $this->terms->check_terms_code(Input::get('code'), Input::get('id'));
	...
	public function checkname() {
		...
		$check = $this->terms->check_terms_name(Input::get('name'), Input::get('id'));
		$isAvailable = ($check) ? false : true;
		echo json_encode(array(
							'valid' => $isAvailable,
						));
