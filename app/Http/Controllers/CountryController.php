...
class CountryController extends Controller
{
	...
	{
		$this->country->update($id, $request->all());//print_r($request->all());exit;
	...
	public function checkcode(Request $request) {
		...
		$check = $this->country->check_country_code($request->get('code'), $request->get('id'));
	...
	public function checkname(Request $request) {
		...
		$check = $this->country->check_country_name($request->get('name'), $request->get('id'));
		$isAvailable = ($check) ? false : true;
		echo json_encode(array(
							'valid' => $isAvailable,
						));
