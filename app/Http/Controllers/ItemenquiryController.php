...
class ItemenquiryController extends Controller
{
	...
	public function ajaxPaging(Request $request)
	{
	 ...
	 public function details(Request $request) {
		...
		$data = array();
		$items = $this->itemmaster->getItemEnquiry($request->all()); //echo '<pre>';print_r($items);exit;
		$heading = $this->getSearchType($request->get('search_type'));
		return view('body.itemenquiry.details')
					->withItems($items)
					->withItemid($request->get('item_id'))
					->withCussupid($request->get('custsupp_id'))
	...
	public function printItem($id, $type, Request $request) { 
