...
class WageEntryRepository extends AbstractValidator implements WageEntryInterface {
	...
	private function setInputOthersValue($attributes) {
		...
		$objWageEntryOthers->oth_allowance1 = $attributes['oth_allowance1'];
		$objWageEntryOthers->desc_allowance1 = $attributes['desc_allowance1'];
		$objWageEntryOthers->oth_allowance2 = $attributes['oth_allowance2'];
		$objWageEntryOthers->desc_allowance2 = $attributes['desc_allowance2'];
		$objWageEntryOthers->oth_allowance3 = $attributes['oth_allowance3'];
		$objWageEntryOthers->desc_allowance3 = $attributes['desc_allowance3'];
		$objWageEntryOthers->oth_allowance4 = $attributes['oth_allowance4'];
		$objWageEntryOthers->desc_allowance4 = $attributes['desc_allowance4'];
		
		$objWageEntryOthers->oth_deduction1 = $attributes['oth_deduction1'];
		$objWageEntryOthers->desc_deduction1 = $attributes['desc_deduction1'];
		$objWageEntryOthers->oth_deduction2 = $attributes['oth_deduction2'];
		$objWageEntryOthers->desc_deduction2 = $attributes['desc_deduction2'];
		$objWageEntryOthers->oth_deduction3 = $attributes['oth_deduction3'];
		$objWageEntryOthers->desc_deduction3 = $attributes['desc_deduction3'];
		$objWageEntryOthers->oth_deduction4 = $attributes['oth_deduction4'];
		$objWageEntryOthers->desc_deduction4 = $attributes['desc_deduction4'];
	...
	public function getPayslipMonth($id,$month) {
