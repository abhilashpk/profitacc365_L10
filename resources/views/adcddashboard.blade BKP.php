...
@section('content')
    <!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <br/>
    <div  class="portlet-title bg-info" style="background-color:#85d3ef">
            <div class="row">
                    ...
                    <div class="panel panel-widget">
						...
						<div class="slimScrollDiv" style="position: relative; overflow-y: scroll; width: auto; height: 280px;">
                            ...
                            <?php foreach($custdat as $row) { ?>
                                <li> {{$row->master_name}}
                                    <span class="right label label-success pull-right">{{$row->cl_balance}}</span>
                                </li>
                            <?php } ?>
                            </ul>
						</div>
            ...
            <div class="row">
                 <div class="col-lg-4 col-sm-6 col-xs-12">
                    <div class="panel panel-widget">
                        <div class="panel-heading" style="background-color:#86C5FF">
                            <h3 class="panel-title" style="color:#428BCA"><i class="fa fa-fw fa-shopping-cart"></i><font color="white"> Top Products</font></h3>
                        </div>
                        <div class="panel-body"  style="background-color:#d6eef8" style="padding:0px !important;">
                            <ul class="basic-list">
                ...
                <div class="col-lg-4 col-sm-6 col-xs-12">
                    <div class="panel">
                        <div class="panel-heading" style="background-color:#86C5FF">
                            <h3 class="panel-title" style="color:#428BCA"><i class="fa fa-fw fa-money"></i><font color="white"> Outstanding</font></h3>
                        </div>
                        <div class="panel-body" style="background-color:#d6eef8">
                            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 col-xs-12">
                    <div class="panel panel-widget">
                        <div class="panel-heading" style="background-color:#86C5FF">
                            <h3 class="panel-title" style="color:#428BCA !important;"> <i class="fa fa-fw fa-user"></i><font color="white"> Top Salesman</font></h3>
                        </div>
                        <div class="panel-body" style="background-color:#d6eef8" style="padding:0px !important;">
                            <ul class="basic-list">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="panel">
                        <div class="panel-heading" style="background-color:#86C5FF">
                            <h3 class="panel-title" style="color:#428BCA !important;"><i class="fa fa-fw fa-calendar-o"></i><font color="white"> Expiry Details</font></h3>
                        </div>
                        <div class="panel-body" style="background-color:#d6eef8" style="padding:0px !important;">
                ...
                <div class="col-md-8">
                     <div class="panel panel-default1">
                         <div class="panel-heading" style="background-color:#86C5FF">
                            <h3 class="panel-title" style="padding-bottom:10px; color:#428BCA !important;"><i class="fa fa-fw fa-list-alt"></i><font color="white"> PDC Validity Details</font></h3>
