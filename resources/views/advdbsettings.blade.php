                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
							<div class="pull-right">
								<a href="{{ url('dashboard/get_advsettings') }}" class="btn btn-warning"><i class="fa fa-fw fa-refresh"></i> Refresh</a>
...
$(document).on('click', '.save', function(e)  {
	...
	console.log(id);
	$.ajax({
		url: "{{ url('dashboard/advsetting_update/') }}",
		type: 'get',
...
$(document).on('click', '.delete', function(e)  { 
  ...
  var con = confirm('Are you sure delete this ?');
	if(con==true) {
		...
		$.ajax({
			url: "{{ url('dashboard/advsetting_delete/') }}/"+id,
			type: 'get',
			//data: 'id='+id,
			success: function(data) {
