                     ...
                     <div class="panel panel-default1">
                        ...
                        <div class="panel-body" style="background-color:#d6eef8">
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="pdcr2">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default1">
                            <div class="panel-heading" style="background-color:#86C5FF">
                                <ul class="nav nav-tabs nav-float" role="tablist">
                                    <li class="active">
                                        <a href="#pdcr" role="tab" data-toggle="tab">PDC Details</a>
                                    </li>
                                    <li>
                                        <a href="#contract" role="tab" data-toggle="tab">Contract Expiry</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="panel-body" style="background-color:#d6eef8">
                                <div class="tab-content">
                                        ...
                                        <div class="row" style="padding:10px;">
                                            <table class="table table-striped" id="tableBank">
                                                <thead>
                                                    ...
                                                    <tbody>
                                                    @foreach($accounts as $pd)
                                                    <tr>
                                                        <td>{{ $pd->category }}</td>
                                                        <td>{{ number_format(abs($pd->cl_balance),2) }}</td>
                                                        <td><a href="#" class="btn btn-info {{$pd->category}}">View</a></td>
                                                    </tr>
                                                    @endforeach
                                                    </tbody>
                                                </tbody>
                                    ...
                                    <div class="tab-pane fade in" id="contract">
                                        ...
                                        <div class="row" style="padding:10px;" id="bdata">
                                            
                                        </div>

                                        <div id="cont-list">
                                            <div class="row" style="padding:10px;" id="contractData">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                     <div class="panel panel-default1">
                        ...
                        <div class="panel-body" style="background-color:#d6eef8">
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="pdcr1">
                                    <div class="row" style="padding:10px;">
                                    <table class="table table-striped" id="tableBank">
                                        <thead>
                                            <tr>
...
$(document).on('click', '.PDCR', function(e) {  
    $('#pdcr-list1').toggle();
});

$(document).on('click', '.PDCI', function(e) {  
    $('#pdci-list1').toggle();
});

$(document).on('click', '.view-cont', function(e) {  
   
    var contractUrl = "{{ url('dashboard/get_contract_expiry/') }}"; 
   $('#contractData').load(contractUrl, function(result) {
      $('#myModal').modal({show:true});
   });
    $('#cont-list').toggle();
});
...
$('#create').on('click', function(e) { 
    ...
    $(document).on('change', '#sortBy', function(e) {  
        var sval = this.value;
        var contractUrl = "{{ url('dashboard/get_building/') }}"; 
        $('#bdata').load(contractUrl+'/'+sval, function(result) {
            //$('#myModal').modal({show:true});
         });
    });	
