            ...
            <ol class="breadcrumb">
                ...
                @can('db-setting')
                     <div class="pull-right">
							 ...
							 <a href="{{ url('dashboard/get_settings') }}" target="_blank" class="btn btn-info btn-sm">
           ...
           @foreach($dbsettings as $db) 
                ...
                <!-- BEGIN Portlet PORTLET-->
                   ...
                   <div class=" portlet box">
                        ...
                        <div class="portlet-body bg-dng-new">
							<div class="portlet">
								 <div class="col-md-6" ><a href="{{ URL::to('purchase_order/add') }}"><img src="{{asset('assets/icons/add-proforma.png')}}"><span class="info-hd"> New Purchase</span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('purchase_order') }}"><img src="{{asset('assets/icons/view-proforma.png')}}"><span class="info-hd"> View Purchase</span></a> </div>
