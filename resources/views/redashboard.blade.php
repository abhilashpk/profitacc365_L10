		...
		<section class="content">
            <div class="row ui-sortable" id="sortable_portlets">
                <div class="col-md-12 sortable">
					...
					<div class=" portlet box">
						<div class="portlet-title bg-info">
                            <div class="caption">
                                <i class="fa fa-fw fa-bars"></i> Building Master 
                            </div>
                        </div>
                        <div class="portlet-body bg-inf-new">
							<div class="portlet">
								 <div class="col-md-6" ><a href="{{ URL::to('buildingmaster/add') }}"><img src="{{asset('assets/icons/building__coimbra.png')}}"><span class="info-hd"> New Building </span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('buildingmaster') }}"><img src="{{asset('assets/icons/offices_building_flats.png')}}"><span class="info-hd"> View Building </span></a> </div>
                            </div>
							<p></br></br></p>
                        </div>
					...
					<div class=" portlet box">
						<div class="portlet-title bg-danger">
                            <div class="caption">
                                <i class="fa fa-fw fa-bars"></i> Contract Entry 
                            </div>
                        </div>
                        <div class="portlet-body bg-dng-new">
							<div class="portlet">
								 <div class="col-md-6" ><a href="{{ URL::to('contra_type/add') }}"><img src="{{asset('assets/icons/add-prchs.png')}}"><span class="info-hd"> New Entry </span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('contra_type') }}"><img src="{{asset('assets/icons/view-prchs.png')}}"><span class="info-hd"> View Entry </span></a> </div>
                            </div>
							<p></br></br></p>
                        </div>
                    ...
                    <div class=" portlet box">
						<div class="portlet-title bg-warning">
                            <div class="caption">
                                <i class="fa fa-fw fa-bars"></i> Tenant
                            </div>
                        </div>
                        <div class="portlet-body bg-wrn-new"> 
                            <div class="portlet">
								 <div class="col-md-6"><a href="{{ URL::to('account_master/add') }}"><img src="{{asset('assets/icons/add-supplier.png')}}"><span class="info-hd"> New Tenant</span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('account_master') }}"><img src="{{asset('assets/icons/view-supplier.png')}}"><span class="info-hd"> View Tenant</span></a> </div>
                            </div>
							<p></br></br></p>
                        </div>
                    </div>
				...
				<div class=" portlet box">
						<div class="portlet-title bg-danger">
                            <div class="caption">
                                <i class="fa fa-fw fa-bars"></i> Sales Split
                            </div>
                        </div>
                        <div class="portlet-body bg-dng-new">
							<div class="portlet">
								 <div class="col-md-6" ><a href="{{ URL::to('sales_split/add') }}"><img src="{{asset('assets/icons/add-sale.png')}}"><span class="info-hd"> New Entry </span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('sales_split') }}"><img src="{{asset('assets/icons/view-sale.png')}}"><span class="info-hd"> View Entry </span></a> </div>
                            </div>
							<p></br></br></p>
                        </div>
				...
				<div class="col-md-6 sortable">
					...
					<div class=" portlet box">
						<div class="portlet-title bg-warning">
                            <div class="caption">
                                <i class="fa fa-fw fa-bars"></i> Flat master
                            </div>
                        </div>
                        <div class="portlet-body bg-wrn-new">
                            <div class="portlet">
								 <div class="col-md-6"><a href="{{ URL::to('flatmaster/add') }}"><img src="{{asset('assets/icons/building_home.png')}}"><span class="info-hd"> New Flat </span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('flatmaster') }}"><img src="{{asset('assets/icons/flat.png')}}"><span class="info-hd"> View Flat </span></a> </div>
                            </div>
							<p></br></br></p>
                        </div>
                    </div>
					...
					<div class=" portlet box">
                        <div class="portlet-title bg-primary">
                            <div class="caption">
                                <i class="fa fa-fw fa-bars"></i> Contract Enquiry
                            </div>
                        </div>
                        <div class="portlet-body bg-pr-new">
                            
                            <div class="portlet">
								 <div class="col-md-6"><a href="{{ URL::to('job_estimate/add') }}"><img src="{{asset('assets/icons/add-estimate.png')}}"><span class="info-hd"> New Enquiry</span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('job_estimate') }}"><img src="{{asset('assets/icons/view-estimate.png')}}"><span class="info-hd"> View Enquiry</span></a> </div>
                            </div>
							<p></br></br></p>
                    ...
                    <div class=" portlet box">
                        <div class="portlet-title bg-primary">
                            <div class="caption">
                                <i class="fa fa-fw fa-bars"></i> Account Enquiry
                            </div>
                        </div>
                        <div class="portlet-body bg-pr-new">
                            
                            <div class="portlet">
								 <div class="col-md-6"><a href="{{ URL::to('account_master/add') }}"><img src="{{asset('assets/icons/add-quote.png')}}"><span class="info-hd"> Create New</span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('account_master') }}"><img src="{{asset('assets/icons/view-quote.png')}}"><span class="info-hd"> View </span></a> </div>
                            </div>
							<p></br></br></p>
				...
				<div class=" portlet box">
						...
						<div class=" portlet box">
						 <div class="portlet-title bg-success">
                            <div class="caption">
                                <i class="fa fa-fw fa-bars"></i> Purchase Split
                            </div>
                        </div>
                        <div class="portlet-body bg-suc-new">
                           <div class="portlet">
								 <div class="col-md-6"><a href="{{ URL::to('purchase_split/add') }}"><img src="{{asset('assets/icons/add-purchase.png')}}"><span class="info-hd"> New Purchase</span></a></div>
								 <div class="col-md-6" ><a href="{{ URL::to('purchase_split') }}"><img src="{{asset('assets/icons/view-purchase.png')}}"><span class="info-hd"> View Purchase</span></a> </div>
                            </div>
							<p></br></br></p>
                        </div>
