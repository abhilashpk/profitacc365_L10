                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
							...
							<tr>
								<td colspan="2"><img src="{{asset('assets/'.Session::get('logo').'')}}" />
								<h6>TRN No: <strong>{{Session::get('vatno')}}</strong></h6></td>
							</tr>
							<tr>
							...
							<td  style="width:28%">
									...
									Invoice Details:
										...
										<?php if($titles['subhead']=='Tax Invoice') { ?>
										<h6>DO No: {{$details->voucher_no}}</h6>
										<h6>DO Date: {{date('d-m-Y',strtotime($details->voucher_date))}}</h6>
										<h6>LPO No: {{$details->reference_no}}</h6>
										<?php } ?>
									</div>
							</td>
							</tr>
