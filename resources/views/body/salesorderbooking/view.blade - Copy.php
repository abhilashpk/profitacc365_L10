							...
							<form class="form-horizontal" role="form" method="POST" name="frmJob" id="frmJob" >
                                ...
                                <table class="table horizontal_table table-striped" id="table5">
									...
									<div class="form-group">
										...
										<div class="col-sm-1">
											<input type="text" class="form-control" name="height[{{$i}}]" value="{{$jobdata[$key][$k]->other_value->height}}" autocomplete="off" readonly>
										</div>
										<label for="input-text" class="col-sm-1 control-label">Width</label>
										<div class="col-sm-1">
											<input type="text" class="form-control" name="width[{{$i}}]" autocomplete="off" value="{{$jobdata[$key][$k]->other_value->width}}" readonly>
										</div>
										@endif
										<label for="input-text" class="col-sm-1 control-label">Quantity</label>
										<div class="col-sm-1">
											<input type="text" class="form-control" name="quantity[{{$i}}]" value="{{$jobdata[$key][$k]->other_value->quantity}}" autocomplete="off" readonly>
										</div>
									</div>
