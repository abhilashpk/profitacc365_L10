                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             ...
                             <a href="{{ url('sales_order_booking/add') }}" class="btn btn-primary btn-sm">
...
function funDelete(id,no) {
	if(no=='0') {
		...
		if(con==true) {
			var url = "{{ url('sales_order_booking/delete/') }}";
...
$(function() {
		...
		var dtInstance = $("#tablePordersList").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "{{ url('sales_order_booking/paging/') }}",
					 "dataType": "json",
					 "type": "POST",
