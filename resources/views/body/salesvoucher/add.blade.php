        ...
        <section class="content">
            <div class="row">
				...
				<div class="alert alert-warning">
					<p>
						Sales voucher is not found! Please create a voucher in Account Settings.
					</p>
				</div>
				<?php } else { ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Sales Voucher 
                            </h3>
                           <div class="pull-right">
							<?php if($printid) { ?>
							
								 <a href="{{ url('sales_voucher/print/'.$printid->id.'/'.$prints[0]->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="{{ url('sales_voucher/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="hidden" name="voucher_type" value="{{$voucher['voucher_type_id']}}">
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<input type="hidden" value="{{$voucher['vno']}}" name="vno">
										...
										<div class="itemdivPrnt">
											<div class="itemdivChld">							
												<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
													...
													<input type="hidden" name="account_id[]" id="draccountid_1"><!-- acntid_1 -->
													...
													<div class="col-xs-15">
														<div class="col-xs-3">
															<span class="small">Description</span> <input type="text" id="descr_1" name="description[]" autocomplete="off" class="form-control">
														</div>
														...
														<div class="col-xs-2" style="width:15%;">
															<span class="small">Amount</span> <input type="number" id="amount_1" step="any" name="line_amount[]" autocomplete="off" class="form-control line-amount">
														</div>
												...
												<div class="form-group">
													...
													<input type="hidden" name="department[]" id="dept_1">
														...
														<div id="chqdtl_1" class="divchq">
															...
															<div class="col-sm-2"> 
																<span class="small">Cheque No</span><input type="text" id="chkno_1" autocomplete="off" name="cheque_no[]" class="form-control" >
															</div>
															
															<div class="col-xs-2">
																<span class="small">Cheque Date</span> <input type="text" id="chkdate_1" autocomplete="off" name="cheque_date[]" class="form-control chqdate" data-language='en'>
															</div>
								...
								<div class="form-group" id="trndtl_1" class="divTrn">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-5"> 
											<span class="small"><b>Supplier Name</b></span><input type="text" id="supname_1" autocomplete="off" name="supplier_name" class="form-control" >
										</div>
										<div class="col-xs-5">
											<span class="small"><b>TRN No</b></span> <input type="text" id="trnno_1" name="trn_no" autocomplete="off"  name="trn_no" class="form-control">
										</div>
                                </div>
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
        ...
        var controlForm = $('.controls .itemdivPrnt'),
			...
			if(group_id=='1') {// group.id VAT input expense type.
				...
				if(con) {
					...
					$('#draccountid_'+rowNum).val( '<?php echo ($account)?$account->payment_account:'';?>' );
	...
	$(document).on('click', '.custRow', function(e) { 
		...
		if($(this).attr("data-group")=='PDCR') { 
			...
			var trnurl = "{{ url('sales_voucher/set_transactions/') }}";
...
function getNetTotal() {
	...
	$( '.line-amount' ).each(function() {
		...
		if( $('#acnttype_'+curNum+' option:selected').val()=='Dr' ) {
			...
			crLineTotal = crLineTotal + parseFloat( (this.value=='')?0:$(this).val() );
		}	
	});
