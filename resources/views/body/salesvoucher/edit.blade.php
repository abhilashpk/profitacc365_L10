                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Sales Voucher 
                            </h3>
                           <div class="pull-right">
							
								 <a href="{{ url('sales_voucher/print/'.$jrow->id.'/'.$prints[0]->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchase Voucher" id="frmPurchase Voucher" action="{{ url('sales_voucher/update/'.$jrow->id) }}">
                               ...
                               @if($isdept)
                                    ...
                                    <div class="col-sm-10">
                                       <select id="department_id" class="form-control select2" style="width:100% ;background-color:#85d3ef;" name="department_id">
											@foreach($departments as $drow)
												<option value="{{ $drow->id }}" {{($jrow->department_id==$drow->id)?'selected':''}} >{{ $drow->name }}</option>
											@endforeach
                                        </select>
                                    </div>
                                </div>
									 ...
									 <div class="col-sm-10">
									   <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
										   @foreach($vouchers as $voucher)
											<option value="{{ $voucher['id'] }}" <?php echo ($jrow->voucher_id==$voucher['id'])?'selected':'';?>>{{ $voucher['voucher_name'] }}</option>
											@endforeach
										</select>
									</div>
								</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="hidden" name="voucher_type" value="{{$row['voucher_type_id']}}">
                                    </div>
                                </div>
								@endif
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">SIN. No.</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">SIN. Date</label>
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" autocomplete="off" value="{{date('d-m-Y', strtotime($jrow->voucher_date))}}" data-language='en' id="voucher_date" placeholder="Voucher Date"/>
                                    </div>
                                </div>
										...
										@php $i++; @endphp
											<div class="itemdivChld">							
												<div class="form-group" style="margin-bottom: 1px;">
													...
													<input type="hidden" name="group_id[]" value="" id="groupid_{{$i}}">
													<input type="hidden" name="je_id[]" id="jeid_{{$i}}" value="{{$item->id}}">
													</div>
													<div class="col-xs-15">
														<div class="col-xs-3">
															<span class="small">Description</span> <input type="text" id="descr_{{$i}}" value="{{$item->description}}" autocomplete="off" name="description[]" class="form-control">
														</div>
														<div class="col-xs-2" style="width:10%;">
															<span class="small">Reference</span> 
															<div id="refdata_1" class="refdata">
															<input type="text" id="ref_{{$i}}" name="reference[]" value="{{$item->reference}}" autocomplete="off" class="form-control">
															</div>
												...
												<div class="form-group">
													...
													<input type="hidden" name="department[]" id="dept_1">
														...
														<div class="col-sm-2"> 
															<span class="small">Cheque No</span><input type="text" id="chkno_{{$i}}" autocomplete="off" value="{{$item->cheque_no}}" name="cheque_no[]" class="form-control" >
															<input type="hidden" id="oldchkno_{{$i}}" value="{{$item->cheque_no}}" name="oldcheque_no[]">
														</div>
														
														<div class="col-xs-2">
															<span class="small">Cheque Date</span> <input type="text" id="chkdate_{{$i}}" autocomplete="off" value="<?php echo ($item->cheque_date=='0000-00-00')?'':date('d-m-Y',strtotime($item->cheque_date));?>" name="cheque_date[]" class="form-control chqdate" data-language='en'>
														</div>
								...
								<div class="form-group" id="trndtl_1" class="divTrn">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-5"> 
											<span class="small"><b>Supplier Name</b></span><input type="text" id="supname_1" autocomplete="off" value="{{$jrow->supplier_name}}" name="supplier_name" class="form-control" >
										</div>
										<div class="col-xs-5">
											<span class="small"><b>TRN No</b></span> <input type="text" id="trnno_1" name="trn_no" autocomplete="off" value="{{$jrow->trn_no}}" class="form-control">
										</div>
                                </div>
								<?php } ?>
								<div class="form-group">
