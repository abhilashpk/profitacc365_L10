                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>Supplier's Driver List
                        </h3>
                        <div class="pull-right">
                            <a href="{{ url('rental_supplierdriver/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="tableTemplate Name">
                                ...
                                @foreach ($rsdriver ??[] as $sd)
                                        <tr>
                                           
                                        <td>{{ $sd->master_name}}</td>
                                         <td>{{ $sd->driver_name}}</td>
                                            

                                            <td>
                                                <p>
                                                    <button class="btn btn-primary btn-xs"
                                                        onClick="location.href='{{ url('rental_supplierdriver/edit/' . $sd->id) }}'">
...
@section('footer_scripts')
    ...
    <script>
        function funDelete(id) {
            var con = confirm('Are you sure delete this Driver Information?');
            if (con == true) {
                var url = "{{ url('rental_supplierdriver/delete/') }}";
