                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>Cargo Salesman List
                        </h3>
                        <div class="pull-right">
                            <a href="{{ url('cargo_salesman/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="tableSalesman">
                                <thead>
                                    <tr>
                                        <th>Salesman ID</th>
                                        <th>Salesman Name</th>
                                            ...
                                            <td>
                                                <p>
                                                    <button class="btn btn-primary btn-xs"
                                                        onClick="location.href='{{ url('cargo_salesman/edit/' . $row->id) }}'">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title custom_align" id="Heading5">Delete Salesman</h4>
                    </div>
...
<script type="text/javascript" src="{{asset('assets/vendors/datatables/js/dataTables.scroller.js')}}"></script>
    ...
    <script>
     $(function() {
        var dtInstance = $("#tableSalesman").DataTable({
        ...
        function funDelete(id) {
            var con = confirm('Are you sure delete this Salesman?');
            if (con == true) {
                var url = "{{ url('cargo_salesman/delete/') }}";
