									...
									<div class="tab-pane fade active in" id="home">
										<form class="form-horizontal" role="form" method="POST" name="frmContract" id="frmContract" action="{{url('contract-connection/save')}}">
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="number" class="form-control amount" id="acamt_{{$i}}" step="any" name="acamount[]" placeholder="Amount">
												</div>
											</div>
											@endforeach
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="number" class="form-control" id="balance" step="any" name="balance"readonly placeholder="Balance">
												</div>
