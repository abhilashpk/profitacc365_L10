							...
							<div class="bs-example">
                                ...
                                <div id="myTabContent" class="tab-content">
									<div class="tab-pane fade active in" id="home">
										<form class="form-horizontal" role="form" method="POST" name="frmContract" id="frmContract" action="{{url('contract-connection/readsave/'.$crow->id)}}">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													...
													<option value="{{$buildingmaster->id}}">{{$buildingmaster->buildingcode}}</option>
													</select>
												</div>
											...
											<legend style="margin-bottom:0px !important;"><h5><span class="itmDtls">Meter Reading</span></h5></legend><br/>
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" class="form-control" id="previous" value="{{isset($reads->current)?$reads->current:''}}" name="previous" {{isset($reads->current)?'readonly':''}}>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" class="form-control" id="rate" value="{{$buildingmaster->unit_price}}" name="rate" readonly>
													</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<input type="number" class="form-control {{($acrow->is_tax==1)?'txamount':'acamount'}}" id="acamt_1" {{($acrow->is_tax==1)?"readonly":""}} step="any" name="acamount[]" placeholder="Amount">
												</div>
											</div>
											@endforeach
