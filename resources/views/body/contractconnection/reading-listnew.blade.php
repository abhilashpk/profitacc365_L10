                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Meter Reading
                        </h3>
                        <div class="pull-right">
							<a href="{{ url('contract-connection/reading-add') }}" class="btn btn-primary btn-sm">
...
var bid = $('#building_id option:selected').val();		
  $('#reportResult').load("{{ url('contract-connection/reading_listing/') }}/"+bid);
});
$(document).on('click', '.searchRead', function(e) {
	...
	if(bid=='') {
		...
		if(fno!='')
  			$('#reportResult').load("{{ url('contract-connection/reading_listing/') }}/"+bid+"/"+fno);
			else
  $('#reportResult').load("{{ url('contract-connection/reading_listing/') }}/"+bid);
...
$(document).on('click', '.clearFun', function(e) {
	localStorage.clear();
	location.href="{{ url('contract-connection/reading-list') }}";
});
