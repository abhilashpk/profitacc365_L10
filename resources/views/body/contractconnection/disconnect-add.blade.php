                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Disconnection 
                            </h3>
							...
							<div class="bs-example">
                                ...
                                <div id="myTabContent" class="tab-content">
									<div class="tab-pane fade active in" id="home">
										<form class="form-horizontal" role="form" method="POST" name="frmContract" id="frmContract" action="{{url('contract-connection/disconsave')}}">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<div class="col-sm-4">
													<input type="number" class="form-control" step="any" name="rv_amount" id="rvamt" />
													</div>
												</div>
											</div>
...
$(document).on('change', '#building_id', function(e) {
	...
	$.get("{{ url('buildingmaster/getvals/') }}/" + bid, function(data) {
		...
		$('#acamt_1').val(det.disconnection_charge); 
		$('#acamt_2').val(det.other_charge_dis); 
	}).done(function() {
		grandTotal();
...
$(document).on('click', '.custRow', function(e) {
	...
	var fid = $('#flat_id').val();
	$.get("{{ url('contract-connection/getreading/') }}/" + $(this).attr("data-id")+"/"+fid+"/D", function(data) {
		var det = $.parseJSON(data); 
		if(det.status)
