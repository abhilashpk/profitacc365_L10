...
@section('content')
    ...
    <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="">
                        <i class="fa fa-fw fa-wrench"></i> Disconnection
                    </a>
                </li>
                <li>
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Disconnection
                        </h3>
                        <div class="pull-right">
							<a href="{{ url('contract-connection/disconnection-add') }}" class="btn btn-primary btn-sm">
                       ...
                       <div id="myTabContent" class="tab-content">
						<div class="tab-pane fade active in" id="home">
								<div class="form-group">
                                                ...
                                                <label for="input-text" class="col-sm-1 control-label">Search</label>
												<div class="col-sm-2">
...
var bid = $('#building_id option:selected').val();		
  $('#reportResult').load("{{ url('contract-connection/disconnection_listing/') }}/"+bid);
});
$(document).on('click', '.searchRead', function(e) {
	...
	if(bid=='') {
		...
		if(fno!='')
  			$('#reportResult').load("{{ url('contract-connection/disconnection_listing/') }}/"+bid+"/"+fno);
			else
  $('#reportResult').load("{{ url('contract-connection/disconnection_listing/') }}/"+bid);
...
$(document).on('click', '.clearFun', function(e) {
	localStorage.clear();
	location.href="{{ url('contract-connection/disconnection-list') }}";
});
