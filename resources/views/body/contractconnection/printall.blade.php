								...
								<tr><td><br/></td></tr>
									<tr>
										<td colspan="2" align="center">
											Connection No:<b>{{$details->connection_no}}</b>, Bldg. No:<b>{{$details->buildcode}}</b>, Flat No:<b>{{$details->flat}}</b>
										</td>
									</tr>
							</table><br/>
                        </div>
								...
								<div>
									...
									<table border="0" style="width:100%;">
										<tr>
											<td style="width:30%;"></td>
											<td style="width:30%;" align="left"></td>
											<td style="width:10%;" align="left"><b>JV Grand Total</b></td>
											<td style="width:15%; padding-right:10px;" class="text-right"><b>{{number_format($JVgdrtotal,2)}}</b></td>
											<td style="width:15%; padding-right:10px;" class="text-right"><b>{{number_format($JVgcrtotal,2)}}</b></td>
										</tr>
									</table>--}}<br/><br/>
								</div>
                        </div>
