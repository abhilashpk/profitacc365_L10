...
@section('content')
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							@can('ss-create')
                             <a href="{{ url('sales_split/add') }}" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmPOReport" id="frmPOReport" action="{{ url('sales_split/search') }}" target="_blank">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "{{ url('sales_split/delete/') }}";
   ...
   /*  $("#multiselect2").multiselect({
	...
	$(document).on('change', '#search_type', function(e) { //$('#search_type').on('change', function(e){
		...
		if(vchr=='customer') {
			...
			$.ajax({
				url: "{{ url('sales_split/getcustomer/') }}",
				//type: 'get',
