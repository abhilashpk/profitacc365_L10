                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Sales Split-Petty Cash
                            </h3>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="voucher_id">
                                           @foreach($vouchers as $voucher)
											<option value="{{ $voucher->id }}">Sales Split-Petty Cash</option>
											@endforeach
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                 <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="customer_name" id="customer_name" value="{{ $accountname }}" class="form-control " autocomplete="off" data-toggle="modal" data-target="#acunt_modal"  placeholder="Customer" >
										<!--<span class="input-group-addon inputsa"><i class="fa fa-edit" style="font-size:22px;color:#ff9f2c"></i></span>-->
										
										<input type="hidden" name="customer_id" id="customer_id" value="{{ $accountid }}">
								...
								<div class="form-group">
									...
									<button type="button" id="vehicle_info" class="btn btn-primary btn-xs vehicle-info">Vehicle Info</button>
										...
										<div class="col-xs-10" style="float: right;" id="vehicleInfo">
											<div class="col-xs-2">
												<span class="small">Vehicle Reg.No.</span> <input type="text" id="vehicle_regno" name="vehicle_regno"  readonly class="form-control">
											</div>
											<div class="col-xs-2">
												<span class="small">Issue Plate</span> <input type="text" id="issue_plate" name="issue_plate"  readonly class="form-control">
											</div>
											<div class="col-xs-2">
												<span class="small">Code Plate</span> <input type="text" id="code_plate" name="code_plate"  readonly class="form-control">
											</div>
											<div class="col-xs-2">
												<span class="small">Make</span> <input type="text" id="make" name="make"  readonly class="form-control">
											</div>
											<div class="col-xs-2">
												<span class="small">Model</span> <input type="text" id="model" name="model"  readonly class="form-control">
											</div>
...
$(document).ready(function () { 
    ...
    $('#frmSalesSplit').bootstrapValidator({
        fields: {
			...
			//'jobcod[]': { validators: { notEmpty: { message: 'The job code is required and cannot be empty!' } }}
