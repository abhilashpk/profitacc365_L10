    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="#">Sales Split-Petty Cash</a>
                </li>
                <li class="active">
                    Edit
                </li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							@permission('pi-print')
							 <a href="{{ url('sales_split/print/'.$orderrow->id.'/'.$print->id) }}" target="_blank"  class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesSplit" id="frmSalesSplit" action="{{ url('sales_split/update/'.$orderrow->id) }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="sales_split_id" id="sales_split_id" value="{{ $orderrow->id }}">
								...
								<div class="form-group">
									<label for="input-text" class="col-sm-2 control-label"><b>Sales Split Petty Cash</b></label>
									<div class="col-sm-10">
								...
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"><b>SS. No.</b></label></font>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">SS. Date</label>
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' autocomplete="off" value="{{date('d-m-Y',strtotime($orderrow->voucher_date))}}" id="voucher_date" placeholder="SS. Date"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="customer_name" id="customer_name" value="<?php echo (old('customer_name'))?old('customer_name'):$orderrow->customer; ?>" class="form-control "autocomplete="off" data-toggle="modal" data-target="#acunt_modal">
										...
										<!--	<div class="col-xs-8">
												<span class="small">Customer Name</span> <input type="text" id="suppliername" name="suppliername" value="{{$orderrow->customer_name}}" class="form-control" autocomplete="off" data-toggle="modal" data-target="#newsupplier_modal">
											</div>-->
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vehicle_name" id="vehicle_name" value="<?php echo $orderrow->vehicle; ?>" class="form-control " autocomplete="off" data-toggle="modal" data-target="#vehicle_modal" placeholder="Vehicle">
										<input type="hidden" name="vehicle_id" id="vehicle_id" value="<?php echo $orderrow->vehicle_id; ?>">
										</div>
									<div class="col-sm-2">
									<button type="button" id="vehicle_info" class="btn btn-primary btn-xs vehicle-info">Vehicle Info</button>
									</div>
										<div class="col-sm-10" style="float: right;" id="vehicleInfo">
											<div class="col-xs-4">
												<span class="small">Vehicle Reg.No.</span> <input type="text" id="vehicle_regno" name="vehicle_regno" value="<?php echo $orderrow->reg_no; ?>" readonly class="form-control">
											</div>
											<div class="col-xs-3">
												<span class="small">Make</span> <input type="text" id="make" name="make" value="<?php echo $orderrow->make; ?>" readonly class="form-control">
											</div>
											<div class="col-xs-3">
												<span class="small">Model</span> <input type="text" id="model" name="model" value="<?php echo $orderrow->model; ?>" readonly class="form-control">
											</div>
								...
								<br/>
								<fieldset>
								<legend style="margin-bottom:0px !important;"><h5><span class="itmDtls">Income  Details</span></h5></legend>
								...
								<div class="itemdivChld">							
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="9%">
														<input type="text" id="vatdiv_{{$i}}" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="{{$item->vat.'% - '}}{{($orderrow->is_fc==1)?$item->item_vat_fc:$item->item_vat}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('sales_split') }}" class="btn btn-danger">Cancel</a>
										<a href="{{ url('sales_split/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	// <?php //if( sizeof($voucher) > 0 && $voucher->is_cash_voucher==1) { ?> //cash customer.... 
	...
	var urlcode = "{{ url('sales_split/checkrefno/') }}";
    $('#frmPurchaseSplit').bootstrapValidator({
        ...
        $('#frmSalesSplit').data('bootstrapValidator').resetForm();
    });
...
$(function() {	
	...
	$('#department_id').on('change', function(e){
		...
		$.get("{{ url('sales_split/getdeptvoucher/') }}/" + dept_id, function(data) {  console.log(data);
	...
	var acturl = "{{ url('sales_split/account_data/') }}";
	...
	$('#voucher_id').on('change', function(e){
		...
		$.get("{{ url('sales_split/getvoucher/') }}/" + vchr_id, function(data) { //console.log(data);
...
/*	var custurl;
	...
	$('.inputsa').on('click', function(e) {
		$('#customer_name').attr("onClick", "javascript:getAccount(this)");
	});
...
function getAccount(e) { 
	...
	var curNum = res[1]; 
	var itmurl = "{{ url('purchase_split/cash_data/') }}/sales";
