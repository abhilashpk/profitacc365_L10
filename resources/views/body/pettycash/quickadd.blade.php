        ...
        <section class="content">
            <div class="row">
				...
				<div class="alert alert-warning">
					<p>
						Petty Cash voucher is not found! Please create a voucher in Account Settings.
					</p>
				</div>
				<?php } else { ?>
										...
										<div class="itemdivPrnt">
                                            ...
                                            <div class="itemdivChld">							
                                                    <div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
                                                        ...
                                                        <input type="text" id="draccount_1" name="account_name[]" class="form-control acname" value="{{$cashac->master_name}}" autocomplete="off" data-toggle="modal" data-target="#account_modal">
                                                        ...
                                                        <div class="col-xs-15">
                                                            ...
                                                            <div class="col-xs-2" style="width:15%;">
                                                                <span class="small">Amount</span> <input type="number" id="amount_1" step="any" name="line_amount[]" autocomplete="off" class="form-control pcline-amount">
                                                            </div>
												...
												<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_2">
													...
													<div class="col-xs-15">
														...
														<div class="col-xs-2" style="width:10%;">
															...
															<input type="text" id="ref_2" name="reference[]" class="form-control" autocomplete="off">
															</div>
														...
														<div class="col-xs-2" style="width:15%;">
															<span class="small">Amount</span> <input type="number" id="amount_2" step="any" name="line_amount[]" autocomplete="off" class="form-control pcline-amount">
														</div>
													...
													<div id="chqdtl_2" class="divchq" style="display:none;">
														...
														<div class="col-sm-2"> 
															<span class="small">Cheque No</span><input type="text" autocomplete="off" id="chkno_2" name="cheque_no[]" class="form-control" >
														</div>
														
														<div class="col-xs-2">
															<span class="small">Cheque Date</span> <input type="text" autocomplete="off" id="chkdate_2" name="cheque_date[]" class="form-control chqdate" data-language='en'>
														</div>
														
														<div class="col-xs-2">
															<input type="hidden" name="partyac_id[]" id="partyac_2">
															<span class="small">Party Name</span> <input type="text" id="party_2" name="party_name[]" class="form-control" data-toggle="modal" data-target="#paccount_modal">
														</div>
...
$(function(){
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
        ...
        var controlForm = $('.controls .itemdivPrnt'),
			...
			if(group_id=='1') {// group.id VAT input expenses type.
				//console.log('vat');
				//New Change[Kavya]
	...
	$(document).on('keyup', '.pcline-amount', function(e) { 
		getNetTotal();
	...
	$(document).on('click', '.custRow', function(e) { 
		...
		if($(this).attr("data-group")=='PDCR') { 
			...
			var trnurl = "{{ url('pettycash/set_transactions/') }}";
