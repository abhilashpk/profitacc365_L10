                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
							...
							<table class="table" border="1">
								...
								<?php } ?>
								<tr>
								    <td>{{$crdata->master_name}}</td>
								    <td class="text-right">{{$crdata->description}}</td>
								    <td class="text-right">{{$crdata->reference}}</td>
								    <td></td>
								    <td class="text-right">{{$crdata->amount}}</td>
								</tr>
								</body>
								<tr>
									<td colspan="3" class="text-right"><b>Total:</b></td>
									<td class="text-right"><b>{{number_format($drtotal,2)}}</b></td>
									<td class="text-right"><b>{{number_format($crdata->amount,2)}}</b></td>
								</tr>
							</table>
							<br/><br/><br/>
