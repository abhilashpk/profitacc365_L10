										...
										<div class="itemdivPrnt">
											<div class="itemdivChld">							
												<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
													<div class="col-sm-2" id ="acName_1"> <span class="small">Account Name</span>
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
	...
	$(document).on('click', '.accountRow', function(e) { 
		...
		if($(this).attr("data-group")=='PDCR') { 
			...
			if( $('#chqdtl_'+num).is(":hidden") ){				
			// $(function() {							
  			// 	 $("#draccount_"+num).width(80); 	
			// 	 	$("#acName_").appendTo()append
			//      $("#descr_"+num).width(150);				
			// 	 $("#amount_"+num).width(80);
			// });
				$('#chqdtl_'+num).toggle(); }
		} 
		else {
