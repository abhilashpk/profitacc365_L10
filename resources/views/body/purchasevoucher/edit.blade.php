                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix ">
                           ...
                           <div class="pull-right">
								 ...
								 <a href="{{ url('purchase_voucher/print/'.$jrow->id.'/'.$prints[0]->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchase Voucher" id="frmPurchase Voucher" action="{{ url('journal/update/'.$jrow->id) }}">
											...
											<div class="itemdivChld">							
												...
												<div class="form-group">
													...
													<input type="hidden" name="department[]" id="dept_1">
														...
														<div class="col-sm-2"> 
															<span class="small">Cheque No</span><input type="text" id="chkno_{{$i}}" value="{{$item->cheque_no}}" autocomplete="off" name="cheque_no[]" class="form-control" >
								...
								<div class="form-group" id="trndtl_1" class="divTrn">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
										...
										<div class="col-xs-5">
											<span class="small"><b>TRN No</b></span> <input type="text" id="trnno_1" autocomplete="off" name="trn_no" value="{{$jrow->trn_no}}" class="form-control">
										</div>
                                </div>
								<?php } ?>
								<div class="form-group">
...
$(function(){
  ...
  $('#department_id').on('change', function(e){ 
		...
		$.get("{{ url('purchase_voucher/getdeptvoucher/') }}/" + dept_id, function(data) { 
