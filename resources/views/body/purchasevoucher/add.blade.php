        ...
        <section class="content">
            <div class="row">
				...
				<div class="alert alert-warning">
					<p>
						Purchase voucher is not found! Please create a voucher in Account Settings.
					</p>
				</div>
				<?php } else { ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Purchase Voucher 
                            </h3>
                            
                            <div class="pull-right">
							<?php if($printid) { ?>
							
								 <a href="{{ url('purchase_voucher/print/'.$printid->id.'/'.$prints[0]->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="{{ url('purchase_voucher/save') }}">
											...
											<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
													...
													<div class="col-xs-15">
														...
														<div class="col-xs-2" style="width:10%;">
															...
															<input type="text" id="ref_1" name="reference[]" class="form-control" autocomplete="off">
															</div>
														...
														<div class="col-xs-2" style="width:15%;">
															<span class="small">Amount</span> <input type="number" id="amount_1" step="any" autocomplete="off" name="line_amount[]" class="form-control line-amount">
														</div>
								...
								<div class="form-group" id="trndtl_1" class="divTrn">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
										...
										<div class="col-xs-5">
											<span class="small"><b>TRN No</b></span> <input type="text" id="trnno_1" autocomplete="off" name="trn_no" class="form-control">
										</div>
                                </div>
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
	...
	$(document).on('click', '.custRow', function(e) { 
		...
		if($(this).attr("data-group")=='PDCR') { 
			...
			var trnurl = "{{ url('purchase_voucher/set_transactions/') }}";
