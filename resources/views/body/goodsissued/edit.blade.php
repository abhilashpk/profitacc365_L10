                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							@can('gi-print')
							 <a href="{{ url('goods_issued/print/'.$orderrow->id) }}" target="_blank" class="btn btn-info btn-sm">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmGoodsInvoice" id="frmGoodsInvoice" action="{{ url('goods_issued/update/'.$orderrow->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('goods_issued/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
