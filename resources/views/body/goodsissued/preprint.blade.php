											...
											@foreach($report as $row)
												...
												<tr>
												 ...
												 <td><b>{{$key}}</b></td>
													...
													<td class="text-right"><b>{{number_format($row['net_amount'],2)}}</b></td>
												</tr>
												<?php $nettotal += $row['total'];
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<td></td>
											...
											<td width="16%" class="text-right"><b>{{number_format($nctotal,2)}}</b></td>
