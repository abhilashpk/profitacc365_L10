<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-xs-10">
				<div class="col-xs-2">
					<span class="small">Quantity</span> <input type="number" id="itmqty_{{$i}}" name="quantity[]" class="form-control line-quantity" value="{{$item->quantity}}">
				</div>
				<div class="col-xs-2">
					<span class="small">Cost/Unit</span> <input type="number" id="itmcst_{{$i}}" step="any" name="cost[]" class="form-control line-cost" value="{{$item->unit_price}}">
				</div>
				<div class="col-xs-2">
					<!--<span class="small">Vat% - Amount</span>--> <input type="hidden" id="vatdiv_{{$i}}" step="any" readonly name="vatdiv[]" class="form-control cost" value="{{$item->vat.'% - '.$item->vat_amount}}"><!--<div class="h5" id="vatdiv_1"></div>--> 
				...
				<div class="col-xs-2">
					<!--<span class="small">Discount</span>--> <input type="hidden" id="itmdsnt_{{$i}}" step="any" name="line_discount[]" class="form-control line-discount" placeholder="Discount">
				</div>
				<div class="col-xs-2">
					<span class="small">Total</span> <input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" class="form-control line-total" readonly value="{{$item->total_price}}">
				</div>
				<div class="col-xs-2">
					 <button type="button" class="btn btn-success btn-danger btn-remove-item" data-id="rem_{{$i}}">
