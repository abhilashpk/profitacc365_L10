                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="table5">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" class="poclk" data-id="{{$sdo->id}}" data-name="{{$sdo->voucher_no}}" data-toggle="modal" data-target="#item_modal">{{$sdo->voucher_no}}</a></td>
                                        <td><a href="" class="poclk" data-id="{{$sdo->id}}" data-name="{{$sdo->reference_no}}" data-toggle="modal" data-target="#item_modal">{{$sdo->reference_no}}</a></td>
