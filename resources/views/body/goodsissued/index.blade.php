...
@section('content')
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Goods Issued Note
                        </h3>
                        <div class="pull-right">
                             <a href="{{ url('goods_issued/add') }}" class="btn btn-primary btn-sm">
                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td>
												<p><button class="btn btn-primary btn-xs" onClick="location.href='{{ url('goods_issued/edit/'.$order->id)}}'"><span class="glyphicon glyphicon-pencil"></span></button></p>
											</td>
											<td>
												<p><a href="{{url('goods_issued/print/'.$order->id)}}" class="btn btn-primary btn-xs" target="_blank"><span class="fa fa-fw fa-print"></span></a></p>
											</td>
											<td>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmReport" target="_blank" id="frmReport" action="{{ url('goods_issued/search') }}">
			 ...
			 <div class="col-lg-12">
					<div class="panel panel-info">
						<div class="panel-heading clearfix">
							<h3 class="panel-title pull-left m-t-6">
								<i class="fa fa-fw fa-list-alt"></i> Goods Issued Report
							</h3>
						</div>
						<div class="panel-body">
								<div class="row">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "{{ url('goods_issued/delete/') }}";
