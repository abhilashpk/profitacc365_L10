                    ...
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								...
								<tr><td colspan="2" align="center"><h4><b>Goods Issued Note</b></h4></td></tr>
								<tr>
									...
									<td align="left" style="padding-left:150px;">
										<div style="border:1px solid #000; padding: 10px;">
											GI No: {{$details->voucher_no}}<br/>
											GI Date: {{date('d-m-Y',strtotime($details->voucher_date))}}<br/>
										</div>
									</td>
								</tr>
								...
								<tr style="border:1px solid black;">
									...
									<table border="0" style="width:100%;" class="table table-bordered">
										<tr>
											...
											@if($details->is_itemjob==1)
											<td width="40%" align="center" style="border:1px solid #000 !important;"><b>Job Name</b></td>
											@endif
										...
										<tr>
											...
											<td align="center">{{number_format($item->vat_amount,2)}}</td>
