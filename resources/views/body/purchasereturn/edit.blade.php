                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Order Return
                            </h3>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurReturn" id="frmPurReturn" action="{{ url('purchase_return/update/'.$orderrow->id) }}">
								...
								<?php if($formdata['pi_no']==1) { ?>
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"> <b>Purchase Invoice No</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="purchase_invoice_no" name="purchase_invoice_no" value="{{$orderrow->purchase_invoice_no}}" placeholder="Purchase Invoice No" autocomplete="off" onclick="getPurchaseInvoice(this)">
										<input type="hidden" class="form-control" id="purchase_invoice_id" name="purchase_invoice_id" value="{{$orderrow->purchase_invoice_id}}">
										<input type="hidden" name="is_prior" id="is_prior">
									</div>
                                </div>
								<?php } else { ?>
									<input type="hidden" name="pi_no" id="pi_no">
								<?php } ?>
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Stock Account</label>
                                    <div class="col-sm-10">
										<div class="input-group">
                                        <input type="text" name="stock_account" id="stock_account" class="form-control" value="{{$orderrow->account}}" readonly>
										<span class="input-group-addon inputsa"><i class="fa fa-edit" style="font-size:22px;color:#ff9f2c"></i></span>
										</div>
										<input type="hidden" name="account_master_id" id="account_master_id" class="form-control" value="{{$orderrow->account_master_id}}">
									</div>
                                </div>
								...
								<div class="form-group">
                                  <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>Supplier</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" class="form-control" value="{{$orderrow->supplier}}" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="{{date('d-m-Y',strtotime($orderrow->voucher_date))}}" readonly id="voucher_date" />
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" value="{{$orderrow->description}}" name="description" placeholder="Description">
                                    </div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_{{$i}}" name="quantity[]" step="any" class="form-control line-quantity" value="{{$item->quantity}}">
												</td>
												<td width="8%">
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_{{$i}}" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="{{$item->vat.'% - '.$vat_amount}}"><!--<div class="h5" id="vatdiv_{{$i}}"></div>--> 
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" value="{{intval($vat_amount_net*100)/100}}" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" value="{{$orderrow->vat_amount}}" placeholder="0" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control" readonly value="{{$net_total}}">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="{{$net_total}}" placeholder="0">
										</div>
										<div class="col-xs-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('purchase_return/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
				...
				/*	remote: {
                        ...
                        data: function(validator) {
                            return {
								...
								id: validator.getFieldElements('purchase_return_id').val()
                            };
                        },
...
$(function() {	
	...
	$('#voucher_id').on('change', function(e){
		...
		$.get("{{ url('purchase_invoice/getvoucher/') }}/" + vchr_id, function(data) { //console.log(data);
			...
			$('#stock_account').val(data.caccount_id+'-'+data.caccount_name);
			$('#account_master_id').val(data.cid);
		});
	});
