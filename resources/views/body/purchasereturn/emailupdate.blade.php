                    ...
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								...
								<tr><td colspan="2" align="center"><h4><b>PURCHASE RETURN MODIFIED  </b></h4></td></tr>
								<tr>
									<td align="left" valign="top" width="35%" style="padding-left:0px; padding-bottom:5px;">
										<div style="border:1px solid #000; padding: 10px;"><br/>
											PR No: {{$purchaseitems[0]->voucher_no}}<br/>
											Modified by: <?php echo $purchaseitems[0]->name;?><br/>
											Modified at: {{date('d-m-Y',strtotime($purchaseitems[0]->modify_at))}}<br/>
							...
							<tbody>
								<tr style="border:1px solid black;">
									...
									<table border="0" style="width:100%;" class="table table-bordered">
										<tr>
											<td width="5%" align="center" style="border:1px solid #000 !important;"><b>PR.#</b></td>
										...
										<tr>
											...
											<?php 
													...
													$total = $purchaseitems[0]->total;
													$vat_amount_net = $purchaseitems[0]->vat_amount;
													$net_amount =$purchaseitems[0]->net_amount;
