                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="table5">
                                    ...
                                    <tr>
                                        <td><a href="" class="itms" data-id="{{$item->id}}" data-code="{{$item->item_code}}" data-name="{{$item->description}}" data-unit="{{$item->unit_name}}" onclick="selectItem(this)">{{$item->item_code}}</a></td>
                                        <td><a href="" class="itms" data-id="{{$item->id}}" data-code="{{$item->item_code}}" data-name="{{$item->description}}" data-unit="{{$item->unit_name}}" onclick="selectItem(this)">{{$item->description}}</a></td>
...
function selectItem(e) { 
	 ...
	 if (window.opener != null && !window.opener.closed) { 
		...
		//var unit = window.opener.document.getElementById("itmunt_"+no);
		//unit.value = $(e).data('unit');
		...
		//selbox.selectedIndex = $(e).data('unit');
        //selbox.options[0].value;
		//unit.name = $(e).data('unit');
		
		//$("#itmunt_1").val('qwe');
			
		//var txtName = window.opener.document.getElementById("itmcod_1");
		//txtName.value = $(e).data('name');//$(e.currentTarget).attr("data-name");//document.getElementById("ddlNames").value;
	}
	//window.close();
}
</script>
