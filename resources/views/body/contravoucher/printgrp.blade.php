            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
							<table border="0" style="width:100%;">
								...
								<tr>
									...
									<td width="40%" align="right"><p>CV. No: {{$details->voucher_no}}</p><p>Date: {{date('d-m-Y',strtotime($details->voucher_date))}}</p></td>
								</tr>
							</table><br/>
                        </div>
						<?php
						...
						?>
                        <div class="col-md-12">
						<!--	<div style="text-align:center;"><h5><p>Received with thanks from Ms./Mr. <b>{{$name}}</b> the sum of <b>Dhs. {{$amtwords}}</b> </p></h5></div>
							...
							<table class="table" border="1">
								...
								@foreach($invoicerow as $row)
									<tr>
										...
										<td>{{$row->reference}}</td>
										<td class="text-right">@if($row->tr_type=='Dr'){{number_format($row->amount,2)}} @php $dramount += $row->amount; @endphp @endif</td>
										<td class="text-right">@if($row->tr_type=='Cr'){{number_format($row->amount,2)}} @php $cramount += $row->amount; @endphp @endif</td>
									</tr>
								@endforeach
									<tr>
