                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Account Group List
                        </h3>
                        <div class="pull-right">
							<a href="{{ url('acgroup/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive m-t-10">
                             <table class="table horizontal_table table-striped" id="tableAcgroup">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>
											<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('acgroup/edit/'.$group->id) }}'">
