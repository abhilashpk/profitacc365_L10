                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Enquiry
                            </h3>
                           
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST"  name="frmTenant" id="frmTenant" action="{{url('tenantenquiry/update/'.$enquiry->id)}}">
								...
								<input type="hidden" name="id" id="id" value="{{ $enquiry->id }}">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="voucher_no" readonly name="voucher_no" value="{{$enquiry->enquiry_no}}">
										...
										<div class="col-sm-4">
									       <input type="text" class="form-control pull-right" id="enq_date" name="enq_date" value="{{date('d-m-Y',strtotime($enquiry->enquiry_date))}}" autocomplete="off" data-language='en'  />
										</div>
									</div>
                                   ...
                                   <div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="customer_account"  name="customer_account" value="{{$enquiry->tenant}}" autocomplete="off" data-toggle="modal" data-target="#customer_modal">
									 ...
									 <div class="form-group">
										...
										<div class="col-sm-10">
											<textarea class="form-control" id="description" name="description" autocomplete="off">{{$enquiry->description}}</textarea>
										</div>
									</div>
