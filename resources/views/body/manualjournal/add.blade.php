        ...
        <section class="content">
            <div class="row">
				...
				<div class="alert alert-warning">
					<p>
						Manual Journal voucher is not found! Please create a voucher in Account Settings.
					</p>
				</div>
				<?php } else { ?>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
						   ...
						   <div class="pull-right">
								@can('jv-print')
								<form class="form-horizontal" role="form" method="GET" target="_blank" name="frmItem" id="frmItem" action="{{ url('manual_journal/getvoucherprint') }}">
							...
							<div class="col-xs-4">
									<select id="voucher_typeprint" class="form-control select2" style="width:100%" name="voucher_typeprint" required>
    									...
    									<option value="16">Manual Journal</option>
									</select> 
										</div>
										<div class="col-xs-3">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="{{ url('manual_journal/save') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="voucher_type" class="form-control select2" style="width:100%" name="voucher_type">
											<option value="25">MJV - Journal Voucher</option>
										</select>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<input type="hidden" value="" name="vno">
