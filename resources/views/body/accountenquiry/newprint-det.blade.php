								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td style="word-break: break-all;">{{($trans->reference_from=="")?$trans->reference:$trans->reference_from}}</td>	
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										<tr>
											...
											<td width="10%"><b>Equipemnt</b></td>
											<td width="10%"><b>Location/Project</b></td>
											<td width="10%"><b>LPO No</b></td>
											<td width="10%" class="text-right"><b>Debit</b></td>
											<td width="10%" class="text-right"><b>Credit</b></td>
											<td width="10%" class="text-right"><b>Balance</b></td>
										</tr>
									...
									?>
										...
										<tr>
											...
											@if($jobid)<td>{{$trans['jobno']}}</td>@endif
											<td>{{$trans['eqp_type']}}</td>
											<td>{{$trans['loc_proj']}}</td>
											<td>{{$trans['lpo_no']}}</td>
