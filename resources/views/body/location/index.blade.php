                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="{{ url('location/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableLoc">
                                    ...
                                    <tr>
                                        <td>{{ $location->code }} <b>{{($location->is_default==1)?'(Default)':''}}</b></td>
										<td>{{ $location->name }}</td>
                                        <td>{{ $location->master_name }}</td>
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('location/edit/'.$location->id) }}'">
