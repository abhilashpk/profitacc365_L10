               ...
               <div class="panel panel-info">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-columns"></i>Work Report
                            </h3>
                        </div>
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmJobReport" id="frmJobReport" target="_blank" action="{{ url('job_report/search') }}">
								...
								<div class="row">
									...
									<div class="col-xs-6">
										<span>Job No:</span><br/>
										<select id="job_id" class="form-control select2" name="job_id"  style="width:100%">
...
function getSummary() {	
	...
	$('#job_id').on('change', function(e){ 
	    ...
	    $('#reportResult').load("{{ url('job_report/sojob_search/') }}/"+jid);
	});
