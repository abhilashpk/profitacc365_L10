                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
							...
							<?php } else if($type=='summary_ac' || $type=='detail') { ?>	
							<h6><b>Job Code: {{$report->code}}</b>, <b>Job Name: {{$report->name}}</b></h6>
									<table class="table" border="0">
										<thead>
										...
										@foreach($reports as $report)
											...
											<tr>
												<td style="width:20%;">{{$row->account_id}}</td>
												<td style="width:30%;" align="left">{{$row->master_name}}</td>
							...
							<?php } else if($type=='detail') { ?>	
									<table class="table" border="0">
										...
										?>
											...
											?>
											<tr>
												<td style="width:20%;">Account ID: <b>{{$row->account_id}}</b></td>
												<td style="width:30%;" align="left">Account Name: <b>{{$row->master_name}}</b></td>
												<td style="width:1%;"></td>
												<td style="width:4%;"></td>
											...
											<tr>
												...
												<td style="width:30%;" align="left">{{$row->name}}</td>
												<td style="width:1%;">{{$row->type}}</td>
												<td style="width:4%;">{{$row->voucher_no}}</td>
												<td style="width:15%;" class="text-right"><?php echo ($row->income > 0)?number_format($row->income,2):'';?></td>
												<td style="width:15%;" class="text-right"><?php echo ($row->amount > 0)?number_format($row->amount,2):'';?></td>
							...
							<?php } else if($type=='stockin' || $type=='stockout') { 
							...
							?>
									...
									<table class="table" border="0">
										...
										<?php foreach($reports['invoice'] as $report) { ?>
											...
											<tr>
												<td colspan="3">Voucher Name: <b>{{$report[0]->master_name}}</b></td>
												<td colspan="4"></td>
											</tr>
											<?php 
