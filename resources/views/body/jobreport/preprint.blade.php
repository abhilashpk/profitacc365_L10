									...
									@endif
											...
											<table border="0" style="width:100%;">
												<tr>
													<td align="left" valign="top" width="50%" style="padding-left:0px;">
														<div style="border:1px solid #000; padding: 10px;">
														<b>MAWB: {{$report->mbl}} </b><br/>
														<b>Origin: {{$report->origin}}</b><br/>
														<b>No.of Pcs.: {{$report->no_of_pieces}}</b><br/>
														<b>Gross Wt.: {{$report->gross_weight}}</b><br/>
														<b>Flight: {{$report->flight_no}}</b>
														</div>
													</td>
													<td align="left" width="50%" style="padding-left:10px;">
														<div style="border:1px solid #000; padding: 10px;">
														<b>HAWB No: {{$report->hbl}}</b><br/>
														<b>Destination: {{$report->destination}}</b><br/>
														<b>Volume: {{$report->volume}}</b><br/>
														<b>Charge Wt.: {{$report->chargeable_weight}}</b><br/>
														<b>Packing: {{$report->packing}}</b>
														</div>
													</td>
												</tr>
											</table>
