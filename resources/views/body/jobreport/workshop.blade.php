							...
							<form class="form-horizontal" role="form" method="POST" name="frmJobReport" id="frmJobReport" target="_blank" action="{{ url('job_report/search') }}">
								...
								<div class="row">
									...
									<div class="col-xs-6">
										...
										<span>Vechicle Details:</span><br/>
										<input type="text" name="search_val" id="search_val" autocomplete="off" class="form-control" style="width:100%">
										...
										<div class="col-xs-4" style="border:0px solid red;">
											<input type="checkbox" name="is_vehicle" value="1"> Vehicle Details
										</div>	
