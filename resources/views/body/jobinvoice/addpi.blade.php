                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('job_invoice/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sales_account" id="sales_account" class="form-control" readonly value="{{($salesac!='')?$salesac:$vouchers[0]['account_id'].'-'.$vouchers[0]['master_name']}}">
    								...
    								<div class="form-group">
    									...
    									<button type="button" id="vehicle_info" class="btn btn-primary btn-xs vehicle-info">Vehicle Info</button>
    										...
    										<div class="col-xs-10" style="float: right;" id="vehicleInfo">
    											...
    											<div class="col-xs-2">
    												<span class="small">ChasisNo</span> <input type="text" id="chasis_no" name="chasis_no" value="{{$docrow->chasis_no}}" readonly class="form-control">
    											</div>
    											<div class="col-xs-2">
    											...
    											<div class="col-xs-1">
    												<span class="small">MetreIn</span> <input type="text" id="metre_in" name="metre_in" value="{{$docrow->metre_in}}" class="form-control">
    											</div>
    											<div class="col-xs-1">
    												<span class="small">MetreOut</span> <input type="text" id="metre_out" name="metre_out"value="{{$docrow->metre_out}}"  class="form-control">
    											</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" tabindex="2" class="form-control" autocomplete="off" data-toggle="modal" value="{{$docrow->code}}" data-target="#job_modal" placeholder="Job Code">
								...
								<?php if($formdata['items_description']==1) { ?>
										   <div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" id="items_description" autocomplete="off" name="items_description" value="{{$docrow->items_description}}" placeholder="Items Description">
											</div>
											</div>
								           <?php } else {?>
