                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('job_invoice/save') }}">
								...
								<div class="form-group">
                                  <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>JI. No.</b></label></font>
								...
								<div class="form-group">
                                  <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
									...
									<div class="col-sm-2">
									<button type="button" id="customer_info" class="btn btn-primary btn-xs cust-info">Customer Info</button>
									</div>
										<div class="col-sm-10" style="float: right;" id="customerInfo">
											<div class="col-sm-3">
										...
										<div class="col-sm-10" style="float: right;" id="newcustomerInfo">
											<div class="col-sm-4">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"> Advisor</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" placeholder="Advisor" autocomplete="off">
                                    </div>
                                </div>
								<?php } else { ?>
...
//$('#voucher_date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('{{$settings->from_date}}'),maxDate: new Date('{{$settings->to_date}}') } );
	...
	$(document).on('click', '.cust-info', function(e) { 
	 <?php if( sizeof($vouchers) > 0 && $vouchers[0]->is_cash_voucher==1){ ?>
	// if( $('#newcustomerInfo').is(":hidden") )
			$('#newcustomerInfo').toggle();
		if( $('#customerInfo').is(":visible") )
			$('#customerInfo').toggle();
