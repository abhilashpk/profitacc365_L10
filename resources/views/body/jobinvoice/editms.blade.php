                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							@can('si-print')
							 <a href="{{ url('job_invoice/print/'.$orderrow->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('job_invoice/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									 <select id="document_type" class="form-control select2" style="width:100%" name="document_type">
										<option value="SQ" <?php if($orderrow->document_type=='SQ') echo 'selected'; ?>>Job Estimate</option>
										<option value="SO" <?php if($orderrow->document_type=='SO') echo 'selected'; ?>>Job Order</option>
									</select>
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document" value="{{$orderrow->doc_no}}" readonly name="document" placeholder="Document ID" autocomplete="off">
										<input type="hidden" id="document_id" value="{{$orderrow->document_id}}" name="document_id">
                                    </div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="17%">
													...
													<span class="small <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>">Item Name</span><input type="text" id="itmcod_{{$j}}" name="item_code[]" class="form-control <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>" autocomplete="off" value="{{$item}}" data-toggle="modal" data-target="#item_modal">
												</td>
												<td width="30%">
												...
												<td width="5%">
													<span class="small <?php if($errors->has('quantity.'.$i)) echo 'form-error';?>">Quantity</span> <input type="number" id="itmqty_{{$j}}" autocomplete="off" name="quantity[]" step="any" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" value="{{ old('quantity')[$i]}}">
												</td>
												<td width="6%">
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="17%">
													...
													<span class="small">Item Name</span><input type="text" id="itmcod_{{$i}}" name="item_code[]" class="form-control" autocomplete="off" value="{{$item->item_code}}" data-toggle="modal" data-target="#item_modal">
												</td>
												<td width="30%">
												...
												<td width="5%">
													<span class="small">Quantity</span> <input type="number" id="itmqty_{{$i}}" autocomplete="off" name="quantity[]" step="any" class="form-control line-quantity" value="{{$item->quantity}}">
												</td>
												<td width="6%">
													<span class="small">Cost/Unit</span> <input type="number" id="itmcst_{{$i}}" autocomplete="off" step="any" name="cost[]" class="form-control line-cost" value="{{$unit_price}}">
												</td>
												<td width="6%">
