                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('job_invoice/update/'.$orderrow->id) }}">
                               ...
                               <?php if($formdata['job_account']==1) { ?>
    								...
    								<div class="form-group">
                                       <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
    									...
    									<button type="button" id="customer_info" class="btn btn-primary btn-xs cust-info">Customer Info</button>
    										...
    										<div class="col-xs-10" style="float: right;" id="newcustomerInfo">
    											<div class="col-xs-3">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" tabindex="2" class="form-control" autocomplete="off" data-toggle="modal" value="{{$orderrow->code}}" data-target="#job_modal" placeholder="Job Code">
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="20%">
														...
														<input type="text" name="rv_dr_account[]" id="rvdraccount_{{$i}}" autocomplete="off" class="form-control" value="{{$rowrv->master_name}}">
										...
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="20%">
														<span class="small">Debit Account</span>
														<input type="text" name="rv_dr_account[]" id="rvdraccount_1" autocomplete="off" class="form-control" value="{{$rvvoucher['account_name']}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('job_invoice') }}" class="btn btn-primary">Back</a>
...
$(document).ready(function () { 
    ...
    $('#cheque_no').hide();$('#cheque_date').hide();$('#bank_id').hide();$('.pdcr').hide(); $('#roundoff_fc').toggle();
	var j = 1;
	@foreach($rventry as $rowrv)
...
$(function() {	
	...
	$(document).on('click', '.cust-info', function(e) { 
	 <?php if( sizeof(array($vouchers)) > 0 && $vouchers->is_cash_voucher==1){ ?>
	   $('#newcustomerInfo').toggle();
	 <?php } else{?>
