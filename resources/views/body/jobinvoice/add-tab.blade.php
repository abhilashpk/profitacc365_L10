        ...
        <section class="content">
            <div class="row">
				...
				<div class="alert alert-warning">
					<p>
						JI. No. is found empty! Please create in Account Settings.
					</p>
				</div>
				<?php } else { ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								@can('si-print')
								 <a href="{{ url('job_invoice/print/'.$printid->id.'/'.$print->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('job_invoice/save') }}">
								...
								<?php if($formdata['job_order_no']==1) { ?>
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Job Order#</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document_id" name="document_id" placeholder="Job Order No" autocomplete="off">
                                    </div>
                                </div>
								<?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="jinvoice_id" readonly name="jinvoice_id" placeholder="Copy from existing Invoice" autocomplete="off" onclick="getJobInvoice()">
                                    </div>
                                </div>
                                <?php } else { ?>
									<input type="hidden" name="jinvoice_id" id="jinvoice_id">
								<?php } ?>
								...
								<div class="form-group" style="display:none;">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="cr_account_id" id="cr_account_id" value="{{ (old('cr_account_id'))?old('cr_account_id'):$vouchers[0]['cr_account_master_id'] }}" class="form-control">
										<div class="input-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="customer_name" id="customer_name" value="{{old('customer_name')}}" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="on" placeholder="Customer">
										<input type="hidden" name="customer_id" id="customer_id" value="{{old('customer_id')}}">
										<input type="hidden" name="dr_account_id" id="dr_account_id" value="{{old('dr_account_id')}}">
										<div class="col-xs-10" id="customerInfo" style="display:none;">
											<div class="col-xs-4">
										...
										<div class="col-xs-10" id="newcustomerInfo" style="display:none;">
											<div class="col-xs-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="Phone No." autocomplete="on">
                                    </div>

									<div class="col-xs-1">
										<a href="" class="btn btn-info vehicle-history" data-toggle="modal" data-target="#veh_history_modal"> Service History</a>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="vehicle_name" id="vehicle_name" value="<?php echo (isset($vehicledata))?$vehicledata->name:''?>" class="form-control <?php if($errors->has('vehicle_name')) echo 'form-error';?>" autocomplete="off" placeholder="Vehicle">
										...
										<div class="col-xs-10" id="vehicleInfo">
											<div class="col-xs-3">
												<span class="small">Vehicle Reg.No.</span> <input type="text" id="vehicle_regno" name="vehicle_regno" value="{{old('vehicle_regno')}}" class="form-control">
											</div>
											<div class="col-xs-2">
												<span class="small">Km</span> <input type="text" id="km" name="kilometer" value="{{old('kilometer')}}" class="form-control">
											</div>
											<div class="col-xs-2">
												<span class="small">Next Km</span> <input type="text" id="code_plate" name="next_km" value="{{old('code_plate')}}" class="form-control">
											</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									<select id="select22" class="form-control select2" style="width:100%" name="salesman_id">
							...
							<div class="form-group">
								...
								<table class="table table-bordered" style="margin-bottom:0px !important;">
									...
									<tr>
										...
										<th width="4%" class="itmHd" style="display:none;">
...
$(document).ready(function () { 
    ...
    $('#frmSalesInvoice').bootstrapValidator({
        fields: {
			...
			/* voucher_no: { //CHNG
                validators: {
					...
					remote: {
                        ...
                        message: 'This JI. No. is already exist!'
                    }
                }
            }, */
			reference_no: {
			...
			customer_name: { validators: { notEmpty: { message: 'The customer is required and cannot be empty!' } }},
			salesman_id: { validators: { notEmpty: { message: 'The technician is required and cannot be empty!' } }},
...
function getJobInvoice() { 
	
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "{{ url('job_invoice/get_jobinvoice/') }}";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
...
///Customer search...
var srccust = "{{ url('sales_invoice/ajax_customer_vehicle/') }}";
	$('#customer_name').autocomplete({
		...
		select: function (event, ui) {
			...
			$('#vehicle_regno').val( ui.item.reg_no );
			$('#vehicle_name').val( ui.item.vehicle );
	...
	var srcph = "{{ url('sales_invoice/ajax_phone_vehicle/') }}";
	$('#phone_no').autocomplete({
        source: function(request, response) {
            $.ajax({
                url: srcph,
                dataType: "json",
