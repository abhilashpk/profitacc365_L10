                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="table5">
                                    ...
                                    <tr>
										<td><input type="radio" name="salesDO" value="{{$invoice->id}}"/></td>
                                        <td><a href="#" class="poclk" data-id="{{$invoice->id}}" data-name="{{$invoice->voucher_no}}" data-toggle="modal" data-target="#item_modal">{{$invoice->voucher_no}}</a></td>
                                        <td><a href="" class="poclk" data-id="{{$invoice->id}}" data-name="{{$invoice->reference_no}}" data-toggle="modal" data-target="#item_modal">{{$invoice->reference_no}}</a></td>
...
function setTransfer() {
	...
	//alert(items);
	 invoiceurl = "{{ url('sales_return/add/') }}/"+item;
