                ...
                <div class="" style="width:100%; !important; border:0px solid red; align=center;">
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								<tr>
									<td colspan="2" height="188px"></td>
								</tr>
								<tr>
									<td style="padding-left:15px;" height="140px" width="455px">
									...
									<td align="left" style="padding-left:200px;padding-top:2px;" valign="top" height="170">
										<table border="0">
											<tr>
											...
											<tr>
												<td height="34px" align="left"> {{$details->do_no}}</td>
											</tr>
											<tr>
												<td height="34px" align="left"> {{$details->lpo_no}}</td>
											</tr>
											<tr>
												<td height="34px" align="left"> {{date('d-m-Y',strtotime($details->lpo_date))}}</td>
											</tr>
							...
							<tbody id="bod">
								<tr style="border:0px solid red;">
									<td colspan="2" height="420px" align="left" valign="top">
										<table border="0" width="763px" style="font-size:9pt; !important;">
											<tr>
												<td width="30px" height="40px"><b></b></td>
												<td width="117px"><b></b></td>
												<td width="276px"><b></b></td>
												<td width="37px"><b></b></td>
												<td width="56px" class="text-right"><b></b></td>
												<td width="75px" class="text-right"><b></b></td>
												<td width="26px"><b></b></td>
												<td width="56px" class="text-right"><b> </b></td>
							...
							<tfoot>
								<tr>
									<td colspan="2"><div class="footer-space">&nbsp;</div></td>
								</tr>
							</tfoot>
						</table>
						...
						<div class="footer">
							<table>
								<tr>
									<td height="40px" style="padding-left:40px;">
										<b style="font-size:11pt;">{{$amtwords}}</b>
									</td>
								</tr>
								<tr>
									<td height="56px" style="padding-left:50px;">
										<table border="0">
											<tr>
