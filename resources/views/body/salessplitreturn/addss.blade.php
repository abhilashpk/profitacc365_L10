                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Sales Split Return
                            </h3>
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesSplit" id="frmSalesSplit" action="{{ url('sales_split_return/save/'.$orderrow->id) }}">
								...
								<div class="form-group">
									<label for="input-text" class="col-sm-2 control-label"><b>Sales Split Return</b></label>
									<div class="col-sm-10">
								...
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"><b>SSR. No.</b></label></font>
                                   <input type="hidden" name="curno" id="curno" value="<?php echo $orderrow->voucher_no; ?>">
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">SSR. Date</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('sales_split_return') }}" class="btn btn-danger">Cancel</a>
										<a href="{{ url('sales_split/add/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
