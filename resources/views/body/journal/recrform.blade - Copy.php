	...
	<div class="itemdivPrnt">
		...
		<div class="itemdivChld">
			...
			<div class="col-xs-2" style="width:10%;">
				...
				<input type="hidden" name="inv_id_rc[]" id="invid_1" value="{{$data['inv_id'][$key]}}">
			...
			<div class="col-xs-1" style="width:8%;">
				<span class="small">Chq. No</span><input type="text" autocomplete="off" id="chkno_1" name="cheque_no_rc[{{$data['vno']+$i}}][]" class="form-control">
			</div>
			<div class="col-xs-1" style="width:9%;">
				<span class="small">Chq. Date</span> <input type="text" autocomplete="off" id="chkdate_1" name="cheque_date_rc[{{$data['vno']+$i}}][]" class="form-control chqdate" data-language='en'>
			</div>
			
			<div class="col-xs-1" style="width:9%;">
				<span class="small">Bank</span> 
					<select id="bankid_1" class="form-control select2 line-bank" style="width:100%" name="bank_id_rc[{{$data['vno']+$i}}][]">
			...
			<div class="col-xs-1" style="width:9%;">
				<input type="hidden" name="partyac_id_rc[]" id="partyac_1" value="{{$data['partyac_id'][$key]}}">
			...
			<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
				<div class="col-sm-2"> <span class="small">Account Name</span>
					...
					<div class="col-xs-2" style="width:15%;">
						...
						<input type="hidden" name="inv_id_rc[]" id="invidrc_1" value="{{$data['inv_id'][$key]}}">
