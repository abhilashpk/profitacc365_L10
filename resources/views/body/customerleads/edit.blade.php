...
@section('content')
	...
	<!--<section class="content-header">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="index">
                        <i class="fa fa-fw fa-money"></i> Customer Desk
                    </a>
                </li>
        ...
        <!--<div class="btn-section">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                                <span class="pull-left">
									<button type="button" onclick="javascript:window.history.go(-2);"
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Edit Customer
                        </h3>
                        <div class="pull-right">
                             <a href="{{ url('customerleads/add')}}" class="btn btn-info btn-sm">
					...
					<button type="button" onclick="javascript:window.history.go(-1);"
						...
						<?php if($sid==1){ ?>
                                        ...
                                        <a href="{{ url('customerleads/customer') }}" class="btn btn-info btn-sm">
								<span >
						...
						?>
                                        ...
                                        <a href="{{ url('customerleads/enquirystatus') }}" target="_blank" class="btn btn-info btn-sm">
								<span >
									<i class="fa fa-fw fa-arrow-circle-left"></i>Back 
								</span>
							 </a>
						...
						?>
                                        ...
                                        <a href="{{ url('customerleads/prospective') }}"  class="btn btn-info btn-sm">
								<span >
									<i class="fa fa-fw fa-arrow-circle-left"></i>Back 
								</span>
							 </a>
						...
						<?php if($sid==4){ ?>
                                        ...
                                        <a href="{{ url('customerleads/archive') }}"  class="btn btn-info btn-sm">
								<span >
									<i class="fa fa-fw fa-arrow-circle-left"></i>Back 
								</span>
							 </a>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmLeads" id="frmLeads" action="{{ url('customerleads/update/'.$docrow->id)}}">
					...
					<div class="form-group">
						<label for="input-text" class="col-sm-2 control-label"></label>
						 <div class="col-sm-10">
                            ...
                            <tr>
                            <?php if($row->remark_date != '0000-00-00')   { ?>
                     ...
                     <?php } ?>
								...
								<div class="form-group">
                                    ...
                                    <input type="hidden" id="sid" value="{{$rowfolo->status}}" name="sid">
                                    <div class="col-sm-4">
                       ...
                       <label for="input-text" id="next_date_label" class="col-sm-2 control-label"></label>
                                ...
                                <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-10">
                                        <button type="button" class="btn btn-primary" id="saveIt" >Submit</button>
...
$(function() {
  ...
  if($('#status option:selected').val()==2 || $('#status option:selected').val()==3 || $('#status option:selected').val()==1 || $('#status option:selected').val()==4) {
        if($('#remark').val()=='') {
