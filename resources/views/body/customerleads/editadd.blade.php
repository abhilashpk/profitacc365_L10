                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-heading clearfix">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmLeads" id="frmLeads" action="{{ url('customerleads/updates/'.$docrow->id)}}">
					...
					<div class="form-group">
                     ...
                     <?php } ?>
                       ...
                       <label for="input-text"  class="col-sm-2 control-label"></label>
                                    ...
                                    <div class="col-sm-4">
                                    <a href="{{ url('customer_enquiry') }}" target="_blank" class="btn btn-primary">Customer Enquiry</a>
                                       
                                        <a href="{{ url('quotation_sales') }}" target="_blank" class="btn btn-primary">Quotation</a>
                                    </div>
                                </div>
