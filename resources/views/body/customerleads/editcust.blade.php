                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Customer
                                    ...
                                    <php ?>
                                    <a href="{{ url('customerleads/customertype') }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmLeads" id="frmLeads" action="{{ url('customerleads/updateCus/'.$docrow->id)}}">
							...
							<input type="hidden" value="{{$rowfolo->id}}" id="fid" name="fid">
                            <br>
					...
					<div class="form-group">
                            ...
                            <tr class="dl-horizontal" >
                             ...
                             <td>{{date('d-m-Y',strtotime($row->remark_date))}}:</td>
                             <td>{{$row->remark}}</td>
                               </tr>
                           @endforeach
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control pull-right" autocomplete="öff"  id="next_date" name="next_date" value="{{date('d-m-Y',strtotime($rowfolo->next_date))}}" data-language='en' />
                                    </div>
