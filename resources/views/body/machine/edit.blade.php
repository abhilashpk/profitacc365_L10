                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Machine 
                            </h3>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmMachine" id="frmMachine" action="{{ url('machine/update/'.$mrow->id) }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								
									<div class="form-group">
										<label for="input-text" class="col-sm-2 control-label">Machine Name</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="name" name="name" value="{{$mrow->name}}" autocomplete="off" placeholder="Machine Name">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="model" name="model" value="{{$mrow->model}}" autocomplete="off" placeholder="Model No">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="brand" name="brand" value="{{$mrow->brand}}" autocomplete="off" placeholder="Brand">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="serialno" name="serialno" value="{{$mrow->serialno}}" autocomplete="off" placeholder="Serial No.">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<select name="type" id="type" class="form-control">
												...
												<option value="Color" {{($mrow->type=='Color')?'selected':''}}>Color</option>
												<option value="B/W" {{($mrow->type=='B/W')?'selected':''}}>B/W</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="media" name="media" value="{{$mrow->media}}" autocomplete="off" placeholder="Media">
										</div>
									</div>
