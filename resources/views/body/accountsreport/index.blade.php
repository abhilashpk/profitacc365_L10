    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="index">
                        <i class="fa fa-fw fa-briefcase"></i> Reports
                    </a>
                </li>
                <li>
                    <a href="#">Customer/Supplierwise Report </a>
                </li>
            </ol>
               ...
               <div class="panel panel-info">
					<div class="panel-heading clearfix">
						<h3 class="panel-title pull-left m-t-6">
							<i class="fa fa-fw fa-columns"></i> Customer/Supplier List
						</h3>
						
					</div>
					<div class="panel-body">
						<form class="form-horizontal" role="form" method="POST" target="_blank" name="frmSearchAccount" id="frmSearchAccount">
						...
						<div class="table-responsive m-t-10">
							...
							<button type="button" class="btn btn-primary statement" onclick="getSearch()">Search</button>
						</div>
						</form>
					</div>
				</div>
...
function getSearch() {	
	document.frmSearchAccount.action = "{{ url('account_reports/search')}}";
	document.frmSearchAccount.submit();
}
...
$(function() {	
	...
	$(function() {
		...
		var dtInstance = $("#Acenquiry").DataTable({
			...
			"serverSide": true,
			"ajax":{
					 "url": "{{ url('account_reports/paging/') }}",
					 "dataType": "json",
					 "type": "POST",
