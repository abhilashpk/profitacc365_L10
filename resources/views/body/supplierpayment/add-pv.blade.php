                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
						   ...
						   <div class="pull-right">
							<?php if($printid) { ?>
								@can('pv-print')
								 <a href="{{ url('supplier_payment/printgrp/'.$printid->id) }}" target="_blank" class="btn btn-info btn-sm">
                          ...
                          <div class="controls"> 
                            ...
                            <div style="display:none;">
                                <div class="itemdivChld">
                                    <div class="form-group classtrn" style="margin-bottom:1px;" id="trns_0">
                                        <div class="col-sm-2"> <span class="small">Account Name</span>
                                            <input type="text" id="draccount_0" name="account_name[]" class="form-control acname" autocomplete="off" data-toggle="modal" data-target="#account_modal" placeholder="Select Account">
                                            <input type="hidden" name="account_id[]" id="draccountid_0">
                                            <input type="hidden" name="group_id[]" id="groupid_0">
                                            <input type="hidden" name="vatamt[]" id="vatamt_0">
                                            
                                            <input type="hidden" id="invoiceid_0" name="sales_invoice_id[]">
                                            <input type="hidden" name="bill_type[]" id="biltyp_0">
                                        </div>
                                            <div class="col-xs-3" style="width:25%;">
                                                <span class="small">Description</span> <input type="text" id="descr_0" autocomplete="off" name="description[]" class="form-control" placeholder="Description">
                                            </div>
                                            <div class="col-xs-2" style="width:15%;">
                                                <span class="small">Reference</span> 
                                                <div id="refdata_1" class="refdata">
                                                <input type="text" id="ref_0" name="reference[]" autocomplete="off" class="form-control" placeholder="Reference No">
                                                </div>
                                                <input type="hidden" name="inv_id[]" id="invid_0">
                                                <input type="hidden" name="actual_amount[]" id="actamt_0">
                                            </div>
                                            
                                            <div class="col-xs-2" style="width:13%;">
                                                <span class="small">Amount</span> <input type="number" id="amount_0" autocomplete="off" step="any" name="line_amount[]" class="form-control jvline-amount">
                                            </div>
                                            
                                            <div class="col-xs-1" style="width:8%;">
                                                <span class="small">Type</span> 
                                                <select id="acnttype_0" class="form-control select2 line-type" style="width:100%;padding-left:5px;" name="account_type[]">
                                            ...
                                            <div class="col-sm-2" style="width:17%;"> 
                                                ...
                                                <input type="hidden" name="job_id[]" id="jobid_0" >
                                                <input type="text" id="jobcod_0" autocomplete="off" name="jobcod[]" class="form-control"  autocomplete="off" data-toggle="modal" data-target="#job_modal" placeholder="Jobcode">
                                            </div>
                                            @if($isdept)
                                            <div class="col-xs-3" style="width:13%;">
                                                <span class="small">Department</span> 
                                                <select id="dept_0" class="form-control select2 line-dept" style="width:100%" name="department[]">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSupPayment" id="frmSupPayment" action="{{ url('journal/save') }}">
                                ...
                                <input type="hidden" name="chktype" id="chktype" value="10">
                                    ...
                                    <div class="itemdivPrnt">
											<div class="itemdivChld">
												<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
													<div class="col-sm-2"> <span class="small">Account Name</span>
														<input type="text" id="draccount_1" name="account_name[]" placeholder="Select Account" class="form-control acname" autocomplete="off" data-toggle="modal" data-target="#account_modal">
														...
														<div class="col-xs-3" style="width:25%;">
															<span class="small">Description</span> <input type="text" id="descr_1" autocomplete="off" name="description[]" class="form-control" placeholder="Description">
														</div>
														<div class="col-xs-2" style="width:15%;">
															<span class="small">Reference</span> 
															<div id="refdata_1" class="refdata">
															<input type="text" id="ref_1" name="reference[]" autocomplete="off" class="form-control" placeholder="Reference No">
															</div>
    ...
    rowNum++; 
        ...
        currentEntry = $('.itemdivChld:first');
            ...
            if($(this).attr("data-type") == 'Dr' || $(this).attr("data-type") == 'Cr') {
                ...
                var trnurl = "{{ url('supplier_payment/set_transactions/') }}";
...
$(document).on('click', '#account_data .custRow', function(e) { 
    ...
    $('.itemdivPrnt #vatamt_'+num).val( $(this).attr("data-vat") );
        ...
        if( $(this).attr("data-group")=='SUPPLIER') { 
        ...
        $('#frmSupPayment').bootstrapValidator('revalidateField', 'account_name[]');
...
$(document).on('click', 'input[name="party_name[]"]', function(e) {
    var res = this.id.split('_');
    var curNum = res[1]; 
    $('#paccount_data').load(acurlall+'/'+curNum+'?type=notin', function(result){ //.modal-body item
        $('#myModal').modal({show:true});
    });
});
...
$(document).on('click', '#paccount_data .custRow', function(e) { //paccount_data
    ...
    $('#frmSupPayment').bootstrapValidator('revalidateField', 'party_name[]');
    checkChequeNo(num);
});
