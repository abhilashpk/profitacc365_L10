                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="{{ url('supplier_payment/update/'.$crrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" value="{{date('d-m-Y', strtotime($crrow->voucher_date))}}" data-language='en' id="voucher_date" placeholder="Voucher Date"/>
                                    </div>
                                </div>
								...
								<legend><h5>Transactions</h5></legend>
										...
										<?php 
										$invoice_id = $tr_id = '';
										foreach($invoicetrrow as $invrow) {
											if($item->id == $invrow->payment_voucher_entry_id) {
												$invoice_id = $invrow->purchase_invoice_id;
												$tr_id = $invrow->id;
											}
										} ?>
											<div class="itemdivChld">							
												<div class="form-group">
													...
													<input type="hidden" id="invoiceid_{{$i}}" name="purchase_invoice_id[]" value="{{$invoice_id}}">
													<input type="hidden" name="bill_type[]" value="PI">
													<input type="hidden" id="trid_{{$i}}" name="tr_id[]" value="{{$tr_id}}">
													</div>
													<div class="col-xs-15">
														<div class="col-xs-3">
														...
														<div class="col-xs-2" style="width:10%;">
															...
															<input type="text" id="ref_{{$i}}" name="reference[]" value="{{$item->reference}}" class="form-control">
															</div>
														...
														<div class="col-xs-2" style="width:15%;">
															<span class="small">Amount</span> <input type="number" id="amount_{{$i}}" value="{{$item->amount}}" step="any" name="line_amount[]" class="form-control line-amount">
														</div>
														...
														<div class="col-xs-1"><br/>
															...
															<?php if($crrow->group_id!=1) { ?> <button type="button" class="btn btn-success btn-add-item" style="margin-top:2px;">
												...
												<div class="form-group">
													...
													<input type="hidden" name="department[]" id="dept_1">
														...
														<div class="col-xs-2">
															<input type="hidden" name="partyac_id[]" id="partyac_1" value="{{$item->party_account_id}}">
															<span class="small">Party Name</span> <input type="text" id="party_1" name="party_name[]" value="{{$item->party_name}}" class="form-control" data-toggle="modal" data-target="#paccount_modal">
														</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="debit" name="debit" readonly value="{{number_format($crrow->debit,2)}}" placeholder="0.00">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="credit" name="credit" readonly placeholder="0.00" value="{{number_format($crrow->credit,2)}}">
                                    </div>
                                </div>
