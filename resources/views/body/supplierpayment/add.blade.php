								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
										<div class="input-group">
											...
											<input type="number" step="any" class="form-control <?php if($errors->has('amount')) echo 'form-error';?>" value="" id="amount" name="amount">
...
$(function(){
  $(':input[type=number]').on('mousewheel',function(e){ $(this).blur(); });
	...
	$(document).on('click', '#supplierData .supp', function(e) {
	   ...
	   $('#drTransactionData').load(url, function(result) {
		  $('#myModal').modal({show:true}); $('.bl-dtls, .ob-dtls').hide(); 
	   });
