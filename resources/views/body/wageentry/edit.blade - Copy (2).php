						...
						<div id="getempData"> 
							...
							<div id="empinfo">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="desc_allowance2" autocomplete="off" name="desc_allowance2" value="{{$wagerow->desc_allowance1}}" placeholder="Description">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="desc_allowance3" autocomplete="off" name="desc_allowance3" value="{{$wagerow->desc_allowance1}}" placeholder="Description">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="desc_allowance4" autocomplete="off" name="desc_allowance4" value="{{$wagerow->desc_allowance1}}" placeholder="Description">
									</div>
								</div>
								<hr/>
								<div class="form-group">
									...
									<?php 
										...
										<?php 
											...
											if($employee->nwage==30) {
												...
												$div = cal_days_in_month(CAL_GREGORIAN, $month, $year);
											}
											...
											if($employee->otwage==30) {
												...
												$divot = cal_days_in_month(CAL_GREGORIAN, $month, $year);
											}
											
											$mth = cal_days_in_month(CAL_GREGORIAN, $month, $year);
											...
											if($employee->nwage==365)
												$total_wage = number_format($per_hr_sal,3) * $parameter->nwh;
											else
											...
											$i=0;
											$mth = cal_days_in_month(CAL_GREGORIAN, $wagerow->month, $wagerow->year);
...
function getNetTotal() { 
	...
	var ded = (lev * itl) + (lev * al);//(basic_net > wage_total)?basic_net - wage_total: 0;
