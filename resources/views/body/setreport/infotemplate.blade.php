												...
												<tr>
													<td width="4%" >
														<select id="tbox_{{$i}}" class="form-control select2" style="width:100%" name="text_no[]">
															<option value="1" {{($row->colno==1)?'selected':'' }}>1</option>
															<option value="2" {{($row->colno==2)?'selected':'' }}>2</option>
														</select>
														<input type="hidden" name="input_text[]" id="txt_{{$i}}" value="Text Box">
													</td>
													<td width="4%" >
														<input type="hidden" name="id[]" id="id_{{$i}}" value="{{$row->id}}">
														<input type="text" name="label[]" id="lbl_{{$i}}" value="{{$row->label1}}" autocomplete="off" required class="form-control">
													</td>
													<td width="4%" >
...
$(document).ready(function () { 
	...
	@else
		$('#lbl2_1').show();
		$('#req2_1').show();
		$('#lbl2_1').attr("required", true);
		/* $('#lbl2_1').hide();
		$('#req2_1').hide();
		$('#lbl2_1').attr("required", false); */
	@endif
});
$(function() {	
