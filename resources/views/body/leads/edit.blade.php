                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Lead 
                            </h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmLeads" id="frmLeads" action="{{ url('leads/update/'.$docrow->id) }}">
							   <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Lead No.</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lead_no" readonly name="lead_no" value="{{$docrow->lead_no}}">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<select id="customer_type" class="form-control select2" style="width:100%" name="customer_type">
                                            <option value="0" <?php if($docrow->customer_type==0) echo 'selected';?>>New</option>
                                            <option value="1" <?php if($docrow->customer_type==1) echo 'selected';?>>Existing</option>
                                        </select>
                                    </div>
                                </div>
							...
							<div id="old_cust">
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="customer_name" name="customer_name" data-toggle="modal" data-target="#customer_modal" value="{{$docrow->master_name}}">
										<input type="hidden" name="customer_id" id="customer_id" value="{{$docrow->customer_id}}">
                                    </div>
                                </div>
							</div>
							...
							<div id="new_cust">
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Customer Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="customer_name" name="customer_name" value="{{$docrow->master_name}}">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="address" name="address" value="{{$docrow->address}}" placeholder="Address">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="phone" name="phone" value="{{$docrow->phone}}" placeholder="Phone">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="fax" name="fax" value="{{$docrow->fax}}" placeholder="Fax">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="email" name="email" value="{{$docrow->email}}" placeholder="Email">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="contact_name" name="contact_name" value="{{$docrow->contact_name}}" placeholder="Contact Person">
                                    </div>
                                </div>
							</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" value="{{$docrow->description}}" placeholder="Description">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="followup_id" id="followup_id" value="{{$rowfolo->id}}">
                                        <input type="text" class="form-control" id="title" name="title" value="{{$rowfolo->title}}" placeholder="Title">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="remarks" name="remarks" value="{{$rowfolo->description}}" placeholder="Remarks">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="salesman_id" class="form-control select2" style="width:100%" name="salesman_id">
                                            ...
                                            <option value="{{$row->id}}" <?php if($docrow->salesman_id==$row->id) echo 'selected';?>>{{$row->name}}</option>
											<?php } ?>
                                        </select>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="lead_status" class="form-control select2" style="width:100%" name="lead_status">
                                            <option value="Suspect" <?php if($docrow->lead_status=='Suspect') echo 'selected'; ?>>Suspect</option>
                                            <option value="Prospective" <?php if($docrow->lead_status=='Prospective') echo 'selected'; ?>>Prospective</option>
                                            <option value="Enquiry" <?php if($docrow->lead_status=='Enquiry') echo 'selected'; ?>>Enquiry</option>
                                        </select>
                                    </div>
                                </div>
