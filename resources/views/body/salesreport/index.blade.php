               ...
               <div class="panel panel-info">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-columns"></i> Sales Report
                            </h3>
                        </div>
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmSalesReport" id="frmSalesReport" action="{{ url('sales_report/search') }}">
								...
								<div class="row">
									...
									<div class="col-xs-6">
										...
										<select id="search_type" class="form-control select2" style="width:100%" name="search_type">
											...
											<option value="quotation" <?php if($type=='quotation') echo 'selected';?>>Quotation</option>
											<option value="sales_order" <?php if($type=='sales_order') echo 'selected';?>>Sales Order</option>
											<option value="delivery_order" <?php if($type=='delivery_order') echo 'selected';?>>Delivery Order</option>
											<option value="sales_return" <?php if($type=='sales_return') echo 'selected';?>>Sales Return</option>
										</select>
										<span></span><br/>
								...
								<div class="table-responsive m-t-10">
									<table class="table horizontal_table table-striped" id="tableAcmaster">
										...
										<?php $i=0;?>
											...
											<tr>
												...
												<td>{{ number_format($report->net_total,2) }}</td>
									...
									<button type="button" class="btn btn-primary statement" onclick="getSummary()">Sales Register(Cash,Credit)</button>
...
function getSummary() {	
	document.frmSalesReport.action = "{{ url('sales_report/summary')}}";
	document.frmSalesReport.submit();
}

function printInvoice() {	
	document.frmSalesReport.action = "{{ url('sales_report/print')}}";
	document.frmSalesReport.submit();
}
</script>
@stop
