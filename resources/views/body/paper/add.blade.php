                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> New Paper 
                            </h3>
                           
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmPaper" id="frmPaper" action="{{ url('paper/save') }}">
...
$(document).ready(function () {
	var urlname = "{{ url('paper/checkname/') }}";
