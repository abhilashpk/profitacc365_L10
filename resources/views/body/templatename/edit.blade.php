                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Email Template 
                            </h3>
                           
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmTemplateName" id="frmHeaderFooter" action="{{ url('template_name/update/'.$tnrow->id) }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="header_footer_id" value="<?php echo $tnrow->id; ?>">
                               
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ $tnrow->name }}">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="message" id="message" class="form-control editor-cls" placeholder="Message">{{ $tnrow->message }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="{{ url('template_name') }}" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
$(document).ready(function () {
    $('#frmTemplateName').bootstrapValidator({
        fields: {
        ...
        $('#frmTemplateName').data('bootstrapValidator').resetForm();
    });
});
</script>
@stop
