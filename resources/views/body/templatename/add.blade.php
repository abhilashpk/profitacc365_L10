                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> New Email Template
                        </h3>

                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" name="frmTemplateName"
                            id="frmTemplateName" action="{{ url('template_name/save') }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">

                            <div class="form-group">
                                <label for="input-text" class="col-sm-2 control-label">Template Name</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="message" id="message" class="form-control editor-cls" placeholder="Message"></textarea>
                                </div>
                            </div>
                            <!---  <div class="form-group">
