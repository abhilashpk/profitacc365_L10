                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>Email Template List
                        </h3>
                        <div class="pull-right">
                             <a href="{{ url('template_name/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableTemplate Name">
                                    <thead>
                                    <tr>
                                        <th>Name</th>
										<th>Message</th>
                                    ...
                                    <tbody>
									@foreach($templatenames as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
										<td>{{ $row->message }}</td>
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('template_name/edit/'.$row->id) }}'">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title custom_align" id="Heading5">Delete Template</h4>
                    </div>
...
function funDelete(id) {
	var con = confirm('Are you sure delete this template name?');
	if(con==true) {
		var url = "{{ url('template_name/delete/') }}";
