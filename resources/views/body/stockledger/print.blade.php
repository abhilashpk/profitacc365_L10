            ...
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
					...
					<?php if(count($results) > 0) { 
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											<?php if($result->type=='PI' || $result->type=='SR' || $result->type=='GR' || $result->type=='TI' || $result->type=='SDO') {
												 ...
												 } elseif($result->type=='SI' || $result->type=='PR' || $result->type=='GI' || $result->type=='TO' || $result->type=='CDO') {
													$bal -= $result->quantity;
											...
											<td class="text-right"><?php if($result->type=='SI' || $result->type=='PR' || $result->type=='GI' || $result->type=='TO' || $result->type=='CDO') echo $result->quantity;?></td>
						...
						<?php } else if($voucherhead=='Stock Ledger with Location' || $voucherhead=='Stock Ledger with Consignment Location') { ?>
								<table border="0" style="width:100%;height:100%;">
								<thead>
									<tr>
									...
									<tr>
										<td align="left" colspan="2" valign="top" style="padding-left:0px;">
											<h5> Item Code: <b>{{$item->item_code}}</b>,  Item Name: <b>{{$item->description}}</b></h5>
										</td>
									</tr>
								</thead>
									<tbody id="bod">
										<tr style="border:0px solid black;">
											...
											<?php foreach($results['pursales'] as $ky => $results) {  ?>
												...
												<tr>
													...
													<td>{{$result->master_name}}</td>
													@if($jobno)<td>{{$result->jobno}}</td>@endif
													<td class="text-right"><?php if($result->type=='OQ' || $result->type=='PI' || $result->type=='SR' || $result->type=='DO' || $result->type=='LT IN' || $result->type=='SDO') echo $result->lqty;?></td>
													<td class="text-right"><?php if($result->type=='CDO' || $result->type=='SI' || $result->type=='PR' || $result->type=='LT OUT') echo $result->lqty;?></td>
													<?php if($result->type=='OQ' || $result->type=='PI' || $result->type=='SR' || $result->type=='DO' || $result->type=='LT IN' || $result->type=='SDO') 
																$qtyin += $result->lqty;
														   elseif($result->type=='CDO' || $result->type=='SI' || $result->type=='PR' || $result->type=='LT OUT') 
																$qtyout += $result->lqty; ?>
													<td class="text-right">{{$qtyin - $qtyout}}</td>
												</tr>
												@endforeach
												<?php $balance = $qtyin - $qtyout; ?>
													<tr>
						...
						<?php } else if($voucherhead == 'Stock Ledger Quantity with Cost & Value Location' || $voucherhead == 'Stock Ledger Quantity with Cost & Value Consignment Location') { ?>
								<table border="0" style="width:100%;height:100%;">
									<thead>
										<tr>
											<td colspan="2" align="left">@include('main.print_head_text')<br/></td>
									...
									<tbody id="bod">
										<tr style="border:0px solid black;">
											...
											<table border="0" style="width:100%;" class="tblstyle table-bordered">
												<?php foreach($results['pursales'] as $ky => $results) { ?>
												<tr>
													<td align="left" valign="top" style="padding-left:0px;" colspan="12">
														<h6><b>Location Code: {{$locdata[$ky]->code}}, Location Name: {{$locdata[$ky]->name}}</b></h6>
													</td>
												</tr>
												<tr>
												...
												@foreach($results as $result)
												<tr>
													<?php if($result->type=='PI' || $result->type=='SR' || $result->type=='TI' || $result->type=='GR' || $result->type=='SDO' || $result->type=='OQ' || $result->type=='DO' || $result->type=='LT IN') {
															$qtyin += $result->lqty;
													...
													<td>{{$result->master_name}}</td>
													@if($jobno)<td>{{$result->jobno}}</td>@endif
													<td class="text-right"><?php if($result->type=='OQ' || $result->type=='PI' || $result->type=='SR' || $result->type=='TI' || $result->type=='GR' || $result->type=='SDO' || $result->type=='DO' || $result->type=='LT IN') echo $result->lqty;?></td>
													...
													<td class="text-right"><?php /* if($result->type=='PI' || $result->type=='SR') */ echo ($result->lqty > 0)?number_format($result->cost_avg,3):'';?></td>
													...
													<td class="text-right"><?php if($result->type=='SI' || $result->type=='PR' || $result->type=='TO' || $result->type=='GI' || $result->type=='CDO' || $result->type=='LT OUT') echo $result->lqty;?></td>
						...
						<?php } else if($voucherhead == 'Stock Ledger Quantity with Cost & Value') { ?>
								<table border="0" style="width:100%;height:100%;">
									<thead>
										<tr>
											<td colspan="2" align="left">@include('main.print_head_text')<br/></td>
										...
										<tr style="border:0px solid black;">
											...
											<table border="0" style="width:100%;" class="tblstyle table-bordered">
												...
												<tr>
													...
													<td class="text-right"><?php if($result->type=='SI' || $result->type=='PR' || $result->type=='TO' || $result->type=='GI' ||  $result->type=='CDO') echo number_format($result->sale_cost,3);?></td>
													<td class="text-right"><?php if($result->type=='SI' || $result->type=='PR' || $result->type=='TO' || $result->type=='GI' ||  $result->type=='CDO') echo $result->quantity;?></td>
													<td class="text-right"><?php if($result->type=='SI' || $result->type=='PR' || $result->type=='TO' || $result->type=='GI' ||  $result->type=='CDO') echo number_format($result->unit_cost,3);?></td>
													<td class="text-right">{{$curbalance}}</td>
												</tr>
												@endforeach
