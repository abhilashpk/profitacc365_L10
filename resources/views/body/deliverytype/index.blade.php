                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>Delivery Type List
                        </h3>
                        <div class="pull-right">
                            <a href="{{ url('delivery_type/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="tableDelivery">
                                <thead>
                                    <tr>
                                        <th>Code</th>
                                        <th>Description</th>
                                            ...
                                            <td>
                                                <p>
                                                    <button class="btn btn-primary btn-xs"
                                                        onClick="location.href='{{ url('delivery_type/edit/' . $row->id) }}'">
...
<script type="text/javascript" src="{{asset('assets/vendors/datatables/js/dataTables.scroller.js')}}"></script>
	...
	var dtInstance = $("#tableDelivery").DataTable({
        ...
        function funDelete(id) {
            var con = confirm('Are you sure delete this Delivery Type?');
            if (con == true) {
                var url = "{{ url('delivery_type/delete/') }}";
