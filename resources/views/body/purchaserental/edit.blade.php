                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Purchase 
                            </h3>
							
							<div class="pull-right">
								<a href="{{ url('purchase_rental/print/'.$row->id.'/'.$print->id) }}" target="_blank"  class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" action="{{ url('purchase_rental/update/'.$row->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<div class="input-group">
											<input type="text" name="purchase_account" id="purchase_account" class="form-control" value="{{$row->account}}" readonly>
								...
								<div class="form-group">
                                  <font color="#16A085">   <label for="input-text" class="col-sm-2 control-label"><b>Supplier</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" required value="{{$row->supplier}}" class="form-control" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
										<input type="hidden" name="supplier_id" id="supplier_id" value="{{$row->supplier_id}}">
										<input type="hidden" name="old_supplier_id" value="{{$row->supplier_id}}">
									</div>
                                </div>
