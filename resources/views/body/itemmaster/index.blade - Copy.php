            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                        <div class="panel-heading clearfix  ">
							...
							&nbsp;
							@can('item-create')
							<a href="{{ url('itemmaster/item_location') }}" class="btn btn-primary btn-sm">
									<span class="btn-label">
								</span> Item Location
							</a>
							@endcan
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="tableItem">
                                    ...
                                    <tr>
										...
										<td>
											@can('item-edit')<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('itemmaster/edit/'.$item->id) }}'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>@endcan
										</td>
										<td>
											@can('item-delete')<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $item->id }}')"><span
...
$(function() {
	...
	$('#createItm').on('click', function(e){
		...
		if(ic=="") {
			...
			$.ajax({
				...
				type: 'get',
				data: 'item_code='+ic+'&description='+dc+'&class_id='+cl+'&unit='+ut+'&vat='+vt,
	...
	$(function() {
            ...
            var dtInstance = $("#tableItem").DataTable({
                ...
                bLengthChange: false,
                mark: true,
				"aoColumns": [null,null,null,null,null,null,null,{ "bSortable": false },{ "bSortable": false },{ "bSortable": false } ],
				//"scrollX": true,
            });
