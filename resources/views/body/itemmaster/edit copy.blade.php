								...
								<table id="user" class="table table-bordered table-striped m-t-10">
										...
										<tr>
											...
											<td>@if(sizeof($itemunits) > 1)
												...
												<div><span id="title_1" style="float:left;">{{$sub}}</span><input type="text" name="packing[]" id="packing_22" value="{{ $packing }}" style="width:40%;float:left;" class="form-control" > <span id="title_12">{{$base}}</span></div>
											</td>
											<td>
										...
										<tr>
											...
											<td>@if(sizeof($itemunits) > 2)
												...
												<div><span id="title_2" style="float:left;">{{$sub}}</span><input type="text" name="packing[]" id="packing_23" value="{{ $packing }}" style="width:40%;float:left;" class="form-control" > <span id="title_13">{{$base}}</span></div>
											</td>
											<td>
											...
											<td>
												<input type="number" step="any" name="sell_price[]" id="sell_price_3" class="form-control" placeholder="S.Price(Retail)">
											</td>
											<td>
...
$(document).ready(function () {
	...
	<?php if(count($rowmaterials) == 0) { ?>$('#rMat').hide();<?php } ?>
