...
@section('content')
    <!-- Content Header (Page header) -->
        ...
        <section class="content">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body controls">
                            <form class="form-horizontal" role="form" method="POST" name="frmItem" id="frmItem" enctype="multipart/form-data" action="{{ url('itemmaster/save') }}">
								...
								<input type="hidden" name="itmHt" id="itmHt" >
								<input type="hidden" name="itmWd" id="itmWd" >
								<input type="hidden" name="itmLt" id="itmLt" >
								<input type="hidden" name="mpqty" id="mpqty" >
								...
								<?php if($formdata['description_arabic']==1) { ?>
                                   ...
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"><b>وصف السلعة</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="itmdescriptionar" name="descriptionar" placeholder="وصف السلعة">
                                    </div>
								...
								<?php } else { ?>
									...
									<table id="user" class="table table-bordered table-striped m-t-12">
										...
										<tr>
											...
											<td>
												<div><input type="text" name="pkno[]" id="pkno_22" value="1" style="width:15%;float:left;" class="form-control"> <span id="title_1" style="float:left;margin-top:6px;"></span><input type="text" name="packing[]" id="packing_22" style="width:40%;float:left;" class="form-control itemunit"><span id="title_12" style="margin-top:15px;"></span>
											</div>
											</td>
											<td>
												<input type="number" name="opn_quantity[]" step="any" readonly id="opn_qty_2" class="form-control itemunit" >
											</td>
											<td>
												<input type="number" step="any" name="opn_cost[]" readonly id="opn_cost_2" class="form-control itemunit" >
											</td>
											<td>
												<input type="number" step="any" name="sell_price[]" readonly id="sell_price_2" class="form-control itemunit" >
											</td>
											<td>
												<input type="number" step="any" name="wsale_price[]" readonly id="wsale_price_2" class="form-control itemunit" >
											</td>
											<td>
										...
										<tr>
											...
											<td>
												<div><input type="text" name="pkno[]" id="pkno_23" value="1" style="width:15%;float:left;" class="form-control"><span id="title_2" style="float:left;"></span><input type="text" name="packing[]" id="packing_23" style="width:40%;float:left;" class="form-control itemunit"><span id="title_13" style="padding-top:10px;"></span></div>
											</td>
											<td>
												<input type="number" name="opn_quantity[]" step="any" readonly id="opn_qty_3" class="form-control itemunit" >
											</td>
											<td>
												<input type="number" step="any" name="opn_cost[]" readonly id="opn_cost_3" class="form-control itemunit" >
											</td>
											<td>
												<input type="number" step="any" name="sell_price[]" readonly id="sell_price_3" class="form-control itemunit" >
											</td>
											<td>
												<input type="number" step="any" name="wsale_price[]" readonly id="wsale_price_3" class="form-control itemunit" >
											</td>
											<td>
									...
									<table id="user" class="table table-bordered table-striped m-t-12">
										...
										<tr>
											<td>
												...
												<input type="hidden" name="packing_d[]" id="packingD_1" class="form-control" readonly>
											</td>
											...
											<td>
												...
												<input type="number" name="opn_quantity_d[]" step="any" id="opn_qtyD_2" class="form-control itemunit" >
											</td>
											...
											<td>
												<input type="number" id="opn_qtyD" step="any" class="form-control" readonly >
											</td>
											<td>
												<input type="number" step="any" name="opn_cost_d[]" id="opn_costD_1" class="form-control" >
								...
								<div class="form-group batch-entry">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-10">
                                        <input type="hidden" id="batchNos" name="batchNos">
                                        <input type="hidden" id="mfgDates" name="mfgDates">
                                        <input type="hidden" id="expDates" name="expDates">
                                        <input type="hidden" id="qtyBatchs" name="qtyBatchs">
					...
					<div class="modal-content">
						...
						<div class="modal-body"><form class="form-vertical">
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="length" autocomplete="off">
								</div>
							</div>
							<div class="form-group">
								<label for="input-text" class="col-sm-2 control-label">Weight</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="weight" autocomplete="off">
								</div>
							</div>
							</form>
							<br/><br/>
           ...
           {{-- <div id="batch_view_modal" class="modal fade animated" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="modal-body" id="batchDataView">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        </div>
...
$(document).on('change','#dimension', function() { 
	...
	if((val==1) && (form==1)) {
		$('#sEntry').hide()
		$('#dimEntry').show();
	} else if ((val==1) && (form==0)) {
		$('#norEntry').hide()
		$('#dimEntry').show();
	}
	else if ((val==0) && (form==1)){
	    $('#sEntry').show()
		$('#dimEntry').hide();
	}
	else if ((val==0) && (form==0)){
	    $('#norEntry').show()
		$('#dimEntry').hide();
	}
...
$(document).on('blur', '.exp-date', function(e)  {  
    ...
    if(exp_date!='' && parseDMY(exp_date) <= parseDMY(mfg_date)) {
...
$(document).on('click', '.batch-add', function(e) { 
   ...
   if(batch!='') {
	   var vwUrl = batchurl+'?batch='+batch+'&mfg_date='+mfgdate+'&exp_date='+expdate+'&qty='+btqty+'&act=add'; 
