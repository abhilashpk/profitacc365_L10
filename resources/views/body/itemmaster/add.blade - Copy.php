								...
								<?php } else { ?>
									...
									<table id="user" class="table table-bordered table-striped m-t-12">
										...
										<tr>
											...
											<td>
												<div><span id="title_1" style="float:left;"></span><input type="text" name="packing[]" id="packing_22" style="width:40%;float:left;" class="form-control itemunit"><span id="title_12" style="padding-top:10px;"></span>
											</div>
											</td>
											<td>
									...
									<table id="user" class="table table-bordered table-striped m-t-12">
										...
										<tr>
											<td>
												<select id="unitD_1" class="form-control select2 itemunit" style="width:100%;background:#87CEFA" name="unit[]" >
													<option value="">Unit</option>
													@foreach ($units as $unit)
													<option value="{{ $unit['id'] }}">{{ $unit['unit_name'] }}</option>
													@endforeach
												</select>
												<input type="hidden" name="packing[]" id="packingD_1" class="form-control" readonly>
											</td>
											<td>
												<input type="number" name="opn_quantity[]" id="opn_qtyD_1" step="any" class="form-control" readonly >
											</td>
											<td>
												<input type="number" step="any" name="opn_cost[]" id="opn_cost_1" class="form-control" readonly>
											</td>
										...
										<tr>
											<td>
											<select id="unitD_2" class="form-control select2 itemunitD" style="width:100%" name="unit[]">
													<option value="">P1</option>
													@foreach ($units as $unit)
													<option value="{{ $unit['id'] }}">{{ $unit['unit_name'] }}</option>
													@endforeach
												</select>
												<input type="hidden" name="packing[]" id="packingD_22" style="width:40%;float:left;" class="form-control itemunit">
											</td>
											</td>
											<td><div>
												<input type="number" name="opn_quantity[]" step="any" id="opn_qtyD_2" class="form-control itemunit" >
