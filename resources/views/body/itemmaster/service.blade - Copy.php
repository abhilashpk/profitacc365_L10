<div class="panel panel-success filterable" id="newItemListLb">
	...
	<div class="table-responsive m-t-10"> <button type="button" class="btn btn-primary createItm">Create Item</button>
		<table class="table horizontal_table table-striped" id="tableItemListLb">
			<thead>
			<tr>
				<th>Item ID</th>
				<th>Item Name</th>
			...
			<tr>
				<td><a href="" class="itemRow" data-id="{{$item->id}}" data-code="{{$item->item_code}}" data-name="{{$item->description}}" data-sprice="{{($item->sell_price>0)?$item->sell_price:''}}" data-unit="{{$item->unit_name}}" data-vat="{{$item->vat}}" data-costavg="{{$item->cost_avg}}" data-purcost="{{$item->pur_cost}}" data-dismiss="modal">{{$item->item_code}}</a></td>
				<td><a href="" class="itemRow" data-id="{{$item->id}}" data-code="{{$item->item_code}}" data-name="{{$item->description}}" data-sprice="{{($item->sell_price>0)?$item->sell_price:''}}" data-vat="{{$item->vat}}" data-costavg="{{$item->cost_avg}}" data-purcost="{{$item->pur_cost}}" data-dismiss="modal">{{$item->description}}</a></td>
