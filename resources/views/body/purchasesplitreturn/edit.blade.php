                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i>  'Edit Purchase Split Return'
                            </h3>
							
							<div class="pull-right">
							@can('pi-print')
							 <a href="{{ url('purchase_split_return/print/'.$orderrow->id.'/'.$print->id) }}" target="_blank"  class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('purchase_split_return/update/'.$orderrow->id) }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="purchasesplit_return_id" id="purchasesplit_return_id" value="{{ $orderrow->id }}">
