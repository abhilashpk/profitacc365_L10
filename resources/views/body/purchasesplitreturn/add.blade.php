    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="#">Purchase Split Return</a>
                </li>
                <li class="active">
                    Add
                </li>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Purchase Split Return
                            </h3>
							
							<div class="pull-right">
							<?php if($printid) { ?>
								
								 <a href="{{ url('purchase_split_return/print/'.$printid->id.'/'.$print->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseSplit" id="frmPurchaseSplit" enctype="multipart/form-data" action="{{ url('purchase_split_return/save') }}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"><b>Purchase Split Return</b></label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                   ...
                                   <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>PSR. No.</b></label></font>
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">PSR. Date</label>
                                    <div class="col-sm-10">
                                	...
                                	<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label "> <b>Purchase Split#</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control " id="purchase_split_id" name="purchase_split_id"  placeholder="Purchase Split No" autocomplete="off" onclick="getPurchaseSplit(this)">
...
$(document).ready(function () { 
	...
	var urlvchr = "{{ url('purchase_split_return/checkvchrno/') }}";
	var urlcode = "{{ url('purchase_split_return/checkrefno/') }}"; //CHNG
	$('.sedePrntItm').toggle();
	...
	if(e.value=='') { 
		...
		if($('#department_id').length) {
			...
			var pourl = "{{url('purchase_split/ps_data/')}}/"+did;
		} else 
			var pourl = "{{url('purchase_split/ps_data/')}}";
