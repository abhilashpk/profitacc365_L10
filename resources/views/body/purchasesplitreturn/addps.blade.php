                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> 'Add Purchase Split Return'
                            </h3>
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('purchase_split_return/save/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"><b>PSR. No.</b></label></font>
                                    <div class="col-sm-10">
                                        ...
                                        <input type="hidden" name="curno" id="curno" value="{{$orderrow->voucher_no}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('purchase_split_return') }}" class="btn btn-danger">Cancel</a>
										<a href="{{ url('purchase_split_return/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
