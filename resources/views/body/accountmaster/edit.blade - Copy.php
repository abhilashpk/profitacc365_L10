                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmMaster" id="frmMaster" action="{{ url('account_master/update/'.$masterrow->id) }}">
								...
								<input type="hidden" name="item_id" value="{{ $masterrow->id }}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Account Group</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Account ID</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Account Master</label>
                                    <div class="col-sm-10">
									...
									<div class="itemdivChld">							
										<div class="form-group">
											<div class="col-xs-12">
												...
												<div class="col-xs-1">
													<span class="small">Rate</span> <input type="number" id="rate_1" step="any" autocomplete="off" name="rate[]" class="form-control rate" value="{{$row->rate}}" readonly>
												</div>
												
												<div class="col-xs-1-half">
													<span class="small">Convrt Amt</span> <input type="number" id="cnvtamt_1" step="any" autocomplete="off" name="cnvt_amt[]" value="{{$row->amount}}" class="form-control">
												</div>
										...
										<div class="itemdivChldch">							
											...
											<div class="form-group">
												...
												<div class="col-xs-10">
													...
													<div class="col-xs-4">
														<span class="small">Transaction Date</span> <input type="text" id="trdate_{{$i}}" name="tr_date[]" value="{{date('d-m-Y',strtotime($row->tr_date))}}" autocomplete="off" class="form-control chtrdate" data-language='en'>
													</div>
													<div class="col-xs-3">
														<span class="small">Description</span> <input type="text" id="description_{{$i}}" name="description[]" autocomplete="off" value ="{{$row->description}}"class="form-control"> 
													</div>
													<div class="col-xs-2"><span class="small">&nbsp; <br/></span>
														<button type="button" class="btn btn-success btn-danger btn-remove-itemch" data-id="rem_{{$i}}">
