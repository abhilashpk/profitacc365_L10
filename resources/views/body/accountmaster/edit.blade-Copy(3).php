									...
									<div class="itemdivPrntch">
										...
										<?php if($num==0) { ?>
											<div class="itemdivChldch">							
												<div class="form-group">
													...
													<div class="col-sm-2" style="width:13%">
														<span class="small">Tr. Date</span> <input type="text" id="trdate_{{$i}}" name="tr_date[]" autocomplete="off" class="form-control chtrdate" data-language='en'>
													</div>
										...
										<div class="itemdivChldch">							
											<div class="form-group">
												...
												<div class="col-sm-2" style="width:13%">
													<span class="small">Tr. Date</span> <input type="text" id="trdate_{{$i}}" name="tr_date[]" value="{{($row->tr_date!='0000-00-00')?date('d-m-Y',strtotime($row->tr_date)):''}}" autocomplete="off" class="form-control chtrdate" data-language='en'>
												</div>
												<div class="col-sm-2" style="width:15%">
													<span class="small">Description</span> <input type="text" id="description_{{$i}}" name="description[]" autocomplete="off" value ="{{$row->description}}"class="form-control"> 
												</div>
