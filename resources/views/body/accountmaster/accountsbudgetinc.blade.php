<div class="panel-body">
	...
	<div class="table-responsive m-t-10" id="accountList">
		...
		<table class="table horizontal_table table-striped" id="tableAcntList">
			...
			<tr>
				<td><a href="" class="accountRowinc" data-id="{{$account->id}}" data-code="{{$account->account_id}}" data-name="{{$account->master_name}}" data-group="{{$account->category}}" data-vatassign="{{$account->vat_assign}}" data-vat="{{$account->vat_percentage}}" data-dismiss="modal">{{$account->account_id}}</a></td>
				<td><a href="" class="accountRowinc" data-id="{{$account->id}}" data-code="{{$account->account_id}}" data-name="{{$account->master_name}}" data-group="{{$account->category}}" data-vatassign="{{$account->vat_assign}}" data-vat="{{$account->vat_percentage}}" data-dismiss="modal">{{$account->master_name}}</a></td>
	...
	<div class="panel-body">  <button type="button" class="btn btn-primary listCust">List Accounts</button>
		...
		<div class="col-xs-10">
			...
			<div id="sucessmsg"><br/>
				...
				<a href="" class="btn btn-primary inc" id="cususe" data-dismiss="modal">
