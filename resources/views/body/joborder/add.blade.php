                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="{{ url('job_order/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="joborder_id" readonly name="joborder_id" placeholder="Copy from existing order" autocomplete="off" onclick="getJobOrder()">
                                    </div>
                                </div>
								<?php } else { ?>
									<input type="hidden" name="joborder_id" id="joborder_id">
								<?php } ?>
