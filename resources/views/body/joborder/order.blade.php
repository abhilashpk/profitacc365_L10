                    ...
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-columns"></i> Job Order
                            </h3>
                        </div>
                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td><a href="#" class="quot-data" data-id="{{$order->id}}" data-name="{{$order->voucher_no}}" data-toggle="modal" data-target="#quot_modal">{{ $order->prefix.$order->voucher_no }}</a></td>
...
function setTransfer() {
	...
	//alert(items);
	if(curl=='SO')
		url = "{{ url('customers_do/add/') }}/"+items+"/SO"; //url = "{{ url('sales_invoice/add/') }}/"+items+"/SO";
	else if(curl=='SOI')
		url = "{{ url('job_invoice/add/') }}/"+items+"/SO";
	else if(curl=='JE')
		url = "{{ url('job_estimate/add/') }}/"+items;
	else
