        ...
        <section class="content p-l-r-15" id="cost-job">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
							<table border="0" style="width:100%;">
								<tr><td width="10	0%" align="center"><h3>{{Session::get('company')}}</h3></td>
									<td align="left"></td>
								</tr>
								<tr>
							...
							<?php if($type=="detail") { ?>
								<table class="table" border="0">
									...
									<tr>
										...
										<td><b>JO.Date</b> {{date('d-m-Y', strtotime($report[0]->voucher_date))}}</td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('job_order/export') }}">
