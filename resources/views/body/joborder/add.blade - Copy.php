...
@section('content')
    <!-- Content Header (Page header) -->
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmVehicleSrch" id="frmVehicleSrch" action="{{ url('job_order/vehsearch') }}">
			 <input type="hidden" name="_token" value="{{ csrf_token() }}">
			 <div class="row">
			 <div class="col-lg-12">
				<?php if($search && empty($vehicledata)) { ?>
				<div class="alert alert-warning">
					<p>
						Vehicle No. not found! Please create new one.
					</p>
				</div>
				<?php } ?>
					<div class="panel panel-info">
						<div class="panel-heading clearfix">
							<h3 class="panel-title pull-left m-t-6">
								<i class="fa fa-fw fa-list-alt"></i> Vehicle Search
							</h3>
						</div>
						<div class="panel-body">
								<div class="row" style="padding-left:300px;">
									<div class="col-xs-6">
										...
										<input type="text" name="vehicle" autocomplete="off" id="vehicle" class="form-control" placeholder="Vehicle Reg. No." value="<?php echo (isset($vehicledata))?$vehicledata->reg_no:''?>">
									</div>
									<div class="col-xs-6">
									<!--<span>Mobile No:</span>
								...
								<div class="row" style="padding-left:300px;">
									<div class="col-xs-6"><br/>
										...
										<a href="" class="btn btn-primary vehicleform" data-toggle="modal" data-target="#vehicleform_modal">Create New Vehicle</a>
									</div>
								</div>
								<?php } ?>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="{{ url('job_order/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" autocomplete="off" name="description" placeholder="Description">
                                    </div>
                                </div>
...
$(function() {	
	...
	//NEW VCLE
	var vclurl = "{{ url('job_order/vehicle_form/') }}";
	$('.vehicleform').click(function() {
		$('#vehicleformData').load(vclurl, function(result) {
			$('#myModal').modal({show:true});
		});
	});
