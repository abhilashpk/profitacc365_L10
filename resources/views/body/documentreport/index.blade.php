            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmDOCReport" id="frmDOCReport" action="{{ url('document_report/search') }}" >
								...
								<div class="row">
									...
									<div class="col-xs-6">
										...
										<select id="search_type" class="form-control select2" style="width:100%" name="search_type">
											<option value="PO" <?php if($type=='PO') echo 'selected';?>>Purchase Order</option>
											<option value="QS" <?php if($type=='QS') echo 'selected';?>>Quotation Sales</option>
											<option value="SO" <?php if($type=='SO') echo 'selected';?>>Sales Order</option>
											<option value="SDO" <?php if($type=='SDO') echo 'selected';?>>Sales DO</option>
										</select>
										<span></span><br/>
