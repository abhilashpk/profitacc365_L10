...
$(function(){
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
	...
	var lastId = $('.itemdivPrnt .classtrn:last').attr('id');
    var lastIdx = lastId ? parseInt(lastId.split('_')[1],10) : parseInt($('#bnum').val(),10);
...
$(document).on('click', '.btn-remove-item', function(e) { 
	...
	$(document).on('click', '.add-invoice', function(e)  { 
		...
		var no = parseInt($('#bnum').val(),10); //var no = $('#bnum').val(); //var rowNum;
