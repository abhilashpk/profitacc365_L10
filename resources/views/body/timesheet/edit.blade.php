                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmWageEntry" id="frmWageEntry" action="{{ url('wage_entry/timesheet/update/') }}" >
                           ...
                           <div class="col-sm-2">
							...
							<a href="{{ url('wage_entry/timesheet/edit') }}" class="btn btn-danger">Clear</a>
						</div>
						</div>	
								...
								<div class="itemdivPrnt">
									...
									<?php 
										...
										<tr>
                                            ...
                                            <td width="6%">
												<span class="small">Day Type</span>
                                                <select id="daytype_{{$i}}" name="day_type[]" class="form-control day-type">
							                           <option value="wday" <?php if($row->day_type=='wday') echo 'selected';?>>Working</option>
													   <option value="hday" <?php if($row->day_type=='hday') echo 'selected';?>>Holiday</option>
						                                </select>
                                                </td>
											
											<td width="5%">
												<span class="small">Start Time</span><input type="time"  name="start_time[]" value="<?php echo ($row->start_time=='00:00:00')?'':$row->start_time; ?>" id="start_{{$i}}"  step="any" autocomplete="off" class="form-control start-time" >
											</td>
											<td width="5%">
												<span class="small">End Time</span><input type="time" id="end_{{$i}}" step="any" value="<?php echo ($row->end_time=='00:00:00')?'':$row->end_time; ?>" name="end_time[]" autocomplete="off" class="form-control end-time" >
											</td>
											<td width="5%">
												<span class="small">Break</span><input type="text" id="break_{{$i}}" step="any" value="{{$row->break_time}}" name="break_time[]"  autocomplete="off" class="form-control break-time" >
											</td>
											<td width="4%">
											...
											<td width="8%">
						                        ...
						                        <input type="hidden" name="job_id[]" id="jobid_{{$i}}" value="{{$row->job_id}}">
						                           ...
						                           <input type="text" id="jobcod_{{$i}}" name="job_code[]" class="form-control"  value="{{$row->job_name}}" autocomplete="off" data-toggle="modal" data-target="#job_modal"   placeholder="Job Code">
					                        </td>
											<td width="4%">
										   ...
										   <select id="levstus_{{$i}}" name="leave_status[]" class="form-control ">
													   ...
													   <option value="P" <?php if($row->leave_status=='P') echo 'selected';?>>Paid</option>
						                                </select>
											</div>			
										   </td >
										</tr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Update</button>
                                         <a href="{{ url('wage_entry/timesheet/edit') }}" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                                <?php }  ?>
...
$(document).on('click', '.subjobRow', function(e) {
	...
	document.getElementById("search").onclick = function () {
       ...
       var mon=$('#date').val();
        location.href = "{{ url('wage_entry/timesheet/edit/') }}/"+emp+"/"+cat+"/"+mon;
    };
