            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="GET" name="frmTrialBalance" id="frmTrialBalance" target="_blank" action="{{ url('trial_balance2/search') }}">
								...
								<div class="row">
									<div class="col-xs-6">
										<span>Date From:</span>
										<input type="text" name="from_date" data-language='en' id="date_from" class="form-control" autocomplete="off">
										<span>Date To:</span>
										<input type="text" name="to_date" data-language='en' id="date_to" class="form-control" autocomplete="off">
