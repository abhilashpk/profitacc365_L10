                                            ...
                                            <table border="1" cellpadding="5" cellspacing="0" class="table table">
                                                ...
                                                <tbody>
                                                    @php
                                                        ...
                                                        $grandCr = 0;
                                                    @endphp
                                                    @foreach($groupedSummary as $groupName => $summary)
                                                        <tr>
                                                            <td>{{ $groupName }}</td>
                                                            <td style="text-align:right">{{ number_format($summary['debit'], 2) }}</td>
                                                            <td style="text-align:right">{{ number_format($summary['credit'], 2) }}</td>
                                                        </tr>
                                                        @php
