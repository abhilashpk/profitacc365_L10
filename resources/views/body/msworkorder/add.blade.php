                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmWorkorder" id="frmWorkorder" action="{{url('ms_workorder/save')}}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="reference_no" name="reference_no" autocomplete="on" >
										</div>
									</div>
									...
									<div class="form-group">
										<label for="input-text" class="col-sm-3 control-label">Technicians</label>
										<div class="col-sm-9">
