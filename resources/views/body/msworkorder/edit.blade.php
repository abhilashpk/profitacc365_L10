                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmWorkorder" id="frmWorkorder" action="{{url('ms_workorder/update/'.$worow->id)}}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="location" value="{{$worow->location}}" name="location" autocomplete="on" >
										</div>
									</div>
									...
									<div class="form-group">
										<label for="input-text" class="col-sm-3 control-label">Customer Reference No.</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="reference_no" name="reference_no" autocomplete="on" value="{{$worow->reference_no}}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select id="select22" class="form-control select2" name="technician_id[]" multiple style="width:100%">
												<?php $tarr = explode(',' , $worow->technician); ?>
												@foreach($technician as $row)
												<option value="{{ $row->name }}" <?php echo (in_array($row->name, $tarr))?'selected':'';?>>{{ $row->name }}</option>
												@endforeach
											</select>
										</div>
									</div>
