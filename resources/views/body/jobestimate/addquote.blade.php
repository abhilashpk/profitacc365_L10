                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> New Job Estimate
                            </h3>
                        </div>
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="{{ url('job_estimate/save') }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">JE. No.</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">JE. Date</label>
                                    <div class="col-sm-10">
...
//
$(function() {	
	var rowNum = $('#rowNum').val(); var descNum = $('#descNum').val();
