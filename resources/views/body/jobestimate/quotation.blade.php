                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td><a href="#" class="quot-data" data-id="{{$quotation->id}}" data-name="{{$quotation->voucher_no}}" data-toggle="modal" data-target="#quot_modal">{{ $quotation->prefix.$quotation->voucher_no }}</a></td>
...
function setTransfer() {
	...
	var curl = $('#url').val();
	if(curl=='so')
		url = "{{ url('job_order/add/') }}/"+items+"/SO";
	else if(curl=='cdo')
		url = "{{ url('customers_do/add/') }}/"+items+"/CDO";
	else if(curl=='QS')
		url = "{{ url('customers_do/add/') }}/"+items+"/QS"; //url = "{{ url('sales_invoice/add/') }}/"+items+"/QS";
	else if(curl=='QSI')
		url = "{{ url('job_invoice/add/') }}/"+items+"/QS";
