                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i>  Job Estimate
                            </h3>
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('job_estimate/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" name="reference_no" readonly value="<?php echo (old('reference_no'))?old('reference_no'):$orderrow->reference_no; ?>" placeholder="Reference No.">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' readonly value="{{date('d-m-Y',strtotime($orderrow->voucher_date))}}"  id="voucher_date" placeholder="Estimate Date" autocomplete="off"/>
                                    </div>
                                </div>
								...
								@if(Session::get('mod_vehicle_cust')==0)
    								<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="customer_name" id="customer_name" readonly value="<?php echo (old('customer_name'))?old('customer_name'):$orderrow->customer; ?>" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="off"  placeholder="Customer">
    								...
    								<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="vehicle_name" id="vehicle_name"  readonly value="<?php echo (old('vehicle_name'))?old('vehicle_name'):$orderrow->vehicle; ?>" class="form-control" autocomplete="off"  placeholder="Vehicle">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="salesman" id="salesman" readonly value="<?php echo (old('salesman'))?old('salesman'):$orderrow->salesman; ?>" class="form-control" autocomplete="off"  placeholder="Technician">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="subject" readonly value="<?php echo (old('subject'))?old('subject'):$orderrow->subject; ?>" name="subject" placeholder="Subject">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" readonlyvalue="<?php echo (old('description'))?old('description'):$orderrow->description; ?>" name="description" placeholder="Description">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="kilometer" name="kilometer"readonly  value="<?php echo (old('kilometer'))?old('kilometer'):$orderrow->kilometer; ?>" placeholder="Kilometer">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                  <font color="#16A085"><label for="input-text" class="col-sm-2 control-label"><b>Job Code</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" class="form-control" readonly autocomplete="off" value="{{$orderrow->name}}">
								...
								<label for="input-text" class="col-sm-2 control-label " id="">Items Description </label>
											<div class="col-sm-6">
												<input type="text" class="form-control" id="items_description" autocomplete="off"  readonly name="items_description"value="{{$orderrow->items_description}}" placeholder="Items Description">
											</div>
								</div>
								<?php } else {?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_{{$i}}" name="item_code[]" class="form-control" readonly autocomplete="off" value="{{$item->item_code}}" >
												</td>
												<td width="29%">
													<input type="text" name="item_name[]" id="itmdes_{{$i}}" autocomplete="off"readonly  class="form-control" value="{{$item->item_name}}">
												</td>
												<td width="7%">
													<select id="itmunt_{{$i}}" class="form-control select2 line-unit"  readonly style="width:100%" name="unit_id[]">
													<option value="{{$item->unit_id}}">{{$item->unit_name}}</option></select>
													</select>
												</td>
												<td width="8%">
													<input type="number" id="itmqty_{{$i}}" name="quantity[]" readonly step="any" autocomplete="off" class="form-control line-quantity" value="{{$item->quantity}}">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_{{$i}}" step="any" name="cost[]" readonly autocomplete="off" class="form-control line-cost" value="{{$unit_price}}">
												</td>
												<td width="6%">
													<select id="taxcode_{{$i}}" class="form-control select2 tax-code" style="width:100%" readonly  name="tax_code[]"><option value="SR" <?php if($item->tax_code=="SR") echo 'selected'; ?>>SR</option><option value="EX" <?php if($item->tax_code=="EX") echo 'selected'; ?>>EX</option><option value="ZR" <?php if($item->tax_code=="ZR") echo 'selected'; ?>>ZR</option></select>
												</td>
												<td width="6%">
													<select id="txincld_{{$i}}" class="form-control select2 taxinclude" style="width:100%"  readonly name="tax_include[]"><option <?php if($item->tax_include==0) echo 'selected';?> value="0">No</option><option <?php if($item->tax_include==1) echo 'selected';?> value="1">Yes</option></select>
												</td>
												<td width="9%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" placeholder="0" value="<?php echo (old('vat_fc'))?old('vat_fc'):intval($orderrow->vat_amount*100)/100; ?>" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="header_id" id="header_id" value="{{$orderrow->hid}}">
                                        <input type="text" class="form-control" id="headermsg" name="header" value="{{$orderrow->header}}" placeholder="Header" autocomplete="off" data-toggle="modal" data-target="#header_modal">
                                    </div>
                                </div>
                                <?php } else { ?>
														...
														<div class="file-drop-disabled">
															<div class="file-preview-thumbnails">
																<div class="file-live-thumbs">
																	<a href="{{asset('uploads/jobestimate/'.$prow->photo)}}" target="_blank">View Image {{$i}}</a>
																</div>
															</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('job_estimate') }}" class="btn btn-primary">Back</a>
...
$(document).ready(function () { 
	...
	$('.descdivPrnt').find('.btn-add-desc-com:not(:last)').hide();
					...
					remote: {
                        ...
                        data: function(validator) {
                            return {
								...
								id: validator.getFieldElements('quotation_order_id').val()
                            };
                        },
