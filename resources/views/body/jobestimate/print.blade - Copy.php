                ...
                <div class="panel-body">
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								<tr>
									<td colspan="2" align="left"><img src="{{asset('assets/'.Session::get('logo').'')}}" height="75%" width="100%" /></td>
								</tr>
								<tr>
									<td align="center" style="padding-left:160px;"><h5><b><u>ESTIMATE</u></b></h5>TRN No: {{Session::get('vatno')}}</td>
									<td align="right" style="padding-left:0px;">
										<div>
											<b>Est. No: {{$details->voucher_no}}</b><br/>
								...
								<tr>
									<td align="left" valign="top" style="padding-left:20px; padding-bottom:5px;">
										<div>
											<strong><?php echo ($details->supplier=='CASH CUSTOMER' || $details->supplier=='Cash Customer')?'CASH CUSTOMER:'.$details->customer_name:$details->supplier;?></strong><br/>
