        ...
        <section class="content p-l-r-15" id="cost-job">
            <div class="panel">
                ...
                <div class="panel-body">
							...
							<?php if($type=="detail") { ?>
								<table class="table" border="0">
									...
									<tr>
										...
										<td><b>Qtn.#:</b> {{$report[0]->voucher_no}}</td>
										<td><b>Qtn.Date</b> {{date('d-m-Y', strtotime($report[0]->voucher_date))}}</td>
										<td><b>Qtn.Ref.#:</b> {{$report[0]->reference_no}}</td>
									...
									<tr>
										...
										<td class="text-right"><b>Qtn.Qty.</b></td>
							...
							<?php } elseif($type=="detail_pending") { ?>
								<table class="table" border="0">
									...
									<tr>
										...
										<td><b>Qtn.#:</b> {{$report[0]->voucher_no}}</td>
										<td><b>Qtn.Date</b> {{date('d-m-Y', strtotime($report[0]->voucher_date))}}</td>
										<td colspan="2"><b>Qtn.Ref.#:</b> {{$report[0]->reference_no}}</td>
									...
									<tr>
										<td><b>Item Code</b></td>
										<td><b>Description</b></td>
										<td class="text-right"><b>PO.Qty.</b></td>
										<td class="text-right"><b>Rate</b></td>
										<td class="text-right"><b>Total Amt.</b></td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											@foreach($reports as $report)
											<tr>
												<td><b>SI.No:</b> {{$report[0]->voucher_no}} &nbsp;  <b>JE.Date</b> {{date('d-m-Y', strtotime($report[0]->voucher_date))}}</td>
												<td><b>JE.Ref.#:</b> {{$report[0]->reference_no}}</td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('job_estimate/export') }}">
