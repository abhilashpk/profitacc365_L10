                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Add Job Estimate
                            </h3>
							
							<div class="pull-right">
							@can('qs-print')
							 <a href="{{ url('job_estimate/print/'.$orderrow->id.'/'.$print->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('job_estimate/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="{{date('d-m-Y',strtotime($orderrow->voucher_date))}}"  id="voucher_date" placeholder="Estimate Date" autocomplete="off"/>
                                    </div>
                                </div>
								...
								<?php if(Session::get('mod_jo_to_je')==1) { ?>
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"> Job Order#</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document_no" readonly name="document_no" value="{{$orderrow->voucher_no}}" autocomplete="off">
                                        <input type="hidden" id="document_id" name="document_id" value="{{$orderrow->id}}">
                                        <input type="hidden" id="document_type" name="document_type" value="JO">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="subject" value="<?php echo (old('subject'))?old('subject'):$orderrow->subject; ?>" name="subject" placeholder="Subject">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="kilometer" name="kilometer" value="<?php echo (old('kilometer'))?old('kilometer'):$orderrow->kilometer; ?>" placeholder="Kilometer">
                                    </div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="hidden" name="so_item_id[]" id="so_itemid_{{$i}}" value="{{$item->id}}">
								...
								<?php $i++; } } else { $total = $vat_amount_net = $net_total  = ''; $itemdesc = []; ?>
								@if(count($orditems) > 0)
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
												    ...
												    <input type="hidden" name="so_item_id[]" id="so_itemid_1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('job_estimate/edit/'.$orderrow->id) }}" class="btn btn-danger">Clear</a>
                                    </div>
                                </div>
