                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							@can('qs-print')
							 <a href="{{ url('job_estimate/print/'.$orderrow->id) }}" target="_blank" class="btn btn-info btn-sm">
										...
										foreach(old('item_code') as $product) { $j = $i+1;?>
											<div class="itemdivChld">
												<table border="0" class="table-dy-row">
													<tr>
														<td width="16%">
															<input type="hidden" name="order_item_id[]" id="p_orditmid_{{$i}}">
															<input type="hidden" name="item_id[]" id="itmid_{{$j}}" value="{{ old('item_id')[$i]}}">
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="lbitmcod_1" name="lbitem_code[]" class="form-control" autocomplete="off" autocomplete="off" placeholder="Item Code" data-toggle="modal" data-target="#lbitem_modal">
												</td>
												<td width="29%">
													<input type="text" name="lbitem_name[]" id="lbitmdes_1" autocomplete="off" class="form-control" placeholder="Item Description">
												</td>
												<td width="7%">
