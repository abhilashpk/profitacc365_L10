...
@section('content')
    <!-- Content Header (Page header) -->
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmVehicleSrch" id="frmVehicleSrch" action="{{ url('job_estimate/vehsearch') }}">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" id="frmQuotationSales" action="{{ url('job_estimate/save') }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="reference_no" autocomplete="off" name="reference_no" placeholder="Reference No.">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name" id="customer_name" value="<?php echo (isset($vehicledata))?$vehicledata->customer:''?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo (isset($vehicledata))?$vehicledata->customer_id:''?>">
										<?php if(isset($vehicledata) && $vehicledata->customer_name!='') { ?>
										<div class="col-xs-10" id="newcustomerInfo">
											<div class="col-xs-6">
												<span class="small">Customer Name</span> <input type="text" id="customer_name" name="customer_name" value="{{$vehicledata->customer_name}}" class="form-control" autocomplete="off">
											</div>
											<div class="col-xs-4">
												<span class="small">Phone No</span> <input type="text" id="customer_phone" name="customer_phone" value="{{$vehicledata->phone}}" class="form-control" autocomplete="off">
											</div>
										</div>
										<?php } ?>
									</div>
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Vehicle Reg. No.</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="vehicle_regno" id="vehicle_regno" value="<?php echo (isset($vehicledata))?$vehicledata->reg_no:''?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#vehicle_modal" placeholder="Vehicle">
									</div>
                                </div>
								...
								<input type="hidden" id="is_fc" name="is_fc" value="1">
								...
								<input type="hidden" id="export" name="is_export" value="1">
									...
									<div class="itemdivChld">
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="29%">
													<span class="small">Item Description</span><input type="text" name="item_name[]" id="itmdes_1" autocomplete="off" class="form-control" data-toggle="modal" data-target="#item_modal" placeholder="Item Description">
												</td>
												<td width="7%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" id="subtotal" step="any" name="subtotal" class="form-control" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" id="subtotal_fc" step="any" name="subtotal_fc" class="form-control" readonly placeholder="0">
										</div>
									</div>
                                </div>
							...
							<div id="vehicleform_modal" class="modal fade animated" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        ...
                                        <div class="modal-body" id="vehicleformData">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close
                                            </button>
							...
							<div id="customeron_modal" class="modal fade animated" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
									...
									<div class="modal-body" id="customeronData">
...
$(function() {	
	...
	//NEW VCLE
	var vclfrmurl = "{{ url('job_order/vehicle_form/') }}";
	$('.vehicleform').click(function() {
		$('#vehicleformData').load(vclfrmurl, function(result) {
			$('#myModal').modal({show:true});
		});
	});
	
	//NEW VCLE
	$(document).on('click', '.vclfrmRow', function(e) {
		$('#vehicle_name').val($(this).attr("data-vname"));
		$('#vehicle_id').val($(this).attr("data-vid"));
		$('#customer_name').val($(this).attr("data-cname"));
		$('#customer_id').val($(this).attr("data-cid"));
		e.preventDefault();
	});
	...
	$(document).on('click', '#customeron_modal .custRow', function(e) {
		$('#customerV').val($(this).attr("data-name"));
		$('#customer_idV').val($(this).attr("data-id"));
		e.preventDefault();
	});
