            ...
            <div class="row">
				...
				<?php if(sizeof($vouchers)==0) { ?>
					<div class="alert alert-warning">
						<p>
							Stock Transfer out voucher is not found! Please create a voucher in Account Settings.
						</p>
					</div>
					<?php } else { ?>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmStockTransfer" id="frmStockTransfer" action="{{ url('stock_transferout/save') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('stock_transferout') }}" class="btn btn-danger">Cancel</a>
										<a href="{{ url('stock_transferout/add') }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "{{ url('stock_transferout/checkrefno/') }}";
...
$(function() {	
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "{{ url('stock_transferout/checkvchrno/') }}", 
			type: 'get',
