                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Stock Transfer
                            </h3>
							
							<div class="pull-right">
							
							 <a href="{{ url('stock_transferout/print/'.$orderrow->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmStockTransfer" id="frmStockTransfer" action="{{ url('stock_transferout/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">STO. No.</label>
                                    <div class="col-sm-10">
								...
								<?php } ?>
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">STO. Date</label>
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="voucher_date" data-language='en' id="voucher_date" value="{{date('d-m-Y',strtotime($orderrow->voucher_date))}}" placeholder="STO. Date"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary" <?php if($orderrow->is_mfg==1) echo 'disabled';?>>Submit</button>
...
$(function() {	
	...
	$('#department_id').on('change', function(e){ 
		...
		$.get("{{ url('stock_transferout/getdeptvoucher/') }}/" + dept_id, function(data) { 
