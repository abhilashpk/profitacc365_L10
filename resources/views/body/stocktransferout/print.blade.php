                    ...
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								...
								<tr><td colspan="2"  align="center"><h5><b><u>Stock Transfer-Out</u></b></h5></td></tr>
								<tr style="border:0px solid black;">
									<td align="left" valign="top" style="width:50%; padding-left:20px; padding-bottom:5px;">
										<div>
											<strong><?php echo $details->dr_account;?><br/>
											<?php echo $details->cr_account;?>
											</strong>
									...
									<td align="left" style="padding-left:200px; width:50%;">
										<div>
											<b>STO. No: {{$details->voucher_no}}</b><br/>
