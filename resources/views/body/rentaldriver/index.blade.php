                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>Driver List
                        </h3>
                        <div class="pull-right">
                            <a href="{{ url('rental_driver/add') }}" class="btn btn-primary btn-sm">
                                            ...
                                            <td>
                                                <p>
                                                    <button class="btn btn-primary btn-xs"
                                                        onClick="location.href='{{ url('rental_driver/edit/' . $row->id) }}'">
...
@section('footer_scripts')
    ...
    <script>
        function funDelete(id) {
            ...
            if (con == true) {
                var url = "{{ url('rental_driver/delete/') }}";
