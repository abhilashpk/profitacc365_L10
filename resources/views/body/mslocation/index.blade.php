                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="{{ url('ms_location/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableloc">
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('ms_location/edit/'.$loc->id) }}'">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "{{ url('ms_location/delete/') }}";
