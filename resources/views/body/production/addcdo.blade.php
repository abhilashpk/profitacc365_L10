                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> New Production Order
                            </h3>
                        </div>
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmCustomerDO" id="frmCustomerDO" action="{{ url('production/save') }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="curno" id="curno" value="{{(old('curno'))?old('curno'):$voucherno}}">
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">PRO. No.</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">PRO. Date</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_date" name="lpo_date" data-language='en' value="<?php echo ($quoterow->lpo_date=='0000-00-00')?'':date('d-m-Y',strtotime($lpodt)); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
										...
										<?php
											if($item->balance_quantity==0) {
												...
												if($quoterow->is_fc==1) {
													...
													$subtotal = $total += $line_total;
													$vattotal = $quoterow->vat_amount;//+= ($line_total * $item->vat)/100;
								...
								<?php $nettotal += $total + $vat_amount - $quoterow->discount; $nettotal_dh += $total_dh + $vattotal_dh;?>
								</fieldset>
								<div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal" name="subtotal" class="form-control spl" readonly value="<?php echo (old('subtotal'))?old('subtotal'):intval($subtotal*100)/100; ?>">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" placeholder="0" value="<?php echo (old('vat'))?old('vat'):intval($vat_amount*100)/100; ?>" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" placeholder="0" value="<?php echo (old('vat_fc'))?old('vat_fc'):intval($vattotal_dh*100)/100; ?>" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="foot_description" id="foot_description" class="form-control editor-cls" placeholder="Description">{{$quoterow->foot_description}}</textarea>
                                    </div>
                                </div>
								<?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('production') }}" class="btn btn-danger">Cancel</a>
...
$(document).ready(function () { 
	...
	var urlcode = "{{ url('production/checkrefno/') }}";
