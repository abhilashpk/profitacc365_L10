                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								@can('do-print')
								 <a href="{{ url('production/print/'.$printid->id.'/45') }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmCustomerDO" id="frmCustomerDO" action="{{ url('production/save') }}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('voucher_no')) echo 'form-error';?>">PRO. No.</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('production/add') }}" class="btn btn-warning">Clear</a>
										@can('do-history')
...
$(document).ready(function () { 
	...
	var urlvchr = "{{ url('production/checkvchrno/') }}"; //CHNG
...
$(function() {	
	...
	$('#customer_name').on('blur', function(e){ //$('#document_type').on('change', function(e){
		...
		$.ajax({
			url: "{{ url('production/set_session/') }}",
			type: 'get',
