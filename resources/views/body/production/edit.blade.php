                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> <?php if($orderrow->is_editable==1) { echo 'Non-Editable'; } else echo 'Edit Production Order';?>
                            </h3>
							
							<div class="pull-right">
							@can('do-print')
							 <a href="{{ url('production/print/'.$orderrow->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
							<form class="form-horizontal" role="form" method="POST" name="frmCustomerDO" id="frmCustomerDO" action="{{ url('production/update/'.$orderrow->id) }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="production_id" id="production_id" value="{{ $orderrow->id }}">
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"><b>PRO. No.</b></label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="{{date('d-m-Y',strtotime($orderrow->voucher_date))}}" id="voucher_date" placeholder="DO. Date"/>
                                    </div>
                                </div>
								...
								<?php $i++; } } else { 
									$total = $vat_amount_net = $net_total = 0;
									?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_{{$i}}" name="item_code[]" class="form-control" autocomplete="off" value="{{$item->item_code}}" autocomplete="off" data-toggle="modal" data-target="#item_modal">
												</td>
												<td width="29%">
								...
								<?php } else { ?>
								<input type="hidden" name="infoadd" id="infoadd">
							    <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('production/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
