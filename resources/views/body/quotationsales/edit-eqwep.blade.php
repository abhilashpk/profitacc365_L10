                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('quotation_sales/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" name="reference_no" value="<?php echo (old('reference_no'))?old('reference_no'):$orderrow->reference_no; ?>" placeholder="Attn.">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="{{date('d-m-Y',strtotime($orderrow->voucher_date))}}" id="voucher_date" placeholder="QS. Date"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name" id="customer_name" value="<?php echo (old('customer_name'))?old('customer_name'):$orderrow->customer; ?>" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="subject" autocomplete="on" value="<?php echo (old('subject'))?old('subject'):$orderrow->subject; ?>" name="subject" placeholder="Subject">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" autocomplete="on" value="<?php echo (old('description'))?old('description'):$orderrow->description; ?>" name="description" placeholder="Description">
                                    </div>
                                </div>
                                <?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="footermsg" name="footer" value="{{$orderrow->footer_text}}" placeholder="Footer" autocomplete="off" data-toggle="modal" data-target="#footer_modal">
                                    </div>
                                </div>
								<?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('quotation_sales/edit/'.$orderrow->id) }}" class="btn btn-danger">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	$('.infodivPrnt').toggle();  $('.maildivPrnt').toggle();
    ...
    $('#frmPurorder').bootstrapValidator({
        fields: {
			...
			//'quantity[]': { validators: { notEmpty: { message: 'The item description is required and cannot be empty!' } }}
        }
