                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								@can('qs-print')
								 <a href="{{ url('quotation_sales/print/'.$printid) }}" target="_blank" class="btn btn-info btn-sm">
										...
										<table border="0" style="border-spacing: 2px; margin-top:10px;">
											<tr>
												<td width="3%" align="center">
													<input type="text" name="orderno[]" id="ordr_{{$i}}" readonly class="form-control" value="{{$item->orderno}}">
												</td>
												...
												<td width="15%" style="padding-left:2px;">
													<input type="text" name="remarks[]" id="remrk_{{$i}}" autocomplete="on" class="form-control"  value="{{$item->remarks}}" >
													<input type="hidden" id="itmunt_{{$i}}" name="unit_id[]" value="{{$item->unit_id}}">
												</td>
												<td width="7%" style="padding-left:2px;">
													<input type="number" id="itmqty_{{$i}}" step="any" name="quantity[]" required autocomplete="off" class="form-control line-quantity" value="{{$item->quantity}}">
												</td>
												...
												<td width="7%" style="padding-left:2px;">
													...
													<input type="hidden" id="taxcode_{{$i}}" name="tax_code[]" value="SR">
													<input type="hidden" id="txincld_{{$i}}" name="tax_include[]" value="0">
												</td>
												<td width="15%" style="padding-left:2px;">
...
$(function() {	
	...
	$(document).on('click', '.btn-add-item', function(e)  { 
        ...
        var controlForm = $('.controls .itemdivPrnt'),
			...
			newEntry.find('.btn-remove-item').removeAttr('data-id'); 
