        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										<td colspan="2" align="center">
											...
											<body>
											<?php $total_net = $discount = $total_vat = $total_gross =$total_amt=$total= 0;?>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												<td><b>SI.No:</b> {{$report[0]->voucher_no}}  &nbsp; <b>Qtn.#:</b> {{$report[0]->voucher_no}}  &nbsp; <b>Qtn.Date</b> {{date('d-m-Y', strtotime($report[0]->voucher_date))}}</td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('quotation_sales/export') }}">
