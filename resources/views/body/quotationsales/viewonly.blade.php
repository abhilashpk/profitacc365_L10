                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> View Quotation
                            </h3>
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('quotation_sales/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
									...
									<?php if($photos!='') { $arrp = explode(',',$photos); $i=1; ?>
											...
											<div class="file-drop-disabled">
												<div class="file-preview-thumbnails">
													<div class="file-live-thumbs">
														<a href="{{asset('uploads/jobestimate/'.$prow)}}" target="_blank">View Image {{$i}}</a>
													</div>
												</div>
										...
										@endforeach
									<?php } ?>
										<input type="file" id="input-23" name="photos" class="file-loading" data-show-preview="true" data-url="{{url('job_estimate/upload/')}}" multiple="">
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_{{$i}}" step="any" name="quantity[]" {{($orderrow->is_editable==1)?'readonly':''}} autocomplete="off" class="form-control line-quantity" value="{{$item->quantity}}">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_{{$i}}" step="any" name="cost[]" autocomplete="off" {{($orderrow->is_editable==1)?'readonly':''}} class="form-control line-cost" value="{{$unit_price}}">
												</td>
												<td width="6%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" value="{{$orderrow->discount}}" class="form-control spl discount-cal" placeholder="0">
										</div>
										<div class="col-xs-2">
								...
								<?php if($formdata['footer_editable']==1) { ?>
								<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('quotation_sales/') }}" class="btn btn-primary">Back</a>
                                    </div>
                                </div>
