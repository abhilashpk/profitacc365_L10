...
@section('content')
    <!-- Content Header (Page header) -->
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->approval_status==1)?'warning':'primary';?>">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> <?php if($orderrow->approval_status==1) { echo 'Approved'; } else echo 'Quotation Sales'; ?>
                            </h3>
...
function funApproval(id) {
	var con = confirm('Are you sure you want to approve this quotqtion?');
	if(con==true) {
		var url = "{{ url('quotation_sales/approve/') }}";
