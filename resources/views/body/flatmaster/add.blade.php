                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmFlat" id="frmFlat" enctype="multipart/form-data"  action="{{url('flatmaster/save')}}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											@php $sel = "" @endphp	
											@endif
											<option value="{{ $row->id }}" {{$sel}}>{{$row->buildingcode }}</option>
											@endforeach
											<!-- @foreach($buildingmaster as $row)
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="flat_no" name="flat_no" autocomplete="off" placeholder="Flat No">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="flat_name" name="flat_name" autocomplete="off" placeholder="Flat Name">
										</div>
									</div>
