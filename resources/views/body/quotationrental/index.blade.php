...
@section('content')
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Quotation Rental
                        </h3>
                        <div class="pull-right">
							@can('qrl-create')
                             <a href="{{ url('quotation_rental/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tableQrl">
                                    <thead>
                                    <tr>
										<th>QR. No</th>
										<th>Customer</th>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" action="{{ url('quotation_rental/search') }}" target="_blank">
			 ...
			 <div class="col-lg-12">
					<div class="panel panel-info">
						<div class="panel-heading clearfix">
							<h3 class="panel-title pull-left m-t-6">
								<i class="fa fa-fw fa-list-alt"></i> Quotation Rental Report
							</h3>
						</div>
						<div class="panel-body">
								<div class="row">
...
function funDelete(id,no) {
	if(no=='0') {
		...
		if(con==true) {
			var url = "{{ url('quotation_rental/delete/') }}";
...
$(function() {
		...
		var dtInstance = $("#tableQrl").DataTable({
			"processing": true,
			"serverSide": true,
			"searching": true,
			"ajax":{
			...
			@can('qrl-edit'){ "data": "edit","bSortable": false },@endcan
			@can('qrl-print'){ "data": "print","bSortable": false },@endcan
			@can('qrl-delete'){ "data": "delete","bSortable": false },@endcan
		]	
