                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if($isprint) { ?>
							 ...
							 <a href="{{ url('quotation_rental/print/'.$orderrow->id.'/'.$print->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('quotation_rental/update/'.$orderrow->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('quotation_rental/edit/'.$orderrow->id) }}" class="btn btn-danger">Clear</a>
                                    </div>
                                </div>
...
$(function() {	
	...
	var custurl = "{{ url('quotation_rental/customer_data/') }}";
