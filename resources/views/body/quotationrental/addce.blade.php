                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Quotation Rental
                            </h3>
							
							<div class="pull-right">
							<?php if($printid) { ?>
							
								 <a href="{{ url('quotation_rental/print/'.$printid) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" id="frmQuotationSales" action="{{ url('quotation_rental/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name" id="customer_name" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" value="<?php echo (old('customer_name'))?old('customer_name'):$quoterow->customer; ?>" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="{{(old('net_amount'))?old('net_amount'):($quoterow->is_fc==1)?$quoterow->net_total_fc:$quoterow->net_total}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" value="<?php echo (old('net_amount_fc'))?old('net_amount_fc'):$quoterow->net_total; ?>" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								<hr/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('quotation_rental') }}" class="btn btn-danger">Cancel</a>
										<a href="{{ url('quotation_rental/add') }}" class="btn btn-warning">Clear</a>
										@can('qs-history')
...
$(document).ready(function () { 
	...
	var urlcode = "{{ url('quotation_rental/checkrefno/') }}";
	var urlvchr = "{{ url('quotation_rental/checkvchrno/') }}"; //CHNG
...
$(function() {	
	...
	var supurl = "{{ url('quotation_rental/salesman_data/') }}";
