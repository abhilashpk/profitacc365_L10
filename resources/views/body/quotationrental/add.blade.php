                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								 ...
								 <a href="{{ url('quotation_rental/print/'.$printid.'/'.$print->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" id="frmQuotationSales" action="{{ url('quotation_rental/save') }}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">QR. No.</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">QR. Date</label>
                                    <div class="col-sm-10">
