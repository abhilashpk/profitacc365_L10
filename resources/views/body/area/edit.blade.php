                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Area 
                            </h3>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmArea" id="frmArea" action="{{ url('area/update/'.$arearow->id) }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="area_id" value="<?php echo $arearow->id; ?>">
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Area Code</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="code" name="code" value="{{ $arearow->code }}">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $arearow->name }}">
                                    </div>
                                </div>
					...
					remote: {
                        ...
                        data: function(validator) {
                            return {
								...
								id: validator.getFieldElements('area_id').val()
                            };
                        },
