                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" enctype="multipart/form-data" action="{{ url('purchase_invoice/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="po_no" name="po_no" placeholder="Purchase Order No" value="<?php echo (old('po_no'))?old('po_no'):$docrow->po_no; ?>" autocomplete="off">
                                    </div>
                                </div>
								<?php } else { ?>
									...
									<div class="itemdivChld">
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_{{$i}}" step="any" autocomplete="off" name="quantity[]" value="{{$poitem->quantity}}" class="form-control line-quantity">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_{{$i}}" autocomplete="off" step="any" name="cost[]" value="{{($poitem->cost==0)?'':$poitem->cost}}" class="form-control line-cost">
												</td>
												<td width="6%">
													<select id="taxcode_{{$i}}" class="form-control select2 tax-code" style="width:100%" name="tax_code[]"><option value="SR">SR</option><option value="RC">RC</option></select>
												</td>
												<td width="6%">
												...
												<td width="11%">
													<input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" value="{{$lntotal}}" class="form-control line-total" readonly >
											...
											<div class="form-group oc" id="othrcstItm_{{$i}}">
												...
												<div class="col-xs-10">
													...
													<div class="col-xs-2">
														<span class="small">Other Cost/Unit</span> <input type="text" id="othrcst_{{$i}}" step="any" name="othr_cost[]" class="form-control" readonly>
													</div>
													<div class="col-xs-2">
														<span class="small">Net Cost/Unit</span> <input type="text" id="netcst_{{$i}}" step="any" name="net_cost[]" class="form-control" readonly>
													</div>
													<div class="col-xs-1">
														 <!--<button type="button" class="btn btn-success btn-add-item" >
															<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="{{$total}}">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" step="any" name="total_fc" class="form-control spl" value="{{round($total*$docrow->currency_rate,2)}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control spl discount-cal" autocomplete="off" value="{{(old('discount'))}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal" name="subtotal" class="form-control spl" readonly value="{{$total}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control spl" value="{{round($total*$docrow->currency_rate,2)}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" value="{{$vattotal}}" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" value="{{round(($vattotal*$docrow->currency_rate),2)}}" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="{{round($total + $vattotal,2)}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" readonly value="{{round(($total+$vattotal)*$docrow->currency_rate,2)}}">
										</div>
									</div>
                                </div>
								<hr/>
...
$(function() {	
    ...
    { 
        ...
        var controlForm = $('.controls .OCdivPrnt'),
			...
			newEntry.find($('.oc-curr')).attr('id', 'occrncy_' + rowNum);
			newEntry.find($('input[name="oc_rate[]"]')).attr('id', 'ocrate_' + rowNum);
			newEntry.find($('input[name="oc_fc_amount[]"]')).attr('id', 'ocfcamt_' + rowNum);
			newEntry.find('input').val(''); 
	...
	$(document).on('click', '.supp', function(e) {
		...
		$('#frmPurchaseInvoice').bootstrapValidator('revalidateField', 'supplier_name');
		e.preventDefault();
	});
