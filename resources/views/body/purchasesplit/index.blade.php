...
@section('content')
    <!-- Content Header (Page header) -->
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmPOReport" id="frmPOReport" action="{{ url('purchase_split/search') }}" target="_blank">
			 ...
			 <div class="col-lg-12">
					<div class="panel panel-info">
						<div class="panel-heading clearfix">
							<h3 class="panel-title pull-left m-t-6">
								<i class="fa fa-fw fa-list-alt"></i> Purchase Split Report
							</h3>
						</div>
						<div class="panel-body">
								<div class="row">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "{{ url('purchase_split/delete/') }}";
   ...
   /*  $("#multiselect2").multiselect({
	...
	$(document).on('change', '#search_type', function(e) { //$('#search_type').on('change', function(e){
		...
		if(vchr=='supplier') {
			...
			$.ajax({
				url: "{{ url('purchase_split/getcustomer/') }}",
				//type: 'get',
