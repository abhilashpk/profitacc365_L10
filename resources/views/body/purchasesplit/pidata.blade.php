                    ...
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-columns"></i> Purchase Split List
                            </h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tableInvList">
                                    ...
                                    <tr>
										<td><input type="radio" name="supplierDO" value="{{$sdo->id}}"/></td>
...
function setTransfer() {
	...
	if (!checked) {
		alert('Please select Purchase Split!');
		return checked;
	}
	var item = $("input[name='supplierDO']:checked").val();
	//alert(items);
	 sdourl = "{{ url('purchase_split_return/add/') }}/"+item;
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "{{ url('purchase_split/item_details/') }}";
