                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmItemTemp" id="frmItemTemp" action="{{url('item_template/save')}}">
								...
								<fieldset>
									...
									<div class="itemdivPrnt">
											...
											<table border="0" class="table-dy-row">
												<tr>
													<td width="1%" >
														<input type="text" name="ordno[]" id="ordno_1" value="1" autocomplete="off" class="form-control" placeholder="No.">
													</td>
													<td width="4%">
														<select id="iptype_1" class="form-control input-type" name="input_type[]" required>
													...
													<td width="4%" >
														<input type="text" name="type_name[]" id="typnam_1" autocomplete="off" required class="form-control" placeholder="Type Name">
													</td>
													{{--<td width="4%" >
														<select id="frameno_1" class="form-control frame-no" name="frameno[]">
															<option value="0">No</option>
															<option value="1">Yes</option>
														</select>
													</td>--}}
													<td width="4%" >
														<select id="stockitm_1" class="form-control stock-item" name="is_stockitm[]">
													...
													<td width="4%">
														<select id="group_1" class="form-control group" name="group[]">
													...
													<td width="5%">
														<select id="dimsn_1" class="form-control dimension" name="dimension[]" >
													...
													<td width="4%">
														<select id="rqrd_1" class="form-control required" name="required[]" >
