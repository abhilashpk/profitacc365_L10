            ...
            <div class="row">
                <div class="col-md-12">
					...
					<div class="alert alert-warning">
						<p>
							Goods Return voucher is not found! Please create a voucher in Account Settings.
						</p>
					</div>
					<?php } else { ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Goods Return
                            </h3>
                        </div>
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmGoodsReturn" id="frmGoodsReturn" action="{{ url('goods_return/save') }}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('voucher_no')) echo 'form-error';?>">GR. No.</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" tabindex="1" name="voucher_date" data-language='en' readonly id="voucher_date" placeholder="{{date('d-m-Y')}}"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                   <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>Job Code</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" tabindex="2" class="form-control" required autocomplete="off" data-toggle="modal" data-target="#job_modal"  placeholder="Job Code">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" tabindex="3" name="stock_account" id="stock_account" class="form-control"  autocomplete="off" value="{{$voucher['dr_master_name']}} "  data-toggle="modal" data-target="#stockac_modal" placeholder="Stock Account">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" tabindex="4" name="job_account" id="job_account" value="{{ $vouchers[0]['account_id'].'-'.$vouchers[0]['master_name'] }}" class="form-control" autocomplete="off" data-toggle="modal" data-target="#account_modal" placeholder="Job Cost Account">
										<input type="hidden" name="job_account_id" id="job_account_id" value="{{$vouchers[0]['cr_account_master_id']}}">
									</div>
                                </div>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_1" name="item_code[]" tabindex="5" class="form-control" autocomplete="off" autocomplete="off" data-toggle="modal" data-target="#item_modal" placeholder="Item Code">
												</td>
												<td width="29%">
													<input type="text" name="item_name[]" id="itmdes_1" autocomplete="off" class="form-control" data-toggle="modal" data-target="#item_modal" placeholder="Item Description">
												</td>
												<td width="7%">
													<select id="itmunt_1" class="form-control select2 line-unit" style="width:100%" name="unit_id[]"><option value="">Unit</option></select>
												</td>
												<td width="8%">
													 <input type="number" tabindex="6" id="itmqty_1" step="any" name="quantity[]" autocomplete="off" class="form-control line-quantity" placeholder="Qty.">
												</td>
												<td width="8%">
													<input type="number" tabindex="7" id="itmcst_1" step="any" name="cost[]" autocomplete="off" class="form-control line-cost" placeholder="Cost/Unit">
								...
								<input type="hidden" step="any" id="discount" name="discount" class="form-control spl" placeholder="0">
								<input type="hidden" step="any" id="discount_fc" name="discount_fc" class="form-control spl" placeholder="0">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" tabindex="8" class="btn btn-primary">Submit</button>
...
$(document).ready(function () { 
    ...
    $('#frmGoodsReturn').bootstrapValidator({
        fields: {
        ...
        $('#frmGoodsReturn').data('bootstrapValidator').resetForm();
    });
