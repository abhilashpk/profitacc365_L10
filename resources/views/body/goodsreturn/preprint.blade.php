        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
							...
							<tbody id="bod">
								...
								<tr>
										<td align="left" valign="top" style="padding-left:0px;">
											<h6><b>Job.Name: {{$report[0]->jobname}}<br/>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										<tr>
											...
											<td width="13%"><b>GI.No</b></td>
											<td width="18%"><b>GI.Date</b></td>
											
											<td width="8%"><b>Stock Account</b></td>
											
											<td width="18%"><b>Stock CONS</b></td>
											<td width="18%"><b>Item Name</b></td>
											<td width="12%" class="text-right"><b>Cost/Unit</b></td>
											<td width="8%" class="text-right"><b>Quantity</b></td>
											<td width="20%"  class="text-right"><b>Net Total</b></td>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td width="70%" colspan="4" align="right"><b>Net Total:</b></td>
											<td  width="3%" class="text-right"><b>{{number_format($nsptotal,2)}}</b></td>
										
											<td width="3%" class="text-right"><b>{{number_format($nctotal,2)}}</b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('goods_return/export') }}">
