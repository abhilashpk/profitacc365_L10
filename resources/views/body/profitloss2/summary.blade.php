                                            ...
                                            <table class="table table" border="1" width="100%">
                                                ...
                                                <tbody>
                                                    @php
                                                        ...
                                                        $expenseResult = buildSummaryRows($reportData['expense']);
                                                        $expenseRows = $expenseResult['rows'];
                                                        $totalExpense = $expenseResult['total'];

                                                        $incomeResult = buildSummaryRows($reportData['income']);
                                                    ...
                                                    @for($i = 0; $i < $maxRows; $i++)
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                {{ isset($expenseRows[$i]['amount']) ? $expenseRows[$i]['amount'] : '' }}
                                                            </td>
                                                            ...
                                                            <td align="right">
                                                                {{ isset($incomeRows[$i]['amount']) ? $incomeRows[$i]['amount'] : '' }}
                                                            </td>
                                                        </tr>
                                                    @endfor
                                                </tbody>
