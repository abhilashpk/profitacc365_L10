                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Sales 
                            </h3>
							
							<div class="pull-right">
								<a href="{{ url('rental_sales/print/'.$printid->id.'/'.$printid->id) }}" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('rental_sales/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<div class="input-group">
											<input type="text" name="sales_account" id="sales_account" class="form-control" value="{{$vouchers->master_name}}" readonly>
								...
								<div class="form-group">
                                  <font color="#16A085">   <label for="input-text" class="col-sm-2 control-label"><b>Cusromer</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name" id="customer_name" required value="{{ old('customer_name') }}" class="form-control" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
