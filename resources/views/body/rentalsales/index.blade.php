...
@section('content')
    <!-- Content Header (Page header) -->
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Rental Sales
                            </h3>
							
							<div class="pull-right">
								<a href="{{ url('rental_sales/add') }}" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="table-responsive">
                                <table class="table table-striped" id="tblRS">
                                    <thead>
                                    <tr>
                                        <th>RS. No</th>
                                        <th>RS. Date </th>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmReport" target="_blank" id="frmReport" action="{{ url('rental_sales/search') }}">
						...
						<div class="panel-body">
								<div class="row">
									...
									<div class="col-xs-6">
										...
										<span>Customer</span>
										 <select class="form-control select2" name="customer" id="select23" style="width:100%" />
...
$(function() {
	...
	var dtInstance = $("#tblRS").DataTable({
			"processing": true,
			"serverSide": true,
			"searching": true,
			"order": [[ 0, 'desc' ]],
			"ajax":{
					 "url": "{{ url('rental_sales/paging/') }}",
					 "dataType": "json",
					 "type": "POST",
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "{{ url('rental_sales/delete/') }}";
