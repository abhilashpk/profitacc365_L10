            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 header">
							<table border="0" style="width:100%;">
								<tr><td align="center" colspan="3">								
										<b style="font-size:15px; ">@include('main.print_head')</b>
						...
						@endforeach
                        <div class="col-md-12">
							<div style="text-align:center;"><h5><p>Received with thanks from M/s. <b>{{$name}}</b> the sum of <b>Dhs. {{$amtwords}}</b></p></h5></div>
