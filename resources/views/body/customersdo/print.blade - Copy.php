                ...
                <div class="panel-body">
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								<tr>
									<td align="left" width="70%"><img src="{{asset('assets/'.Session::get('logo').'')}}" /></td>
									<td align="center" valign="bottom" style="padding-bottom:10px;"><b>{{session::get('address')}}<br/>Phone: {{session::get('phone')}}</b><br/>
										TRN No: {{session::get('vatno')}}
									</td>
								</tr>
								<tr>
									<td colspan="2" align="center"><h4><b><u>Delivery Order</u></b></h4></td>
								</tr>
								<tr>
