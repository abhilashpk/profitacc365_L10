                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> <?php if($orderrow->is_editable==1) { echo 'Non-Editable! Delivery order already transfered to invoice.'; } else echo (Session::get('trip_entry')==1)?'Edit Daily Entry':'Edit Delivery Order';?>
                            </h3>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_{{$i}}" step="any" autocomplete="off" name="quantity[]" {{($formdata['location_item']==1)?'readonly':''}}  {{($orderrow->is_editable==1)?'readonly':''}} class="form-control line-quantity" value="{{$item->quantity}}">
												</td>
												<td width="8%">
														...
														<div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																$quantity = $id = $qty_entry = '';
																 $location_id = $row->id; $cqty = 0;//$row->cqty;
