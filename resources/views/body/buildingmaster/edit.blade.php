                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="{{ url('buildingmaster/update/'.$brow->id) }}">
								...
								<input type="hidden" name="id" id="id" value="{{ $brow->id }}">
...
"use strict";
 ...
 $(document).ready(function () {
	...
	$('#frmSalesOrder').validate({
                ...
                remote: {
                    ...
                    data: {
                        buildingcode: function () {
                            return $('#buildingcode').val();
                        },
                        id: function () {
                            return $('#id').val(); // 👈 current record id
                        }
                    }
                }
            },
        ...
        messages: {
            buildingcode: {
                required: "Building code is required and cannot be empty!",
                remote: "Building code is not available"
            },
            buildingname: {
                required: "Building name is required and cannot be empty!"
            }
        },
