            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
						...
						@if($fromdate!='' && $todate!='')<p>Expiry Date From: <b><?php echo ($fromdate=='')?'':date('d-m-Y',strtotime($fromdate));?></b> &nbsp; To: <b><?php echo ($todate=='')?'':$todate;?></b></p>@endif
                        <div class="col-md-12">
							<?php if(count($results) > 0) { ?>
							<?php if($type=='batch_expiry') { ?>
								<table class="table">
										<thead>
											<tr>
												...
												<th><strong>Mfg. Date</strong></th>
												<th><strong>Exp. Date</strong></th>
												<th class="text-right"><strong>Exp. Datys</strong></th>
										...
										<tr>
											...
											<td class="text-right">{{number_format($item['cost_avg'],2)}}</td>
