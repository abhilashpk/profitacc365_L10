...
@section('footer_scripts')
    ...
    $(document).ready(function () {
        ...
        /* abi $.validator.addMethod("equalToDebit", function(value, element) {
            var debit = parseFloat($("#debit").val()) || 0;
            var credit = parseFloat($("#credit").val()) || 0;
            return debit === credit;
        }, "Debit and Credit must be equal.");*/

       /* abi window.validator = $("#frmJournal").validate({
            ignore: [],
        ...
        var rowNum = 1;
       //abi addRulesForRow(1); // attach rules for first row

        // ADD ROW
        $(document).on('click', '.btn-add-item', function(e){
            e.preventDefault();

            //abi if(!validateRow(rowNum)) return false;
        ...
        $(document).on('click', '#account_data .custRow', function() {
            ...
            //abi validator.element('#draccountid_'+num);
            //abi addRulesForRow(num);
