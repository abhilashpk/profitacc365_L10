                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="{{ url('customer_receipt/update/'.$crrow->id) }}">
                                ...
                                <fieldset>
                                    ...
                                    <div class="itemdivPrnt">
                                        @foreach($invoicerow as $item)
                                            ...
                                            <div class="itemdivChld">
                                                <div class="form-group classtrn" style="margin-bottom:1px;" id="trns_{{$i}}">
                                                    {{-- Account + IDs --}}
                                                    <div class="col-sm-2">
                                                        <span class="small">11Account Name</span>
                                                    ...
                                                    <div class="col-xs-3" style="width:20%;">
                                                        ...
                                                        <input type="text" id="descr_{{$i}}" value="{{$item->description}}" name="description[]" class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="col-xs-2" style="width:12%;">
                                                        ...
                                                        <div id="refdata_{{$i}}" class="refdata">
                                                            <input type="text" id="ref_{{$i}}" name="reference[]" value="{{$item->reference}}" class="form-control {{ $item->entry_type=='Cr' ? 'ref-invoice' : '' }}" {{ $item->entry_type=='Cr' ? 'data-toggle=modal data-target=#reference_modal' : '' }}>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-2" style="width:12%;">
                                                        ...
                                                        <input type="number" id="amount_{{$i}}" value="{{rtrim(rtrim(number_format($item->amount, 2, '.', ''), '0'), '.')}}" step="any" name="line_amount[]" class="form-control jvline-amount">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-2" style="width:13%;">
                                                        ...
                                                        <input type="text" id="jobcod_{{$i}}" autocomplete="off" name="jobcod[]" class="form-control" value="{{$item->code}}" data-toggle="modal" data-target="#job_modal" placeholder="Jobcode">
                                                    </div>

                                                    {{-- Salesman (only for CUSTOMER) --}}
                                                    @if($item->category == 'CUSTOMER')
                                                        <div id="salem_{{$i}}" class="col-sm-2 salem" style="width:11%;">
                                                            <span class="small">Salesman</span>
                                                            <input type="hidden" name="salesman_idd[]" id="salesmanid_{{$i}}" value="{{$item->salesman_id}}">
                                                            <input type="text" id="salesman_{{$i}}" autocomplete="off" name="salesman[]" class="form-control" value="{{$item->salesman}}" data-toggle="modal" data-target="#salesman_modal" placeholder="Salesman">
                                                        </div>
                                                    @else
                                                        <input type="hidden" name="salesman_idd[]" id="salesmanid_{{$i}}">
                                                        <div id="salem_{{$i}}" class="col-sm-2 salem" style="display:none;"></div>
                                                    @endif

                                                    {{-- PDC / BANK extra fields (hidden unless PDCR/PDCI/BANK UI is loaded) --}}
                                                        ...
                                                        <div class="col-xs-2">
                                                            ...
                                                            <select id="bankid_{{$i}}" class="form-control select2 line-bank" style="width:100%" name="bank_id[]">
                                                                ...
                                                                @foreach($banks as $bank)
                                                                    <option value="{{$bank['id']}}" {{ $item->bank_id==$bank['id'] ? 'selected' : '' }}>{{$bank['code'].' - '.$bank['name']}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <span class="small">Cheque No</span>
                                                            <input type="text" id="chkno_{{$i}}" value="{{$item->cheque_no}}" name="cheque_no[]" class="form-control">
                                                            <input type="hidden" id="oldchkno_{{$i}}" value="{{$item->cheque_no}}" name="oldcheque_no[]">
                                                        </div>
                                                        <div class="col-xs-2">
                                                            <span class="small">Cheque Date</span>
                                                            <input type="text" id="chkdate_{{$i}}" value="{{ $item->cheque_date=='0000-00-00' ? '' : date('d-m-Y', strtotime($item->cheque_date)) }}" name="cheque_date[]" class="form-control chqdate" data-language='en'>
                                                        </div>
                                                        <div class="col-xs-2">
                                        ...
                                        {{-- If no rows exist, seed one empty row to allow adding --}}
                                        @if(count($invoicerow) === 0)
                                            @php $i = 1; @endphp
                                            <div class="itemdivChld">
                                                <div class="form-group classtrn" id="trns_1">
                                                    <div class="col-sm-2">
                                                        ...
                                                        <input type="hidden" id="draccountid_1" name="account_id[]">
                                                        <input type="hidden" id="groupid_1" name="group_id[]">
                                                        <input type="hidden" id="jeid_1" name="je_id[]">
                                                        <input type="hidden" id="invoiceid_1" name="sales_invoice_id[]">
                                                        <input type="hidden" id="biltyp_1" name="bill_type[]">
                                                        <input type="hidden" id="trid_1" name="tr_id[]">
                                                    </div>

                                                    <div class="col-xs-3" style="width:20%;">
                                                        <span class="small">Description</span>
                                                        <input type="text" id="descr_1" name="description[]" class="form-control">
                                                    </div>

                                                    <div class="col-xs-2" style="width:12%;">
                                                        <span class="small">Reference</span>
                                                        <div id="refdata_1" class="refdata">
                                                            <input type="text" id="ref_1" name="reference[]" class="form-control">
                                                        </div>
                                                        <input type="hidden" id="invid_1" name="inv_id[]">
                                                        <input type="hidden" id="actamt_1" name="actual_amount[]">
                                                    </div>

                                                    <div class="col-xs-1" style="width:7%;">
                                                        <span class="small">Type</span>
                                                        <select id="acnttype_1" name="account_type[]" class="form-control select2 line-type">
                                                            <option value="Dr">Dr</option>
                                                            <option value="Cr">Cr</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-2" style="width:12%;">
                                                        <span class="small">Amount</span>
                                                        <input type="number" id="amount_1" name="line_amount[]" class="form-control jvline-amount" step="any">
                                                    </div>

                                                    <div class="col-sm-2" style="width:13%;">
                                                        <span class="small">Job</span>
                                                        <input type="hidden" id="jobid_1" name="job_id[]">
                                                        <input type="text" id="jobcod_1" name="jobcod[]" class="form-control" data-toggle="modal" data-target="#job_modal" placeholder="Jobcode" autocomplete="off">
                                                    </div>

                                                    <div id="salem_1" class="col-sm-2 salem" style="width:11%; display:none;">
                                                        <span class="small">Salesman</span>
                                                        <input type="hidden" id="salesmanid_1" name="salesman_idd[]">
                                                        <input type="text" id="salesman_1" name="salesman[]" class="form-control" data-toggle="modal" data-target="#salesman_modal" placeholder="Salesman" autocomplete="off">
                                                    </div>
                                                    ...
                                                    <div id="chqdtl_1" class="divchq" style="display:none;">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <span class="small">Cheque No</span>
                                                            <input type="text" id="chkno_1" name="cheque_no[]" class="form-control">
                                                            <input type="hidden" id="oldchkno_1" name="oldcheque_no[]">
                                                        </div>
                                                        <div class="col-xs-2">
                                                            <span class="small">Cheque Date</span>
                                                            <input type="text" id="chkdate_1" name="cheque_date[]" class="form-control chqdate" data-language='en'>
                                                        </div>
                                                        <div class="col-xs-2">
                                                            <input type="hidden" id="partyac_1" name="partyac_id[]">
                                                            <span class="small">Party Name</span>
                                                            <input type="text" id="party_1" name="party_name[]" class="form-control" data-toggle="modal" data-target="#paccount_modal">
                                                        </div>
                                                    </div>

                                                    <div class="col-xs-1 abc" style="width:3%;"><br/>
                                                        <button type="button" data-id="rem_1" class="btn-danger btn-remove-item"><i class="fa fa-fw fa-minus-square"></i></button>
                                                        <button type="button" class="btn-success btn-add-item"><i class="fa fa-fw fa-plus-square"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
