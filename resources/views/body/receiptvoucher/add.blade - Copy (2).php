...
$(document).ready(function () {
	...
	$.validator.addMethod("equalToDebit", function(value, element) {
		// get numeric values from #debit and #credit
		var debit = parseFloat($("#debit").val()) || 0;
		var credit = parseFloat($("#credit").val()) || 0;

		return debit === credit; // ✅ return true if equal
  ...
  $(':input[type=number]').on('mousewheel',function(e){ $(this).blur(); });
   $('#trndtl_1').toggle(); $('#salem_1').toggle(); //$('#chqdtl_1').toggle();
	...
	$(document).on('click', '#account_data .custRow', function(e) { //.accountRow
		...
		$('#frmJournal').validate().element('#draccountid_'+num);
