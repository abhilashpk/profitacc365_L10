								...
								{{--*/ $i++; /*--}}
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											...
											<div class="locPrntItmX" id="locPrntItm_{{$i}}">
												<div class="locChldItmX">							
													<div class="table-responsive loc-dataX" id="locData_{{$i}}">
														<?php 
...
@stop
>>>>>>> a8806e674c621bf30708b099faf7ebeafd872976
