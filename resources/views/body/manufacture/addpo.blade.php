                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Manufacture Voucher
                            </h3>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmManufacture" id="frmManufacture" action="{{ url('manufacture/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document_id" readonly name="document_id" value="{{$docid}}" autocomplete="off" onclick="getDocument()">
                                    </div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="8%">
														...
														<input type="number" id="itmcst_{{$i}}"  autocomplete="off" step="any" name="cost[]"  value="{{$item->unit_price}}"class="form-control line-cost" placeholder="Cost/Unit">
													</td>
													<td width="11%">
														<input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" value="{{$item->line_total}}" class="form-control line-total" readonly placeholder="Total">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="{{$orderrow->total}}" placeholder="0">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="total_price" class="form-control spl" readonly value="{{$orderrow->net_total}}" placeholder="0">
										</div>
										<div class="col-xs-2">
										</div>
									</div>
