                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmGroup" id="frmGroup" action="{{ url('group/update/'.$grouprow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" placeholder="Group Description" value="{{ $grouprow->description }}">
                                    </div>
                                </div>
