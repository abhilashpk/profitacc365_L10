                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> New Destination 
                        </h3>

                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" name="frmDestinationType"
                            id="frmDestinationType" action="{{ url('destination_type/save') }}">
                            ...
                            <div class="form-group">
                                <label for="input-text" class="col-sm-2 control-label">Destination Name</label>
                                <div class="col-sm-10">
