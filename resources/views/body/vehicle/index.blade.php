                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="{{ url('vehicle/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableVehicle">
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('vehicle/edit/'.$vehicle->id) }}'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>
										</td>
										<td>
											<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $vehicle->id }}')"><span
...
function funDelete(id) {
	var con = confirm('Are you sure delete this vehicle?');
	if(con==true) {
		var url = "{{ url('vehicle/delete/') }}";
