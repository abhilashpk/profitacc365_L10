                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmVehicle" id="frmVehicle" action="{{url('vehicle/save')}}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="issue_plate" name="issue_plate" autocomplete="off" placeholder="Issue Plate">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="code_plate" name="code_plate" autocomplete="off" placeholder="Code Plate">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="color_code" name="color_code" autocomplete="off" placeholder="Color Code">
										</div>
									</div>
