                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>  Cargo Despatch Bill Status 
                        </h3>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
						  ...
						  <div id="status_modal" class="modal fade animated" role="dialog" style="z-index:51">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
										<h4 class="modal-title">Set Despatch Bill Status</h4>
									</div>
...
$(function() {
	...
	var dtInstance = $("#tblCargoDsphbill").DataTable({
			...
			"order": [[ 0, 'desc' ]],
			"ajax":{
					 "url": "{{ url('cargo_despatchbill/paging-list/') }}",
					 "dataType": "json",
					 "type": "POST",
	...
	$(document).on('click', '.setStatus', function(e) {
		 ...
		 $('#statusForm').load(vehurl+"/"+$(this).attr("data-id")+"/"+1, function(result) {
