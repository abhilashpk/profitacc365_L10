							...
							<div class="panel-body">
								<form class="form-horizontal" role="form" method="POST" name="frmReport" id="frmReport" target="_blank" action="{{ url('cargo_despatchbill/search') }}">
									...
									<div class="row">
										...
										<!-- <div class="col-xs-6">
											<span>To Despatch No:</span>
											<input type="text" name="to_no" id="to_no"  class="form-control">
											<span></span><br/>
...
<script>
$(document).on('keyup','#from_no',function(){
  console.log(this.value);
  $('#reportResult').load("{{ url('cargo_despatchbill/report_search/') }}/"+this.value);
});
