                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Edit Consignee
                        </h3>

                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" name="frmConsignee" id="frmConsignee"
                            action="{{ url('consignee/update/' . $cedit->id) }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="consignee_id" value="<?php echo $cedit->id; ?>">

                            <div class="form-group">
                                <label for="input-text" class="col-sm-2 control-label">Consignee Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Name" value="{{ $cedit->consignee_name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="address" id="address" class="form-control " placeholder="Address">{{ $cedit->address }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" id="phone" name="phone"
                                        placeholder="Phone no:" value="{{ $cedit->phone }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" id="phone1" name="phone1"
                                        placeholder="Phone no:" value="{{ $cedit->alter_phone }}">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    name: {
                        validators: {
                            ...
                            return {
                                ...
                                id: validator.getFieldElements('consignee_id').val(),
                            };
                        },
