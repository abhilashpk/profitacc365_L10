                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>Consignee List
                        </h3>
                        <div class="pull-right">
                            <a href="{{ url('consignee/add') }}" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    @foreach ($consignee as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->phone }}</td>
                                            <td>{{ $row->alter_phone }}</td>
                                            <td>{{ $row->address }}</td>
                                            <td>
                                                <p>
                                                    <button class="btn btn-primary btn-xs"
                                                        onClick="location.href='{{ url('consignee/edit/' . $row->id) }}'">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title custom_align" id="Heading5">Delete Consignee</h4>
                    </div>
...
<script type="text/javascript" src="{{asset('assets/vendors/datatables/js/dataTables.scroller.js')}}"></script>
	...
	var dtInstance = $("#tableTemplate").DataTable({
        ...
        function funDelete(id) {
            var con = confirm('Are you sure delete this Consignee?');
            if (con == true) {
                var url = "{{ url('consignee/delete/') }}";
