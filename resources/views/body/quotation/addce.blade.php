                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" id="frmQuotationSales" action="{{ url('quotation/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" autocomplete="off" name="reference_no" value="<?php echo (old('reference_no'))?old('reference_no'):$referenceno; ?>" placeholder="Reference No.">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" autocomplete="off" data-language='en' id="voucher_date" value="{{($voucherdt=='')?date('d-m-Y'):$voucherdt}}" placeholder="{{date('d-m-Y')}}"/>
                                    </div>
                                </div>
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('supplier_name')) echo 'form-error';?>"><b>Supplier</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="<?php  echo (old('supplier_name'))?old('supplier_name'):$quoterow->supplier; ?>" class="form-control <?php if($errors->has('supplier_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="salesman" id="salesman" class="form-control" value="<?php echo (old('salesman'))?old('salesman'):$quoterow->salesman; ?>" autocomplete="off" data-toggle="modal" data-target="#salesman_modal" placeholder="Salesman">
									...
									<?php $i++; } } else { ?>
										...
										<?php
												if($item->balance_quantity==0) {
													...
													if($quoterow->is_fc==1) {
														...
														$line_total = number_format($item->line_total / $quoterow->currency_rate,2, '.', '');
														$total += $line_total;
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%"><input type="hidden" name="actual_quantity[]" id="itmactqty_{{$i}}" value="{{$actual_quantity}}">
													<input type="number" id="itmqty_{{$i}}" step="any" name="quantity[]" autocomplete="off" class="form-control line-quantity" value="{{$quantity}}">
												</td>
												<td width="8%">
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_{{$i}}" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="{{$item->vat.'% - '.intval($vat_amount*100)/100}}"> 
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" value="{{(old('total'))?old('total'):(($quoterow->is_fc==1)?$quoterow->total_fc:$quoterow->total)}}" step="any" name="total" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" value="{{(old('total_fc'))?old('total_fc'):$quoterow->total}}" step="any" name="total_fc" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" value="{{(old('discount'))?old('discount'):(($quoterow->is_fc==1)?$quoterow->discount_fc:$quoterow->discount)}}" class="form-control spl discount-cal" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" value="{{(old('discount_fc'))?old('discount_fc'):$quoterow->discount}}" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" id="subtotal" step="any" name="subtotal" value="{{(old('subtotal'))?old('subtotal'):(($quoterow->is_fc==1)?$quoterow->subtotal_fc:$quoterow->subtotal)}}" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" id="subtotal_fc" step="any" name="subtotal_fc" value="{{(old('subtotal_fc'))?old('subtotal_fc'):$quoterow->subtotal}}" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" value="{{(old('vat'))?old('vat'):(($quoterow->is_fc==1)?$quoterow->vat_amount_fc:$quoterow->vat_amount)}}" readonly class="form-control spl" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" value="{{(old('vat_fc'))?old('vat_fc'):$quoterow->vat_amount}}" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="{{(old('net_amount'))?old('net_amount'):(($quoterow->is_fc==1)?$quoterow->net_amount_fc:$quoterow->net_amount)}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" value="<?php echo (old('net_amount_fc'))?old('net_amount_fc'):$quoterow->net_amount; ?>" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								<hr/>
