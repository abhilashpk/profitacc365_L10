                    ...
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-columns"></i> Quotation Purchase
                            </h3>
                        </div>
                        <div class="panel-body">
							...
							<button type="button" class="btn btn-info" onClick="setTransfer()">Copy Quotation</button>
                        </div>
                    </div>
                </div>
            </div>
...
function setTransfer() {
	...
	url = "{{ url('quotation/add/') }}/"+items+"/QP";
...
$(document).on('click', '.quot-data', function(e) {
	...
	var itmurl = "{{ url('quotation/item_details/') }}";
