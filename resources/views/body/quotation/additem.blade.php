                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Quotation Purchase
                            </h3>
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" id="frmQuotationSales" action="{{ url('quotation/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" id="voucher_no" name="voucher_no" <?php if($voucherno->autoincrement==1) { ?> readonly value="{{$quoterow->voucher_no}}" <?php } else { ?> value="{{old('voucher_no')}}" <?php } ?>>
                                ...
                                <input type="hidden" name="curno" id="curno" value="{{(old('curno'))?old('curno'):$quoterow->voucher_no}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" autocomplete="off" name="reference_no" value="<?php echo (old('reference_no'))?old('reference_no'):$quoterow->reference_no; ?>" placeholder="Reference No.">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" autocomplete="off" data-language='en' id="voucher_date" value="{{$quoterow->voucher_date}}" placeholder="{{date('d-m-Y')}}"/>
                                    </div>
                                </div>
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('supplier_name')) echo 'form-error';?>"><b>Supplier</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="<?php  echo (old('supplier_name'))?old('supplier_name'):$quoterow->supplier_name; ?>" class="form-control <?php if($errors->has('supplier_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
										<input type="hidden" name="supplier_id" id="supplier_id"  value="<?php  echo (old('supplier_id'))?old('supplier_id'):$quoterow->supplier_id; ?>">
									</div>
                                </div>
								<!-- <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label <?php //if ($errors->has('supplier_name')) echo 'form-error';?>">Supplier</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" class="form-control <?php //if ($errors->has('supplier_name')) echo 'form-error';?>" value="<?php // echo (old('supplier_name'))?old('supplier_name'):$quoterow->supplier; ?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
										<input type="hidden" name="supplier_id" id="supplier_id" value="<?php // echo (old('supplier_id'))?old('supplier_id'):$quoterow->supplier_id; ?>">
									</div>
                                </div> -->
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="salesman" id="salesman" class="form-control" value="<?php echo (old('salesman'))?old('salesman'):$quoterow->salesman_id; ?>" autocomplete="off" data-toggle="modal" data-target="#salesman_modal" placeholder="Salesman">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="quotation" value="{{(old('quotation'))?:$quoterow->voucher_no}}" readonly name="quotation" placeholder="Enquiry No" autocomplete="off" onclick="getEnquiry()">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo (old('description'))?old('description'):$quoterow->description; ?>" placeholder="Description">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<option value="{{ $term['id'] }}" <?php if($term['id']==$quoterow->terms_id) echo 'selected'; ?>>{{ $term['description'] }}</option>
											@endforeach
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										<div class="col-xs-1">
											...
											<input type="checkbox" class="custom_icheck" id="is_fc" name="is_fc" {{ $chk }} value="1">
										</label>
										</div>
										<div class="col-xs-5">
										...
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" class="form-control" value="{{ $quoterow->currency_rate }}" placeholder="Currency Rate">
										</div>
									</div>
                                </div>
								<?php } else { ?>
									...
									<?php $i++; } } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="7%">
													<select id="itmunt_{{$i}}" class="form-control select2 line-unit" style="width:100%" name="unit_id[]"><option value="{{$item->unit_id}}">{{$item->unit_name}}</option></select></select>
												</td>
												<td width="8%">
												...
												<td width="8%">
													<input type="number" id="itmcst_{{$i}}" step="any" name="cost[]" autocomplete="off" class="form-control line-cost" value="{{($item->cost==0)?0:$item->cost}}">
												</td>
												<td width="6%">
													<select id="taxcode_{{$i}}" class="form-control select2 tax-code" style="width:100%" name="tax_code[]"><option value="SR" >SR</option><option value="EX" >EX</option><option value="ZR" >ZR</option></select>
												</td>
												<td width="6%">
												...
												<?php
													$lntotal = $item->quantity * $item->cost;
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_{{$i}}" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="{{$item->vat.'% - '.$vat}}"> 
													<input type="hidden" id="vat_{{$i}}" name="line_vat[]" value="{{$item->vat}}" class="form-control vat">
													<input type="hidden" id="vatlineamt_{{$i}}" name="vatline_amt[]" class="form-control vatline-amt" value="{{$item->vat}}">
													<input type="hidden" id="itmdsnt_{{$i}}" name="line_discount[]">
												</td>
												<td width="11%">
													<input type="hidden" id="itmtot_{{$i}}" name="item_total[]" value="{{$lntotal}}">
													<input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" class="form-control line-total" readonly value="{{$lntotal}}">
												</td>
												<td width="1%">
													@if($num==$i)
														<button type="button" class="btn-success btn-add-item" >
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" value="{{$total}}" step="any" name="total" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" value="{{round($total*$quoterow->currency_rate,2)}}" step="any" name="total_fc" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" value="" class="form-control spl discount-cal" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" value="" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" id="subtotal" step="any" name="subtotal" value="{{$total}}" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" id="subtotal_fc" step="any" name="subtotal_fc" value="{{round($total*$quoterow->currency_rate,2)}}" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" value="{{$vattotal}}" readonly class="form-control spl" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" value="{{round(($vattotal*$quoterow->currency_rate),2)}}" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" value="{{round(($total+$vattotal)*$quoterow->currency_rate,2)}}" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								<hr/>
...
$(document).ready(function () { 
	...
	function getAutoPrice(curNum) {
		...
		$.ajax({
			...
			type: 'get',
			data: 'item_id='+item_id+'&unit_id='+unit_id+'&supplier_id='+supplier_id+'&crate='+crate,
