                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Quotation
                            </h3>
                        </div>
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotation" id="frmQuotation" action="{{ url('quotation/update/'.$orderrow->id) }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="quotation_id" value="<?php echo $orderrow->id; ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="reference_no" name="reference_no" value="{{$orderrow->reference_no}}">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' id="voucher_date" value="{{$orderrow->voucher_date}}"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="{{$orderrow->supplier}}" class="form-control" autocomplete="off" data-toggle="modal" data-target="#supplier_modal">
								...
								<div class="itemdivPrnt">
									<div class="itemdivChld">							
										<div class="form-group">
											<div class="col-sm-2">
												<input type="hidden" name="quotation_id[]" id="p_orditmid_1" value="{{$item->id}}">
												<input type="hidden" name="item_id[]" id="itmid_1" value="{{$item->item_id}}">
												<input type="text" id="itmcod_1" name="item_code[]" class="form-control" autocomplete="off" onclick="getItems(this)" value="{{$item->item_code}}">
											</div>
											<div class="col-xs-10">
												<div class="col-xs-10">
													<input type="text" name="item_name[]" id="itmdes_1" autocomplete="off" class="form-control" onclick="getItems(this)" value="{{$item->item_name}}">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<option value="{{$item->unit_id}}">{{$item->unit_name}}</option></select></div>
											<div class="col-xs-10">
												<div class="col-xs-2">
													<span class="small">Quantity</span> <input type="number" id="itmqty_1" name="quantity[]" class="form-control line-quantity" value="{{$item->quantity}}">
												</div>
												<div class="col-xs-2">
													<span class="small">Cost/Unit</span> <input type="number" id="itmcst_1" step="any" name="cost[]" class="form-control line-cost" value="{{$item->unit_price}}">
												</div>
												<div class="col-xs-2">
													<span class="small">Vat% - Amount</span> <input type="text" id="vatdiv_1" step="any" readonly name="vatdiv[]" class="form-control cost" value="{{$item->vat.'% - '.$item->vat_amount}}">
													<input type="hidden" id="vat_1" name="line_vat[]" class="form-control cost">
												</div>
												<div class="col-xs-2">
													<span class="small">Discount</span> <input type="number" id="itmdsnt_1" step="any" name="line_discount[]" class="form-control line-discount" value="{{$item->discount}}">
												</div>
												<div class="col-xs-2">
													<span class="small">Total</span> <input type="number" id="itmttl_1" step="any" name="line_total[]" class="form-control line-total" readonly value="{{$item->line_total}}">
												</div>
												<div class="col-xs-1">
												@if($num==$i)
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" readonly class="form-control" value="{{$vattotal}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control" value="{{$vattotal}}">
										</div>
										<div class="col-xs-2">
