            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
							<table border="0" style="width:100%;">
								...
								<tr>
									<td align="center"><h4><b><u>Submission of Payment Report & Sales Invoice Retention Report</u></b></h4>
									</td>
								</tr>
							</table><br/>
                        </div>
						...
						<p><b>SUBMISSION OF PAYMENT CERTIFICATES</b></p>
							<table class="table" border="0">
								<thead>
									...
									<th>Job.No</th>
									<th>Jobname</th>
									<th class="text-right">Retention Amt.</th>
								</thead>
								<body>
                    ...
                    <div class="btn-section">
						...
						<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('voucherwise_report/pisirtnexport') }}">
