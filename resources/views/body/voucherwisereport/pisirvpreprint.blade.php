            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
							<table border="0" style="width:100%;">
								...
								<tr>
									<td align="center"><h4><b><u>Submission of Payment Report & Sales Invoice RV Report</u></b></h4>
									</td>
								</tr>
							</table><br/>
                        </div>
							...
							<table class="table" border="0">
								...
								<body>
									...
									<tr>
										...
										<td></td><td></td><td></td>
										<td class="text-right"><b>Total:</b></td>
										<td class="text-right"><b>{{number_format($total_rv,2)}}</b></td>
									</tr>
									
								</body>
							</table>
							
							<?php $rvbal = $pitotal_net - $total_rv; //+ $total_net ?>
							<p><b>Balance Amount: {{number_format($rvbal,2)}}</b></p>
                    ...
                    <div class="btn-section">
						...
						<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('voucherwise_report/pisirvexport') }}">
