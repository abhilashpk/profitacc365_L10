                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Form List
                        </h3>
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableBank">
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('forms/detail/'.$row->code) }}'">
												<i class="fa fa-fw fa-cog"></i> &nbsp; Manage</button>
											</p>
										</td>
										<td>
