                        ...
                        <div class="table-responsive">
                                <table class="table horizontal_table table-striped" id="table1" border="0">
                                    ...
                                    <tr>
										...
										<td><input type="text" name="dr_account[]" id="draccount_{{$i}}" class="form-control" value="{{$banks[0]->master_name}}" onClick="getAccount(this)" style="width:8em;">
										<input type="hidden" name="dr_account_id[]" id="draccountid_{{$i}}" value="{{$banks[0]->id}}">
										</td>
										<td>{{ $pdc->debitor }}</td>
									...
									@endforeach
									 <div class="col-sm-3">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' readonly id="voucher_date" placeholder="Cheque Transfer Date"/>
                                    </div>
