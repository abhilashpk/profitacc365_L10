                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
						   ...
						   <div class="pull-right">
							...
							<?php if($printid) { ?>
								@can('jv-print')
								<form class="form-horizontal" role="form" method="GET" target="_blank" name="frmItem" id="frmItem" action="{{ url('creditnotejournal/getvoucherprint') }}">
						   ...
						   <?php //if(!empty($remarks)){ ?> 
								...
								<button type="submit" class="btn btn-info btn-sm" > <span class="btn-label">
								 ...
								 <!-- <a href="{{ url('creditnotejournal/print/'.$printid->id) }}" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="{{ url('creditnotejournal/save') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="voucher_type" class="form-control select2" style="width:100%" name="voucher_type">
											<option value="7">CNJV - Credit Note Journal Voucher</option>
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">CNJV. No.</label>
									<input type="hidden" name="curno" id="curno" value="{{$vchrdata['vno']}}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">CNJV. Date</label>
                                    <div class="col-sm-10">
											...
											<div class="itemdivChld">
												<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
                                                    <div class="col-sm-1 " style="width:1.55%;">
	                                                 <input type="checkbox" id="tag_1" name="tag[]" class="form-control tagchk" unchecked >
	                                                 </div>
...
$(document).ready(function () {
	...
	var urlvchr = "{{ url('creditnotejournal/checkvchrno/') }}"; //CHNG
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
	...
	$(document).on('click', '.accountRow', function(e) { 
		...
		if( $(this).attr("data-group")=='SUPPLIER' || $(this).attr("data-group")=='CUSTOMER' || $(this).attr("data-group")=='VATIN' || $(this).attr("data-group")=='VATOUT') {// group.id
			$('#refdata_'+num).html('<input type="text" id="ref_'+num+'" name="reference[]" class="form-control ref-invoice" autocomplete="off" >');
		} else {// group.id
			var nm = num - 1;
			if(nm > 0)
