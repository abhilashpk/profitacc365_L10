                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Credit Note Journal Entry List
                        </h3>
                        <div class="pull-right">
							@can('jv-create')
                             <a href="{{ url('creditnotejournal/add') }}" class="btn btn-primary btn-sm">
...
$(function() {
		...
		var dtInstance = $("#tableJVlist").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "{{ url('creditnotejournal/paging/') }}",
					 "dataType": "json",
					 "type": "POST",
...
function funDelete(id) {
	var con = confirm('Are you sure delete this credit note journal?');
	if(con==true) {
		var url = "{{ url('creditnotejournal/delete/') }}";
