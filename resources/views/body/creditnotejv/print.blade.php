                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
							...
							<table class="table" border="0">
							    <tr>
									<td>Created Details: <b>{{$details->createdby}} {{date('d-m-Y H:i a', strtotime($details->created_at))}}</b></td>
									<td class="text-right">Modified Details: <b>{{$details->modifiedby}} {{($details->modifiedby!='')?date('d-m-Y H:i a', strtotime($details->modify_at)):''}}</b></td>
								</tr>
							</table>
