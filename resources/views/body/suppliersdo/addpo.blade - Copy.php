                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls">
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('suppliers_do/save/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="{{$orderrow->supplier}}" class="form-control" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="purchase_order_id" readonly name="purchase_order_id" value="{{$pordid}}" autocomplete="off" onclick="getPurchaseOrder()">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" placeholder="Description" autocomplete="off" data-toggle="modal" data-target="#purchase_order_modal">
                                    </div>
                                </div>
									...
									<div class="itemdivChld">							
										<div class="form-group">
											<div class="col-sm-2">
												...
												<input type="text" id="itmcod_1" name="item_code[]" value="{{$poitem->item_name}}" class="form-control" autocomplete="off" data-toggle="modal" data-target="#item_modal" placeholder="Item Code">
											</div>
											<div class="col-xs-10">
												<div class="col-xs-10">
													<input type="text" name="item_name[]" id="itmdes_1" value="{{$poitem->item_name}}" autocomplete="off" class="form-control" placeholder="Item Description">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-10">
												<div class="col-xs-2">
													<input type="hidden" name="unit_id[]" id="itmuntid_1" value="{{$poitem->unit_id}}">
													<span class="small">Unit</span>	<input type="text" name="unit[]" value="{{$poitem->unit_name}}" id="itmunt_1" readonly class="form-control" placeholder="Unit">
												</div>
												<div class="col-xs-2">
													<input type="hidden" name="actual_quantity[]" id="itmactqty_1" value="{{$poitem->quantity}}">
													<span class="small">Quantity</span> <input type="number" id="itmqty_1" value="{{$poitem->quantity}}" name="quantity[]" class="form-control" placeholder="Qty.">
												</div>
												<div class="col-xs-2">
													<span class="small">Cost/Unit</span> <input type="number" id="itmcst_1" step="any" value="{{$poitem->unit_price}}" name="cost[]" class="form-control cost" placeholder="Cost/Unit">
												</div>
												<div class="col-xs-2">
													<span class="small">Discount</span> <input type="number" id="itmdsnt_1" step="any" value="{{$poitem->discount}}" name="line_discount[]" class="form-control" placeholder="Discount">
												</div>
												<div class="col-xs-2">
													<span class="small">Total</span> <input type="number" id="itmttl_1" step="any" value="{{$poitem->total_price}}" name="line_total[]" class="form-control line-total" readonly placeholder="Total">
												</div>
												<div class="col-xs-1">
													@if($num==$i)
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small">Currency Dhs</span>	<input type="number" id="total" step="any" name="total" class="form-control" value="{{$total}}" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" value="{{$discount}}" class="form-control" placeholder="0">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount" value="{{$nettotal}}" name="net_amount" class="form-control" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
...
$(function() {	
    ...
    { 
        ...
        var controlForm = $('.controls .itemdivPrnt'),
			...
			newEntry.find($('input[name="unit_id[]"]')).attr('id', 'itmuntid_' + rowNum);
			newEntry.find($('input[name="quantity[]"]')).attr('id', 'itmqty_' + rowNum);
			//newEntry.find($('input[name="quantity[]"]')).attr('id', 'itmactqty_' + rowNum);
	...
	$(document).on('click', 'input[name="item_code[]"]', function(e) {
		...
		$(document).on('click', '.itms', function(e) { 
			...
			$("#itmuntid_"+id).val($(this).attr("data-unit-id"));
