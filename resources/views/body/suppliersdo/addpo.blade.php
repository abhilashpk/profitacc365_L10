                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" action="{{ url('suppliers_do/save/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                  <font color="#16A085">   <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('supplier_name')) echo 'form-error';?>"><b>Supplier</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="{{$orderrow->supplier}}" class="form-control <?php if($errors->has('supplier_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document_id" readonly value="{{$pordid}}" name="document_id" placeholder="Document ID" autocomplete="off" onclick="getDocument()">
                                    </div>
                                </div>
								<?php } else { ?>
									...
									<div class="col-xs-10">
										...
										<div class="col-xs-5">
											<select id="currency_id" class="form-control select2" style="width:100%" name="currency_id">
												...
												<option value="{{$curr['id']}}" <?php if($curr['id']==$orderrow->currency_id) echo 'selected'; ?>>{{$curr['code']}}</option>
												@endforeach
											</select>
										</div>
										<div class="col-xs-5">
										...
										<?php 
											if($poitem->balance_quantity==0) {
												if($orderrow->is_fc==1) {
													...
													$total_price = number_format($poitem->total_price / $orderrow->currency_rate,2, '.', '');
													$total += $total_price;
													$vattotal += ($total_price * $poitem->vat)/100;
													
													$vat_amount = round($poitem->vat_amount / $orderrow->currency_rate,2);
													$unit_price = $poitem->unit_price / $orderrow->currency_rate;
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_{{$i}}" name="item_code[]" class="form-control"  autocomplete="off" data-toggle="modal" data-target="#item_modal" value="{{$poitem->item_code}}">
												</td>
												<td width="29%">
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_{{$i}}" step="any" autocomplete="off" name="quantity[]" class="form-control line-quantity" value="{{$quantity}}" {{($formdata['location_item']==1)?'readonly':''}}><!--NOV24-->
												</td>
												<td width="8%">
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="10%">
														...
														<input type="number" name="oc_amount[]" step="any" id="ocamt_{{$i}}" value="{{intval($row->oc_amount*100)/100}}" autocomplete="off" class="form-control oc-line" placeholder="Amount">
													</td>
													<td width="5%">
													...
													<td width="10%">
														<div class="oc-amount-fc">
															...
															<input type="number" name="oc_fc_amount[]" id="ocfcamt_{{$i}}" step="any" value="{{intval($row->oc_fc_amount*100)/100}}" autocomplete="off" class="form-control oc-line-fc" placeholder="FC Amount">
														</div>
													</td>
													<td width="5%"><br/>
								...
								<input type="hidden" step="any" id="other_cost_fc" name="other_cost_fc" value="{{$orderrow->other_cost_fc}}" readonly class="form-control spl" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="{{($orderrow->is_fc==1)?$orderrow->total_fc:$orderrow->total}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control spl discount-cal" autocomplete="off" value="{{(old('discount'))?old('discount'):$orderrow->discount}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal" name="subtotal" class="form-control spl" readonly value="{{($orderrow->is_fc==1)?$orderrow->subtotal_fc:$orderrow->subtotal}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="{{($orderrow->is_fc==1)?$orderrow->net_amount_fc:$orderrow->net_amount}}">
										</div>
										<div class="col-xs-2">
...
$(document).ready(function () { 
	...
	<?php if($orderrow->is_fc=="1") { ?> $('.custom_icheck').on('ifChecked', function(event){ 
...
$(function() {	
	...
	$(document).on('click', '#paccount_modal .custRow', function(e) { 
		var num = $('#anum').val();
