                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSupplierDO" id="frmSupplierDO" action="{{ url('suppliers_do/save/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									 <select id="document_type" class="form-control select2" style="width:100%" name="document_type">
										<option value="2" selected>Purchase Order</option>
									</select>
                                    </div>
                                </div>
									...
									<div class="itemdivChld">							
										<div class="form-group">
											<div class="col-sm-2">
												...
												<input type="text" id="itmcod_1" name="item_code[]" value="{{$poitem->item_code}}" class="form-control" autocomplete="off" onclick="getItems(this)" placeholder="Item Code">
											</div>
											<div class="col-xs-10">
												<div class="col-xs-10">
													<input type="text" name="item_name[]" id="itmdes_1" autocomplete="off" class="form-control" onclick="getItems(this)" value="{{$poitem->item_name}}" placeholder="Item Description">
												</div>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-2"> <span class="small">Unit</span>	<select id="itmunt_1" class="form-control select2 line-unit" style="width:100%" name="unit_id[]">
											...
											<div class="col-xs-10">
												<div class="col-xs-2">
													...
													<span class="small">Quantity</span> <input type="number" id="itmqty_1" name="quantity[]" class="form-control line-quantity" value="{{$poitem->quantity}}">
												</div>
												<div class="col-xs-2">
													<span class="small">Cost/Unit</span> <input type="number" id="itmcst_1" step="any" name="cost[]" class="form-control line-cost" value="{{$poitem->unit_price}}">
												</div>
												<div class="col-xs-2">
													<span class="small">Vat% - Amount</span> <input type="text" id="vatdiv_1" step="any" readonly name="vatdiv[]" class="form-control cost" value="{{$poitem->vat.'% - '.$poitem->vat_amount}}">
													<input type="hidden" id="vat_1" name="line_vat[]" class="form-control cost">
												</div>
												<div class="col-xs-2">
													<span class="small">Discount</span> <input type="number" id="itmdsnt_1" step="any" name="line_discount[]" class="form-control line-discount" value="{{$poitem->discount}}">
												</div>
												<div class="col-xs-2">
													<span class="small">Total</span> <input type="number" id="itmttl_1" step="any" name="line_total[]" class="form-control line-total" readonly value="{{$poitem->total_price}}">
												</div>
												<div class="col-xs-1">
												@if($num==$i)
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small">Currency Dhs</span>	<input type="number" id="total" step="any" name="total" class="form-control" readonly value="{{$total}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control" value="{{$orderrow->discount}}">
										</div>
										<div class="col-xs-2">
...
$(document).ready(function () { 
	...
	var urlcode = "{{ url('suppliers_do/checkrefno/') }}";
    $('#frmSupplierDO').bootstrapValidator({
        fields: {
			reference_no: {
                validators: {
                    notEmpty: {
        ...
        $('#frmSupplierDO').data('bootstrapValidator').resetForm();
    });
...
function getDocument() { 
	...
	if(doc==1)
		var pourl = "{{ url('quotation_sales/get_quotation/') }}/"+supplier_id+"/cdo";
	else if(doc==2)
