                    ...
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-columns"></i> Goods Receipt Note List
                            </h3>
                        </div>
                        <div class="panel-body">
							...
							<button type="button" class="btn btn-info" onClick="setTransfer()">Copy Receipt</button>
                        </div>
                    </div>
                </div>
            </div>
...
function setTransfer() {
	...
	var sdourl;
		...
		sdourl = "{{ url('suppliers_do/add/') }}/"+items+"/SDO";
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "{{ url('suppliers_do/item_details/') }}";
