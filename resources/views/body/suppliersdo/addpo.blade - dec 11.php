									...
									<div class="itemdivChld">							
										<div class="form-group">
											<div class="col-sm-2">
												...
												<input type="text" id="itmcod_1" name="item_code[]" value="{{$poitem->item_name}}" class="form-control" autocomplete="off" onclick="getItems(this)" placeholder="Item Code">
										...
										<div class="form-group">
											...
											<div class="col-xs-10">
												<div class="col-xs-2">
													...
													<input type="text" name="unit[]" value="{{$poitem->unit_name}}" id="itmunt_1" readonly class="form-control" placeholder="Unit">
