                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> New Status
                        </h3>

                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" name="frmCargoStatus"
                            id="frmCargoStatus" action="{{ url('cargo_status/save') }}">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                     <select id="driver_type" class="form-control select" required style="width:100%" name="status_type">
									<option value="" selected>Select </option>
									<option value="1">Despatch Status</option>
									<option value="2">Waybill Status</option>
								</select>
                                     </div>
                            </div>
                            <div class="form-group">
