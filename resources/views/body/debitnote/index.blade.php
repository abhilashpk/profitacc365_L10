                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Debit Note List
                        </h3>
                        <div class="pull-right">
							@can('rv-create')
                             <a href="{{ url('debit_note/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableCrNote">
                                    ...
                                    <tr>
										...
										<td>
											@can('rv-edit')<p><button class="btn btn-primary btn-xs" onClick="location.href='{{ url('debit_note/edit/'.$row->id)}}'"><span class="glyphicon glyphicon-pencil"></span></button></p>@endcan
										</td>
										<td>
										...
										<td>
											@can('rv-print')<p><a href="{{url('debit_note/print/'.$row->id.'/'.$prints[0]->id)}}" target='_blank' class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span></a></p>@endcan
										</td>
                                    </tr>
									@endforeach
