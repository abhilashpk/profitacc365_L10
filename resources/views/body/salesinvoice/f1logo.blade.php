						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								<tr>
									<td colspan="2" align="center">
										<table border="0">
											<tr>
												<td align="center" width="25%"><img src="{{asset('assets/logoleft.jpg')}}" width="80%"/></td>
												<td align="center" width="50%">
													<b style="font-size:20px;">{{Session::get('company')}}</b><br/>
													{{Session::get('address')}}<br/>{{Session::get('phone')}}, Email:{{Session::get('email')}}</br/>
													<b>TRN No: {{Session::get('vatno')}}</b>
												</td>
												<td align="center" width="25%"><img src="{{asset('assets/logoright.jpg')}}" width="80%"/></td>
											</tr>
										</table>
									</td>
								</tr>
								...
								<tr>
									<td align="left" valign="top" width="35%" style="padding-left:0px; padding-bottom:5px;">
										<div style="border:1px solid #000; padding: 10px;">
											...
											Telephone No: {{$details->custphone}}<br/>
							...
							<tbody>
								<tr style="border:1px solid black;">
									...
									<table border="0" style="width:100%;" class="table table-bordered">
										<tr>
											<td width="3%" align="center" style="border:1px solid #000 !important;"><b>Si.#</b></td>
											<!--<td width="12%" align="center" style="border:1px solid #000 !important;"><b>Item Code</b></td>-->
											<td width="40%" align="center" style="border:1px solid #000 !important;"><b>Description of Goods</b></td>
											<td width="5%" align="center" style="border:1px solid #000 !important;" ><b>Qty.</b></td>
											<td width="8%" align="center" style="border:1px solid #000 !important;" ><b>Rate</b></td>
											<td width="5%" align="center" style="border:1px solid #000 !important;" ><b>Per</b></td>
											<td width="10%" align="center" style="border:1px solid #000 !important;" ><b>Amount</b></td>
											<td width="5%" align="center" style="border:1px solid #000 !important;" ><b>VAT%</b></td>
											<td width="13%" align="center" style="border:1px solid #000 !important;" ><b>Taxable Val.</b></td>
											<td width="11%" align="center" style="border:1px solid #000 !important;" ><b>Tax Amt.</b></td>
										</tr>
										<?php $i = $total_qty = $ln_total = 0;?>
										...
										<?php $i++; 
											if($fc) {
												...
												$netline_total = $line_total + $vat_amount;
								...
								<tr style="border:1px solid black;">
									...
									<td width="40%" align="center" style="border:0px solid #000 !important;"><b>Total:</b></td>
									<td width="5%" align="center" style="border:0px solid #000 !important;" ><b>{{$total_qty}}</b></td>
									<td width="8%" align="center" style="border:0px solid #000 !important;" ></td>
									<td width="5%" align="center" style="border:0px solid #000 !important;" ></td>
									<td width="10%" align="center" style="border:0px solid #000 !important;" ><b>{{number_format($ln_total,2)}}</b></td>
									<td width="5%" align="center" style="border:0px solid #000 !important;" ></td>
									<td width="13%" align="center" style="border:0px solid #000 !important;" ></td>
									<td width="11%" align="center" style="border:0px solid #000 !important;" ></td>
									</tr></table>
									</td>
								</tr>
									...
									<td colspan="2" align="center">
										...
										<tr>
											<td width="65%" style="padding-left:10px;">
												Amount chargeable(in words): <b>{{$amtwords}}</b><br/>
												VAT Amount(in words): <b>{{$vatamtwords}}</b>
											</td>
								...
								<tr style="border:0px solid black;">
									<td colspan="2">
										<table border="0" style="width:100%;">
											<tr>
												<td colspan="2"><br/>{!! $details->hf_description !!}</td>
											</tr>
											<tr>
												<td colspan="2">Declaration:<br/> Goods once sold cannot be taken back. We declare that this invoice shows the actual price of the goods described on that all particulars are true as correct.</td>
											</tr>
										</table>
									</td>
								</tr>
							...
							<div class="footer" style="text-align:center; border:0px solid red; width:86%;">
								<div style="width:70%; border:0px solid red;float:left; text-align: left; padding-bottom:10px;">
									Issued By: FORCE ONE TRADING FZE.
							</div>
