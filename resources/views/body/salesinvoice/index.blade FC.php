                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tableSalesInvoice">
                                    <thead>
                                    <tr>
										<th>Voucher No</th>
										<th>Reference No</th>
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td>{{ date('d-m-Y', strtotime($invoice->voucher_date)) }}</td>
											<td>
												<p><button class="btn btn-primary btn-xs" onClick="location.href='{{ url('sales_invoice/edit/'.$invoice->id)}}'"><span class="glyphicon glyphicon-pencil"></span></button></p>
											</td>
											<td>
												<p><a href="{{url('sales_invoice/print/'.$invoice->id)}}" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span>Invoice</a></p>
											</td>
											<td>
												<?php if($invoice->is_fc==1) { ?>
												<p><a href="{{url('sales_invoice/print/'.$invoice->id.'/FC')}}" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span> FC</a></p>
											<?php } ?>
												<!--<p><a href="{{url('sales_invoice/printdo/'.$invoice->id)}}" class="btn btn-primary btn-xs" target="_blank"><span class="fa fa-fw fa-print"></span>DO</a></p>-->
											</td>
											<td>
												<p><button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $invoice->id }}')"><span class="glyphicon glyphicon-trash"></span></button></p>
											</td>
										</tr>
										@endforeach
                                    </tbody>
