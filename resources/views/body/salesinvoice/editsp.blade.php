                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('sales_invoice/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									 <select id="document_type" class="form-control select2" style="width:100%" name="document_type">
										...
										<!--<option value="CDO">Customer Delivery Order</option>-->
									</select>
                                    </div>
                                </div>
								<?php } else { ?>
									...
									<div class="itemdivChld">	
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="11%">
													<input type="text" id="itmttl_{{$i}}" name="line_total[]" class="form-control line-total" readonly value="{{$item->pay_amount}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control spl" readonly value="<?php echo (old('net_amount_hid'))?old('net_amount_hid'):$net_total;?>">
