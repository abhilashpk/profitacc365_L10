                    ...
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								<?php if($fc) { ?>
									<tr>
										<td colspan="2"><div style="height:150px;"></div></td>
									</tr>
								<?php } else { ?>
								<tr>
									<td align="center" valign="top"><h3><b>{{Session::get('company')}}</b></h3>
									<!--<img src="{{asset('assets/'.Session::get('logo').'')}}" height="75%" width="100%" />--></td>
									<td align="center">P.O BOX:44341, NEAR NATIONAL PAINT R/A,<br/>
									SHARJAH, UAE Tel: +971 65350992<br/> Fax: +971 65350961 <b>TRN No: {{Session::get('vatno')}}</b></td> 
								</tr>
								<?php } ?>
								<tr>
									<td colspan="2" align="center"><h5><b><u>TAX INVOICE</u></b></h5></td>
								</tr>
								<tr>
									<td align="left" valign="top" style="padding-left:20px; padding-bottom:5px;">
										<div>
