						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								<tr>
									...
									<img src="{{asset('assets/'.Session::get('logo').'')}}" />
									</td>
								</tr>
								
								<tr><td colspan="2"  align="center"><h5><b><u>TAX INVOICE</u></b></h5></td></tr>
								...
								<tr style="border:0px solid black;">
									<td align="left" width="80%" valign="top" style="padding-left:20px; padding-bottom:5px;">
										<div>
											...
											<?php $vat_no = ($details->vat_no=='')?$details->customer_trn:$details->vat_no; ?>
											<?php echo ($vat_no!='')?'<br/>TRN No: <strong>'.$vat_no.'</strong>':'';?><br/>
										</div>
									</td>
									<td align="left">
										<div>
											<b>Inv. No: {{$details->voucher_no}}</b><br/>
							...
							<tbody>
								<tr style="border:1px solid black;">
									<td colspan="2" align="center" valign="top" style="height:490px;">
									<table border="0" style="width:100%;" class="table table-bordered">
										<tr>
											...
											<td width="15%" class="text-right"><b>Rate</b></td>
										...
										<tr>
											...
											<td class="text-right">{{number_format($item->pay_amount,2)}}</td>
										</tr>
								...
								<tr style="border:1px solid black;">
									<td colspan="2" align="center">
										...
										<tr>
											<td  align="right"><b>
											<p>Total Work Done<?php if($fc) echo ' ('.$details->currency.')'?>: </p>
											<p>Less - <?php echo $details->less_description;?>: </p>
											<p>Less - <?php echo $details->less_description2;?>: </p>
											<p>Less - <?php echo $details->less_description3;?>: </p>
											<p>Less - <?php echo $details->previnv_description;?>: </p>
											<p>Total Amount against this Invoice<?php if($fc) echo ' ('.$details->currency.')'?>: </p>
											<p>Add + 5% VAT Extra<?php if($fc) echo ' ('.$details->currency.')'?>: </p>
											<?php if($details->discount!=0) { ?><p>Discount: </p><?php } ?>
											<p>Total Amount Against this Certificate including Tax<?php if($fc) echo ' ('.$details->currency.')'?>: </p></b>
											</td>
											<td  align="right">
											<?php 
												/* if($fc) {
											...
											<b>
												...
												<p>{{number_format($details->less_amount,2)}}</p>
												<p>{{number_format($details->less_amount2,2)}}</p>
												<p>{{number_format($details->less_amount3,2)}}</p>
												<p>{{number_format($details->previnv_amount,2)}}</p>
												<p>{{number_format($details->subtotal,2)}}</p>
										...
										<tr><td colspan="2" height="40" align="center"><b>DHS: {{$amtwords}}</b></td></tr>
										</table>
									</td>
								</tr>
								<tr style="border:0px solid black;">
									<td colspan="2"><?php if(!$fc) { ?>
										<table border="0" style="width:100%;">
											<tr>
												<td style="padding-left:5px;"> {!! $details->description !!}
													Received by: ...............................
												</td>
