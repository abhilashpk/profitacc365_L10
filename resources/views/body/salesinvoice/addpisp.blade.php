								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									 <select id="document_type" class="form-control select2" style="width:100%" name="document_type">
										...
										<option value="SO" <?php if($doctype=='SO') echo 'selected'; ?>>Payment Certificate</option>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="job_id" class="form-control select2" style="width:100%" name="job_id">
											...
											{{--*/ $sel = "" /*--}}	
											@endif
											<option value="{{ $job['id'] }}" {{$sel}}>{{ $job['code'] }}</option>
											@endforeach
                                        </select>
                                    </div>
                                </div>
									...
									<div class="itemdivChld">	
										<table border="0" class="table-dy-row">
											...
											<div style="float:left;">
												Amount in % <input type="text" style="width:50px;" id="per_{{$j}}" name="per[]" class="perc" value="{{old('per')[$i]}}"/> <input type="text" style="width:250px;" placeholder="Description..." value="{{$item->pay_pcntg_desc}}" id="perdesc_{{$j}}" value="{{old('perdesc')[$i]}}" name="perdesc[]"/>
											</div>
									...
									<div class="itemdivChld">	
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="11%">
													<input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" class="form-control line-total" readonly value="{{intval($item->pay_amount)}}">
													<input type="hidden" id="itmtot_{{$i}}" name="item_total[]" value="{{$item->pay_amount}}">
												</td>
												<td width="1%">
													@if($num==$i)
														<button type="button" class="btn-success btn-add-item" >
											...
											<div style="float:left;">
												Amount in % <input type="text" style="width:50px;" id="per_{{$i}}" name="per[]" class="perc" value="{{$item->pay_pcntg}}"/> <input type="text" style="width:250px;" placeholder="Description..." value="{{$item->pay_pcntg_desc}}" id="perdesc_{{$i}}" name="perdesc[]"/>
											</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="net_amount" value="<?php echo (old('net_amount'))?old('net_amount'):intval($docrow->net_total*100)/100; ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
