...
@section('content')
    <!-- Content Header (Page header) -->
		...
		<div class="alert alert-success">
			...
			<script>alert('DO updated successfully and redirecting to transfered invoice. Please update the invoice for make the changes as in the DO.');</script>
		</div>
		@endif
        <!--section ends-->
		@if (count($errors) > 0)
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('sales_invoice/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									 <select id="document_type" class="form-control select2" style="width:100%" name="document_type">
										<option value="SQ" {{($orderrow->document_type=='SQ')?'selected':''}}>Sales Quotation</option>
										<option value="SO" {{($orderrow->document_type=='SO')?'selected':''}}>Sales Order</option>
										<option value="CDO" {{($orderrow->document_type=='CDO')?'selected':''}}>Delivery Order</option>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="hidden" class="form-control" id="document_id" value="{{$orderrow->document_id}}" readonly name="document_id">
                                    </div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												@endif
													...
													<input type="hidden" name="order_item_id[]" id="p_orditmid_{{$i}}" value="{{(isset($orditems[$key]))?$orditems[$key]->id:''}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10"> 
										...
										<div class="col-xs-2"></div>                                                                                                                     
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" step="any" id="total" step="any" name="total" class="form-control spl" readonly value="{{(old('total'))?old('total'):($docrow->is_fc==1)?$docrow->total_fc:$docrow->total}}">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" step="any" id="total_fc" name="total_fc" class="form-control spl" value="{{(old('total_fc'))?old('total_fc'):$docrow->total}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"><!-- MR19 -->
											<input type="number" step="any" id="discount" name="discount" autocomplete="off" class="form-control spl discount-cal" value="{{(old('discount'))?old('discount'):($docrow->is_fc==1)?$docrow->discount_fc:$docrow->discount}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control spl" readonly value="{{(old('subtotal_fc'))?old('subtotal_fc'):$docrow->subtotal}}">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" value="{{(old('vat'))?old('vat'):($docrow->is_fc==1)?$docrow->vat_amount_fc:$docrow->vat_amount}}" readonly>
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control" readonly value="<?php echo (old('net_amount_hid'))?old('net_amount_hid'):$docrow->net_total;?>">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="{{(old('net_amount'))?old('net_amount'):($docrow->is_fc==1)?$docrow->net_total_fc:$docrow->net_total}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" value="<?php echo (old('net_amount_fc'))?old('net_amount_fc'):$docrow->net_total; ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('sales_invoice/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	<?php if( count(array($vouchers)) > 0 && $vouchers->is_cash_voucher==1) { ?> //cash customer.... is_cash_voucher 
