									...
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tbody>
												...
												<?php
													$tot_sprice += $report['sptotal'];
													$tot_discount += $report['discount'];
													$tot_price += $report['sptotal'];
													$tot_cost += $report['cost'];
													$tot_profit += $report['profit'];
												?>
												<tr>
													<td>{{ $report['voucher_no'] }} {{($report['is_assebly']==1)?'(Assembly Item Included)':''}}</td>
													<td>{{ date('d-m-Y', strtotime($report['voucher_date'])) }}</td>
													<td>{{ $report['supplier'] }}</td>
													<td>{{ $report['salesman'] }}</td>
													<td class="text-right">{{ number_format($report['sptotal'],3) }}</td>
													<td class="text-right">{{ number_format($report['discount'],3) }}</td>
													<td class="text-right">{{ number_format(($report['sptotal']), 3) }}</td>
													<td class="text-right">{{ number_format($report['cost'],3) }}</td>
													<td class="text-right">{{ number_format($report['profit'], 3) }}</td>
													<td>{{number_format($report['percentage'],3)}}</td>
												</tr>
												@endforeach
												<tr>
													<td></td>
													...
													<td></td>
													<td><b>Total</b></td>
													<td class="text-right"><b>{{ number_format($tot_price,3) }}</b></td>
													<td class="text-right"><b>{{ number_format($tot_discount,3) }}</b></td>
													<td class="text-right"><b>{{ number_format($tot_sprice, 3) }}</b></td>
													<td class="text-right"><b>{{ number_format($tot_cost,3) }}</b></td>
													<td class="text-right"><b>{{ number_format($tot_profit, 3) }}</b></td>
													<td></td>
												</tr>
											</tbody>
										</table>
							...
							<tbody id="bod">
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<?php 
											...
											foreach($report as $row) { 
											    ...
											    $pprice	= ($row['punit_price1'] * $row['squantity']) + $row['assembly_items_cost'];
										...
										<tr>
											...
											<td >{{number_format($row['sunit_price'],3)}}</td>
											<td>{{$row['squantity']}}</td>
											<td class="text-right">{{number_format($sprice,3)}}</td>
										
											<td class="text-right">{{number_format($pprice,3)}}</td>
									...
									<tr>
										...
										<td class="text-right"><b>{{number_format($sptotal,3)}}</b></td>
									
										<td class="text-right"><b>{{number_format($tcst,3)}}</b></td>
										<td class="text-right"><b>{{number_format($ptotal,3)}}</b></td>
										<td class="text-right"><b>{{number_format($peravg,3)}}</b></td>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td width="11%" class="text-right"><b>{{number_format($nsptotal,3)}}</b></td>
										
											<td width="10%" class="text-right"><b>{{number_format($nctotal,3)}}</b></td>
											<td width="9%" class="text-right"><b>{{number_format($nptotal,3)}}</b></td>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td>{{$row['squantity']}}</td>
											<td class="text-right">{{number_format($sprice,3)}}</td>
											<td class="text-right">{{number_format($row['discount'],3)}}</td>
											<td class="text-right">{{number_format($pprice,3)}}</td>
											<td class="text-right">{{number_format($profit,3)}}</td>
											<td class="text-right">{{number_format($percentage,3)}}</td>
										</tr>
									...
									<tr>
										<td colspan="4" align="right"><b>Sub Total:</b></td>
										<td class="text-right"><b>{{number_format($sptotal,3)}}</b></td>
										<td class="text-right"><b>{{number_format($dtotal,3)}}</b></td>
										<td class="text-right"><b>{{number_format($tcst,3)}}</b></td>
										<td class="text-right"><b>{{number_format($ptotal,3)}}</b></td>
										<td class="text-right"><b>{{number_format($peravg,3)}}</b></td>
									</tr>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td width="12%" class="text-right"><b>{{number_format($nsptotal,3)}}</b></td>
											<td width="8%" class="text-right"><b>{{number_format($ndtotal,3)}}</b></td>
											<td width="10%" class="text-right"><b>{{number_format($nctotal,3)}}</b></td>
											<td width="12%" class="text-right"><b>{{number_format($nptotal,3)}}</b></td>
								...
								<tbody id="bod">
									...
									<tr style="border:0px solid black;">
										...
										<table border="0" style="width:100%;" class="tblstyle table-bordered">
											...
											<tr>
												...
												<td class="text-right">{{number_format($row['sprice'],3)}}</td>
												<td class="text-right">{{number_format($row['discount'],3)}}</td>
												<td  class="text-right">{{number_format($row['cost'],3)}}</td>
												<td  class="text-right">{{number_format($row['profit'],3)}}</td>
												<td  class="text-right">{{number_format($row['percentage'],3)}}</td>
											</tr>
										<?php } $peravg = $pertotal / $n;
									...
									?>
										...
										<tr>
											...
											<td class="text-right"><b>{{number_format($sptotal,3)}}</b></td>
											<td  class="text-right"><b>{{number_format($dtotal,3)}}</b></td>
											<td class="text-right"><b>{{number_format($ctotal,3)}}</b></td>
											<td  class="text-right"><b>{{number_format($ptotal,3)}}</b></td>
    										  ...
    										  <tr style="border:0px solid black;">
            									...
            									<table border="0" style="width:100%;" class="tblstyle table-bordered">
            										...
            										<tr>
            											...
            											<td width="10%" class="text-right"><b>{{number_format($nsptotal,3)}}</b></td>
            											<td width="8%" class="text-right"><b>{{number_format($ndtotal,3)}}</b></td>
            											<td width="10%" class="text-right"><b>{{number_format($nctotal,3)}}</b></td>
            											<td width="12%" class="text-right"><b>{{number_format($nptotal,3)}}</b></td>
            											<td width="10%" class="text-right"></td>
											...
											<tr style="border:0px solid black;">
												...
												<table border="0" style="width:100%;" class="tblstyle table-bordered">
													...
													<tr>
														...
														<td  class="text-right">{{number_format($row->amount,3)}}</td>
													</tr>
													@endforeach
													<tr>
														<td align="right"><b>Sub Total:</b></td>
														<td  class="text-right"><b>{{$total_qty}}</b></td>
														<td class="text-right"><b>{{number_format($stock_total,3)}}</b></td>
													</tr>
												</table>
												</td>
											</tr>
