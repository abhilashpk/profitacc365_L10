                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Duration
                        </h3>
                        <div class="pull-right">
						<a href="{{ url('duration/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableCrNote">
                                    ...
                                    <tr>
										...
										<td>
										<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('duration/edit/'.$row->id) }}'">
...
function funDelete(id) {
	var con = confirm('Are you sure delete this duration?');
	if(con==true) {
		var url = "{{ url('duration/delete/') }}";
