                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmFlat" id="frmFlat"  action="{{url('duration/save')}}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									
									<div class="form-group">
										<label for="input-text" class="col-sm-2 control-label">Duration</label>
                                        <div class="col-sm-10">
											<input type="text" class="form-control" id="duration_month" name="duration_month" autocomplete="off" placeholder="Months">
										</div>
									...
									<!--<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="duration_days" name="duration_days"  autocomplete="off" placeholder="Days">
										</div>
									</div>-->
