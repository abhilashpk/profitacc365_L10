        ...
        <section class="content">
            <div class="row">
				...
				<div class="alert alert-warning">
					<p>
						Credit Note voucher is not found! Please create a voucher in Account Settings.
					</p>
				</div>
				<?php } else { ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> New Credit Note 
                            </h3>
                           
                        </div>
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmCreditNote" id="frmCreditNote" action="{{ url('credit_note/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="hidden" name="dr_account_id" id="dr_account_id" value="{{$voucher['dr_account_master_id']}}" class="form-control">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<div class="input-group">
											...
											<input type="number" step="any" class="form-control" id="amount" name="amount" autocomplete="off">
										...
										<div class="itemdivPrnt">
											<div class="itemdivChld">							
												<div class="form-group" style="margin-bottom: 1px;">
													...
													<input type="text" id="craccount_1" name="account_name[]" class="form-control acname" autocomplete="off" data-toggle="modal" data-target="#account_modal">
													<input type="hidden" name="cr_account_id[]" id="craccountid_1"><!-- acntid_1 -->
													<input type="hidden" name="group_id[]" id="groupid_1">
													<input type="hidden" name="vatamt[]" id="vatamt_1">
													
													<input type="hidden" id="invoiceid_1" name="purchase_invoice_id[]">
													<input type="hidden" name="bill_type1[]" value="SI">
													</div>
													<div class="col-xs-15">
														<div class="col-xs-3">
															<span class="small">Description</span> <input type="text" id="descr_1" autocomplete="off" name="cr_description[]" class="form-control">
														</div>
														<div class="col-xs-2" style="width:10%;">
															<span class="small">Reference</span> 
															<div id="refdata_1" class="refdata">
															<input type="text" id="ref_1" name="cr_reference[]" autocomplete="off" class="form-control">
															</div>
														...
														<div class="col-xs-2" style="width:15%;">
															<span class="small">Amount</span> <input type="number" id="amount_1" autocomplete="off" step="any" name="cr_amount[]" class="form-control line-amount">
														</div>
...
$(function(){
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
	...
	$(document).on('blur', '#voucher_date', function(e) { 
        ...
        //$('#frmCreditNote').bootstrapValidator('revalidateField', 'voucher_date');
		$('#frmCreditNote').bootstrapValidator('revalidateField', 'voucher_no');
	});
	...
	/* $(document).on('blur', '.acname', function(e) { 
        // Revalidate the date when user change it
        $('#frmCreditNote').bootstrapValidator('revalidateField', 'account_name[]');
	});
	
	$(document).on('blur', '.pname', function(e) { 
        // Revalidate the date when user change it
        $('#frmCreditNote').bootstrapValidator('revalidateField', 'party_name[]');
	}); */
