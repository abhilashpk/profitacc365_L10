            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <tr><td align="center" colspan="3">
								...
								<tr>
									...
									<td width="40%" align="right"><p>CN. No: {{$details->voucher_no}}</p><p>Date: {{date('d-m-Y',strtotime($details->voucher_date))}}</p></td>
								</tr>
							</table><br/>
                        </div>
						<?php
						...
						?>
                        <div class="col-md-12">
							<div style="text-align:center;"><h5><p>Received with thanks from Ms./Mr. <b>{{$invoicerow[0]->master_name}}</b> the sum of <b> {{number_format($invoicerow[0]->cr_amount,2)}} </b>.</p></h5></div>
