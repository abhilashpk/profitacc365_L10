                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Edit Collection Type
                        </h3>

                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" name="frmCollectionType"
                            id="frmCollectionType" action="{{ url('collection_type/update/' . $ctedit->id) }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="collection_id" value="<?php echo $ctedit->id; ?>">

                            <div class="form-group">
                                <label for="input-text" class="col-sm-2 control-label">Code</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" name="code"
                                        placeholder="Enter Code" value="{{ $ctedit->code }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="description" name="description"
                                        placeholder="Enter Description" value="{{ $ctedit->description }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a href="{{ url('collection_type') }}" class="btn btn-danger">Cancel</a>
                                </div>
                            </div>
...
@section('footer_scripts')
    ...
    <script>
        ...
        var url = "{{ url('collection_type/checkcode/') }}";
            $('#frmCollectionType').bootstrapValidator({
                fields: {
                                ...
                                data: function(validator) {
                                    return {
                                        code: validator.getFieldElements('code').val(),
                                         id: validator.getFieldElements('collection_id').val(),
                                    };
                                },
                ...
                $('#frmCollectionType').data('bootstrapValidator').resetForm();
            });
        });
    </script>
@stop
