                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" name="frmCargoVehicle"
                            id="frmCargoVehicle" action="{{ url('cargo_vehicle/update/' . $cvedit->id) }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="vehicle_id" value="<?php echo $cvedit->id; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="vnumber" name="vnumber"
                                        placeholder="Vehicle No:" value="{{ $cvedit->vehicle_no }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="vname" name="vname"
                                        placeholder="Vehicle Type" value="{{ $cvedit->vehicle_name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="dname" name="dname"
                                        placeholder="Driver Name" value="{{ $cvedit->driver_name }}">
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="company" name="company"
                                        placeholder="Driver Name" value="{{ $cvedit->company }}" required>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    value="{{ $cvedit->driver_id }}" placeholder="ID No:" required>
                                </div>
                                 <label for="input-text" class="col-sm-2 control-label">Driver Passport No:</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="passport" name="passport"
                                       value="{{ $cvedit->passport_no }}" placeholder="Passport No:" required>
                                </div>
                            </div>

                             <div class="form-group">
                                <label for="input-text" class="col-sm-2 control-label">Diver Mobile(UAE)</label>
                                <div class="col-sm-4">
                                    <input type="tel" class="form-control" id="mbuae" name="mbuae"
                                        placeholder="Mobile(UAE)" value="{{ $cvedit->mobile_uae }}" required>
                                </div>
                                <label for="input-text" class="col-sm-2 control-label">Diver Mobile(KSA)</label>
                                <div class="col-sm-4">
                                    <input type="tel" class="form-control" id="mbksa" name="mbksa"
                                        placeholder="Mobile(KSA)" value="{{ $cvedit->mobile_ksa }}"required>
                                </div>
                            </div>
                            
                            
                             <div class="form-group">
                               <label for="input-text" class="col-sm-2 control-label">Watsapp</label>
                                <div class="col-sm-4">
                                    <input type="tel" class="form-control" id="watsapp" name="watsapp"
                                        value="{{ $cvedit->watsapp }}"required>
                                </div>
                                <label for="input-text" class="col-sm-2 control-label">Expiry Date</label>
                                    <div class="col-sm-4">
                                        ...
                                        id="expiry_date" data-language='en'  value="{{date('d-m-Y',strtotime($cvedit->expiry_date))}}" readonly required/>
								   </div>
                            </div>
                            <div class="form-group">
