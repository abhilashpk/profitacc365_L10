                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="{{ url('unit/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tr>
                                    <td><input <?php if(($unit->id <=2) && ($aitem==1) ) echo 'disabled';?> type='checkbox' name='unitid[]' class='chk-unitid' value='{{$unit->id}}'/></td>
                                    <td>{{ $unit->unit_name }}</td>
                                    <td>{{ $unit->description }}</td>
                                    <td>
                                        <p>
                                            <button class="btn btn-primary btn-xs" onClick="location.href='{{ url('unit/edit/'.$unit->id) }}'"><span
                                                        class="glyphicon glyphicon-pencil"></span></button>
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            <button class="btn btn-danger btn-xs delete"<?php if(($unit->id <=2)  && ($aitem==1)) echo 'disabled';?>  onClick="funDelete('{{ $unit->id }}')"><span
    ...
    if (!checked) {
        ...
        if(con==true) {
           ...
           $('#chkids').val(id);
            ...
            document.frmUnits.action="{{ url('unit/group_delete') }}"
...
function deleteRow() {  
    ...
    if (!checked) {
        ...
        if(con==true) {
            ...
            document.frmOrders.action="{{ url('unit/group_delete') }}"
