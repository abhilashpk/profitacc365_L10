                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          <div class="controls"> 
                                ...
                                <div class="itemdivChld">
                                    <div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
                                        <div class="col-sm-2"> <span class="small">Account Name</span>
                                            <input type="text" id="draccount_1" name="account_name[]" class="form-control acname" autocomplete="off" data-toggle="modal" data-target="#account_modal" placeholder="Select Account">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmCustReceipt" id="frmCustReceipt" action="{{ url('journal/save') }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="from_jv" value="1">
                                <input type="hidden" name="voucher_type" value="9">
                                <input type="hidden" name="chktype" id="chktype" value="9">
...
$(document).on('click', '.btn-add-item', function(e)  { 
    rowNum++; 
        ...
        $('#frmCustReceipt').bootstrapValidator('addField',"account_name[]");
