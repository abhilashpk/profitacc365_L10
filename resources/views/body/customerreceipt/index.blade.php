...
@section('content')
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							@can('rv-create')
							@if($formdata['multi_entry']==1)
							<a href="{{ url('customer_receipt/add-rv') }}" class="btn btn-primary btn-sm">
        ...
        <section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="{{ url('customer_receipt/search') }}">
...
$(function() {
		...
		var dtInstance = $("#tableRVlist").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "{{ url('customer_receipt/paging/') }}",
					 "dataType": "json",
					 "type": "POST",
			...
			//{ "data": "creditor" },
			{ "data": "amount" },
			@can('rv-edit'){ "data": "edit","bSortable": false },@endcan
			@can('rv-print'){ "data": "print","bSortable": false },@endcan
			@can('rv-delete'){ "data": "delete","bSortable": false }@endcan
		]	
