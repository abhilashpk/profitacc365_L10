                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="{{ url('customer_receipt/update/'.$crrow->id) }}">
								...
								<legend><h5>Transactions</h5></legend>
										...
										foreach($invoicetrrow as $invrow) {
											if($item->id == $invrow->receipt_voucher_entry_id) {
												$invoice_id = $invrow->sales_invoice_id;
												$tr_id = $invrow->id;
											}
										} ?>
											<div class="itemdivChld">							
												<div class="form-group">
													<div class="col-sm-3"> <span class="small">Account Name<!-- acntname_1 --></span>
													...
													<input type="hidden" id="invoiceid_{{$i}}" name="sales_invoice_id[]" value="{{$invoice_id}}">
													...
													<div class="col-xs-15">
														...
														<div class="col-xs-1"><br/>
															<button type="button" class="btn btn-success btn-danger btn-remove-item" data-id="rem_{{$i}}"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </button>
															 <button type="button" class="btn btn-success btn-add-item" style="margin-top:2px;">
