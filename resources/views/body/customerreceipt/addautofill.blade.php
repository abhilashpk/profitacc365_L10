                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmCustReceipt" id="frmCustReceipt" action="{{ url('customer_receipt/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
										<div class="input-group">
											...
											<input type="number" step="any" class="form-control <?php if($errors->has('amount')) echo 'form-error';?>" id="amount" name="amount" value="{{$amount}}">
								...
								<div id="chequeInput">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control <?php if($errors->has('cheque_no')) echo 'form-error';?>" id="cheque_no" name="cheque_no" value="{{old('cheque_no')}}" autocomplete="off">
										</div>
									</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control <?php if($errors->has('customer_account')) echo 'form-error';?>" value="{{$custrow->master_name}}" id="customer_account" name="customer_account" autocomplete="off" data-toggle="modal" data-target="#customer_modal">
										<input type="hidden" class="form-control" id="customer_id" name="customer_id" value="{{$custrow->id}}">
                                    </div>
                                </div>
										...
										<div class="table-responsive item-data" id="crTransactionData">
											...
											<table class="table table-bordered table-hover" id="tableRV">
												...
												<tr>
													...
													<td><input type="checkbox" id="tag_{{$i}}" name="tag[]" checked class="tag-line-nw" value="{{$i-1}}" onclick="getTag(this)"></td>
													...
													<td><input type="text" id="lineamnt_{{$i}}" step="any" name="line_amount[]" value="{{$row->balance_amount}}" class="form-control line-amount" style="width:8em;">
													<input type="hidden" id="hidamt_{{$i}}" name="actual_amount[]" value="{{$row->balance_amount}}">
													<input type="hidden" id="sinvoiceid_{{$i}}" name="sales_invoice_id[]" value="{{$siid}}">
													<input type="hidden" name="bill_type[]" id="billtype_{{$i}}" value="SI"> </td>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="debit" name="debit" value="{{$amount}}" readonly placeholder="0.00">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="credit" name="credit" value="{{$amount}}" readonly placeholder="0.00">
                                    </div>
                                </div>
   ...
   $('#department_id').on('change', function(e){ 
	...
	$('#customer_account').click(function() {
		if($('#department_id').length)
			...
			custurl = "{{ url('sales_invoice/customer_data/') }}";
