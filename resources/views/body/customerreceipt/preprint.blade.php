        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
						...
						<table border="0" style="width:100%;height:100%;">
							...
							<tbody id="bod">
								<tr style="border:0px solid black;">
									...
									<tr>
											<td width="1%"><b>Customer Account</b></td>
						...
						<table border="0" style="width:100%;height:100%;">
							...
							<tbody id="bod">
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										<tr>
											<td width="15%"><b>RV No</b></td>
											<td width="10%"><b>RV</b></td>
											<td width="45%">Date</b></td>
							...
							<tbody id="bod">
								...
								<tr>
										<td align="left" valign="top" style="padding-left:0px;">
											<h6><b>Cus.Name: {{$report[0]->creditor}}<br/>
									...
									<td></td>
										...
										<td ><b>{{number_format($sptotal,2)}}</b></td>
									...
									<td></td>
										...
										<td ><b>{{number_format($nsptotal,2)}}</b></td>
							...
							<thead>
								<tr>									
									<td colspan="2" align="center">
										...
										<b style="font-size:20px;">{{Session::get('company')}}</b>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('customer_receipt/export') }}">
