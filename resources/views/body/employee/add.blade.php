                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
								...
								<div id="rootwizard">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="tab1">
											...
											<div class="form-group">
                                    			<label for="input-text" class="col-sm-2 control-label"><b>Category</b></label>
                                                <div class="col-sm-10">
                                                   <select id="category_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="category_id">
                                                     	<option>Select Category</option>
											            @foreach($category as $crow)
												           <option value="{{ $crow->id }}" >{{ $crow->category_name }}</option>
											          @endforeach
                                                   </select>
                                               </div>
                                            </div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" name="dob" id="dob" readonly data-language='en' autocomplete="off" />
												</div>
											</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<select id="emp_type" class="form-control select2" style="width:100%" name="emp_type">
                                        ...
                                        <div class="tab-pane" id="tab3">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Salary Start Date</label>
												<div class="col-sm-6">
													 <input type="text"  class="form-control" id="salary_start_date" name="salary_start_date" placeholder="Salary Start Date" data-language='en'>
												</div>
											</div>
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Salary End Date</label>
												<div class="col-sm-6">
													 <input type="text"  class="form-control" id="salary_end_date" name="salary_end_date" placeholder="Salary end Date" data-language='en'>
												</div>
											</div>
											<div class="form-group">
										...
										<div class="tab-pane" id="tab4">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="cname" name="cname" placeholder="Company">
											...
											<div class="form-group">
                                             ...
                                             <div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Other Files</label>
												<div class="col-sm-10">
													...
													<div id="files_list"></div>
													<p id="floading"></p>
													<input type="hidden" name="fimage_name" id="fimage_name">
												</div>
											</div>
							...
							<div class="form-group">
								<label for="input-text" class="col-sm-2 control-label">EDR</label>
								<div class="col-sm-10">
									<select id="emp_type" class="form-control select2" style="width:100%" name="emp_type">
									  <option value="EDR">EDR</option>
    ...
    $(function () {
		...
		$('#input-23f').fileupload({
            ...
            add: function (e, data) {
				...
				var fim = $('#fimage_name').val();
				$('#fimage_name').val( (fim=='')?data.result.file_name:fim+','+data.result.file_name );
