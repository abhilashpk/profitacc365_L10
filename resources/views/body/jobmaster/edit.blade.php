                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmJobmaster" id="frmJobmaster" action="{{ url('jobmaster/update/'.$jobmasterrow->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="transport_type" class="form-control select2" style="width:100%; background-color:#85d3ef;"  name="transport_type" onchange="myFunction(event)">
											...
											@if($jobmasterrow->transport_type==$job->id)
                                            <option value="{{ $job->id}}" <?php if($jobmasterrow->transport_type==$job->name) echo 'selected'; ?>>{{ $job->name}}</option>
                                            @endif
											@endforeach
                                        </select>
                                    </div>
                                ...
                                <?php if($formdata['origin']==1) { ?>
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" step="any" id="origin" name="origin" placeholder="Load Port" value="{{ $jobmasterrow->origin }}">
                                    </div>
                                 <?php } else { ?>
                                ...
                                <?php if($formdata['destination']==1) { ?>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="destination" id="destination" class="form-control" autocomplete="off"  placeholder="Discharge Port" value="{{ $jobmasterrow->destination }}">
                                    </div>
                                 <?php } else { ?>
                                ...
                                <?php if($formdata['por']==1) { ?>
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" step="any" id="por" name="por" placeholder="Place of Receipt" value="{{ $jobmasterrow->por }}">
                                    </div>
                                 <?php } else { ?>
                                ...
                                <?php if($formdata['fnd']==1) { ?>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="fnd" id="fnd" class="form-control" autocomplete="off"  placeholder="Place of Delivery" value="{{ $jobmasterrow->fnd }}">
                                    </div>
                                <?php } else { ?>
                                ...
                                <?php if($formdata['shipper']==1) { ?>
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="shipper" id="shipper" class="form-control" autocomplete="off" placeholder="Shipper" value="{{ $jobmasterrow->shipper }}">
                                    </div>
                                <?php } else { ?>
                                ...
                                <?php if($formdata['consignee']==1) { ?>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="consignee" id="consignee" class="form-control" autocomplete="off" placeholder="Consignee" value="{{ $jobmasterrow->consignee }}">
                                    </div>
                                <?php } else { ?>
