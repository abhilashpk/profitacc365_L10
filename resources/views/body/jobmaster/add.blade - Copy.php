                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmJobmaster" id="frmJobmaster" action="{{ url('jobmaster/save') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"> <input id="prefix" name="prefix" value="" type="text" readonly></span>
                                ...
                                <?php if($formdata['date']==1) { ?>
                                    ...
                                    <div class="col-sm-5">
                                        <input type="date" class="form-control pull-right"  id="date" name="date"  data-language='en'  placeholder="{{date('d-m-Y')}}"/>
                                    </div>
                                    <?php } else { ?>
                                ...
                                <?php if($formdata['origin']==1) { ?>
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" step="any" id="origin" name="origin" placeholder="Origin">
                                    </div>
                                <?php } else { ?>
                                ...
                                <?php if($formdata['por']==1) { ?>
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" step="any" id="por" name="por" placeholder="POR">
                                    </div>
                                <?php } else { ?>
                                ...
                                <?php if($formdata['fnd']==1) { ?>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="fnd" id="fnd" class="form-control" autocomplete="off"  placeholder="FND">
                                    </div>
                                <?php } else { ?>
                                ...
                                <?php if($formdata['destination']==1) { ?>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="destination" id="destination" class="form-control" autocomplete="off"  placeholder="Destination">
