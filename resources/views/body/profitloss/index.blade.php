               ...
               <div class="panel panel-info">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-columns"></i> Profit & Loss
                            </h3>
                        </div>
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmTrialBalance" id="frmTrialBalance" target="_blank" action="{{ url('profit_loss/search') }}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
								<div class="row">
									<div class="col-xs-6">
										<span>Date From:</span>
										<input type="text" name="date_from" id="date_from" data-language='en' autocomplete="off" class="form-control">
										<span>Date To:</span>
									...
									<div class="col-xs-6">
										...
										<span></span><br/>
										@if($optionsrch)
										<input type="checkbox" name="op_stock" value="1"> Opening Stock &nbsp;
										<input type="checkbox" name="cl_stock" value="1"> Closing Stock
										@endif
										&nbsp; &nbsp;
