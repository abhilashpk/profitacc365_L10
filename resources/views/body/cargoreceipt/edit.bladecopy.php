                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmCargoReceipt" id="frmCargoReceipt" action="{{url('cargo_receipt/update/'.$row->id)}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="consignee_name" name="consignee_name" value="{{$row->consignee_name}}" required autocomplete="off" data-toggle="modal" data-target="#consignee_modal">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" autocomplete="off" name="shipper_name" value="{{$row->shipper_name}}" required id="shipper_name"  data-toggle="modal" data-target="#shipper_modal"/>
