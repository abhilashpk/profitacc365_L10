                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmCargoReceipt" id="frmCargoReceipt" action="{{url('cargo_receipt/save')}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="consignee_name" name="consignee_name" required autocomplete="off" data-toggle="modal" data-target="#consignee_modal">
										<input type="hidden" name="consignee_id" id="consignee_id">
                                    </div>
                                    <label for="input-text" class="col-sm-2 control-label">Shipper Name</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" autocomplete="off" name="shipper_name" required id="shipper_name"  data-toggle="modal" data-target="#shipper_modal"/>
