                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> New Work Enquiry 
                            </h3>
                           
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmWorkenquiry" id="frmWorkenquiry" action="{{url('ms_workenquiry/save')}}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									
									<div class="form-group">
										<label for="input-text" class="col-sm-3 control-label">Enquiry No</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="enqno" readonly value="{{$enqno}}">
										</div>
									</div>
									
									<div class="form-group">
										<label for="input-text" class="col-sm-3 control-label">Enquiry Date Time</label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="customer_name" name="customer_name" autocomplete="off" data-toggle="modal" data-target="#customer_modal">
