							...
							<?php if($type=="detail") { ?>
								<table class="table" border="0">
									...
									<tr>
										...
										<td><b>CE..#:</b> {{$report[0]->voucher_no}}</td>
										<td><b>CE..Ref.#:</b> {{$report[0]->reference_no}}</td>
									...
									<tr>
										...
										<td class="text-right"><b>CE..Qty.</b></td>
							...
							<?php } elseif($type=="detail_pending") { ?>
								<table class="table" border="0">
									...
									<tr>
										<td><b>SI.No:</b> {{$report[0]->voucher_no}}</td>
										<td><b>CE..#:</b> {{$report[0]->voucher_no}}</td>
										<td colspan="2"><b>CE..Ref.#:</b> {{$report[0]->reference_no}}</td>
