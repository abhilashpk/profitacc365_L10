                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> <?php if($orderrow->is_editable==1) { echo 'Non-Editable'; } else echo 'Edit Customer Enquiry'; ?>
                            </h3>
							
							<div class="pull-right">
							<?php if($isprint) { ?>
							@can('ce-print')
							 <a href="{{ url('customer_enquiry/print/'.$orderrow->id) }}" target="_blank" class="btn btn-info btn-sm">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('customer_enquiry/update/'.$orderrow->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('customer_enquiry/edit/'.$orderrow->id) }}" class="btn btn-danger">Clear</a>
                                    </div>
                                </div>
...
$(function() {	
	...
	var custurl = "{{ url('customer_enquiry/customer_data/') }}";
