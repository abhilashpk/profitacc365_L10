                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Customer Enquiry
                            </h3>
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" enctype="multipart/form-data" id="frmQuotationSales" action="{{ url('customer_enquiry/save') }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" value="{{($lrow)?$lrow->id:''}}" name="lead_id">
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">CE. No.</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">CE. Date</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name" id="customer_name" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" value="<?php echo (old('customer_name'))?old('customer_name'):$quoterow->customer_name; ?>" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
...
$(function() {	
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "{{ url('quotation_sales/checkvchrno/') }}", 
			type: 'get',
