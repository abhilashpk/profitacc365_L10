                    ...
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-columns"></i> Customer Enquiry
                            </h3>
                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Customer Enquiry</h4>
                                        </div>
...
function setTransfer() {
	...
	url = "{{ url('quotation_sales/add/') }}/"+items+"/CE";
...
$(document).on('click', '.quot-data', function(e) {
	...
	var itmurl = "{{ url('customer_enquiry/item_details/') }}";
