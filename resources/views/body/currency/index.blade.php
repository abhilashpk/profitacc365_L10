                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Currency List
                        </h3>
                        <div class="pull-right">
                             <a href="{{ url('currency/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableBank">
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('currency/edit/'.$currency->id) }}'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>
										</td>
										<td>
											<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $currency->id }}')"><span
...
function funDelete(id) {
	var con = confirm('Are you sure delete this currency?');
	if(con==true) {
		var url = "{{ url('currency/delete/') }}";
