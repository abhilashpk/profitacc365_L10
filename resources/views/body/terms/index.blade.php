                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Terms List
                        </h3>
                        <div class="pull-right">
                             <a href="{{ url('terms/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableTerms">
                                    <thead>
                                    <tr>
                                        <th>Terms Code</th>
										<th>Description</th>
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('terms/edit/'.$terms->id) }}'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>
										</td>
										<td>
											<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $terms->id }}')"><span
...
function funDelete(id) {
	var con = confirm('Are you sure delete this terms?');
	if(con==true) {
		var url = "{{ url('terms/delete/') }}";
