                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Job Type List
                        </h3>
                        <div class="pull-right">
                             <a href="{{ url('jobtype/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableJobtype">
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('jobtype/edit/'.$row->id) }}'">
...
function funDelete(id) {
	var con = confirm('Are you sure delete this job type?');
	if(con==true) {
		var url = "{{ url('jobtype/delete/') }}";
