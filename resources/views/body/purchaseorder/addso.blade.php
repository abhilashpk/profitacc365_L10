                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" action="{{ url('purchase_order/save') }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">PO. No.</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="voucher_no" readonly name="voucher_no" value="{{$voucherno->no}}">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="voucher_date" readonly data-language='en' id="voucher_date" placeholder="{{date('d-m-Y')}}"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="po_no" name="po_no" placeholder="Purchase Order No" value="{{$docrow->voucher_no}}" autocomplete="off">
                                    </div>
                                </div>
								<input type="hidden" id="document_id" name="document_id" value="{{$pordid}}">
								<input type="hidden" id="document_type" name="document_type" value="SO">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="{{$docrow->supplier}}" class="form-control <?php if($errors->has('supplier_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<option value="">Select Location..</option>
											...
											?>
											<option value="{{ $loc['id'] }}" <?php if($loc['id']==$docrow->location_id) echo 'selected'; ?>>{{ $loc['name'] }}</option>
											<?php } ?>
                                        </select>
                                    </div>
                                </div>
								...
								{{--*/ $i++; /*--}}
									...
									<div class="itemdivChld">
										<?php 
											if($poitem->balance_quantity_po==0) {
												if($docrow->is_fc==1) {
												...
												if($docrow->is_fc==1) {
													$quantity = $actual_quantity = $poitem->balance_quantity_po;
													$unit_price = $poitem->unit_price / $docrow->currency_rate;
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_{{$i}}" step="any" readonly name="vatdiv[]" class="form-control vatdiv" ><!--<div class="h5" id="vatdiv_1"></div> value="{{$vat.'% - '.intval($vat_amount*100)/100}}" --> 
...
$(document).ready(function () { 
	...
	$('.itemdivPrnt').find('.btn-remove-item').show();
