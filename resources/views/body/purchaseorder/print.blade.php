            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								...
								<tr>
									<td colspan="2" align="center"><h4><b>PURCHASE ORDER</b></h4></td>
								</tr>
								<tr>
								...
								<tr>
									...
									We are pleased to submit our order.</td>
								</tr>
								<!--<tr>
									...
									<td align="left" style="padding-left:150px;">
										<div style="border:1px solid #000; padding: 10px;">
											<b>PO. No: {{$details->voucher_no}}</b><br/>
											Date:  {{date('d-m-Y',strtotime($details->voucher_date))}}<br/>
							...
							<tbody>
								<tr style="border:1px solid black;">
									<td colspan="2" align="center" valign="top" style="height:390px;">
                    ...
                    <div class="btn-section">
						...
						<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('purchase_order/export_po') }}">
