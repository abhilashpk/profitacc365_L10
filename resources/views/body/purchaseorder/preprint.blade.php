								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										<td colspan="2" align="center">
											...
											<body>
											<?php $total_net = $net_amount = $total_vat = $total_gross =$amount=$net_amt=$disc= 0;?>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										<td colspan="2" align="center">
											...
											<body>
											<?php 		
												$total_net = $net_amount = $total_vat = $total_gross=$amount=$net_amt=$disc = 0;?>
												@foreach($reports as $row)
											<?php 
									...
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												...
												<td><b>PO Date</b> {{date('d-m-Y', strtotime($report[0]->voucher_date))}}</td>
