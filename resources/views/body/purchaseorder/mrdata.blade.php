                    ...
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-columns"></i> Material Requisition List
                            </h3>
                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Material Requisition</h4>
                                        </div>
...
function setTransfer() {
	...
	if(curl=='MRI')
		sdourl = "{{ url('purchase_invoice/add/') }}/"+items+"/MR";
	else if(curl=='MRO')
		sdourl = "{{ url('purchase_order/add/') }}/"+items+"/MR";
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "{{ url('material_requisition/item_details/') }}";
