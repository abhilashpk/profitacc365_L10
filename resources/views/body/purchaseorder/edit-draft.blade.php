                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('purchase_order/update/'.$orderrow->id) }}">
                                ...
                                <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary" <?php if($orderrow->is_editable==1) echo 'disabled';?>>Update</button>
                                        <button type="button" value="button" name="btn" onclick="updateDraft()"class="btn btn-success">Update Draft</button>
...
function updateDraft() {
    ...
    document.frmPurorder.action="{{ url('purchase_order/update_draft/'.$orderrow->id) }}";
     document.frmPurorder.submit();
}
