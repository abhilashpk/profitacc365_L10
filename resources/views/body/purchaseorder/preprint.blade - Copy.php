        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										<tr>
											...
											<td width="10%"><b>PO.No</b></td>
											<td width="10%"><b>PO.Date</b></td>
											<td width="20%"><b>Item Description</b></td>
											<td width="10%"><b>Jobno</b></td>
											<td width="10%" class="text-right"><b>Gross Amt.</b></td>
					...
					<input type="hidden" name="search_type" value="{{$curid}}" >
					</form>
