                    ...
                    <div class="panel panel-<?php echo ($orderrow->approval_status==1)?'warning':'primary';?>">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> <?php if($orderrow->approval_status==1) { echo 'Approved'; } else echo 'Purchase Order';?>
                            </h3>
...
function funApproval(id) {
	var con = confirm('Are you sure you want to approve this order?');
	if(con==true) {
		var url = "{{ url('purchase_order/approve/') }}";
