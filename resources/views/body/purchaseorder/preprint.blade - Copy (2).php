        ...
        <section class="content p-l-r-15" id="cost-job">
            <div class="panel">
                ...
                <div class="panel-body">
                        ...
                        <div class="col-md-12">
							<?php if($type=="detail") { ?>
								<table class="table" border="1">
									...
									<tr>
										<td><b>SI.No:</b> {{ ++$i }}</td>
										<td><b>PO#:</b> {{$report[0]->voucher_no}}</td>
										<td><b>PO Ref.#:</b> {{$report[0]->reference_no}}</td>
										<td colspan="4" class="text-right"><b>Supplier Name:</b> {{$report[0]->master_name}}</td>
									</tr>
									<tr>
										<td><b>Item Code</b></td>
							...
							<?php } elseif($type=="detail_pending") { ?>
								<table class="table" border="0">
									...
									<tr>
										...
										<td colspan="2"><b>PO#:</b> {{$report[0]->voucher_no}}</td>
										<td colspan="2"><b>PO Ref.#:</b> {{$report[0]->reference_no}}</td>
										<td colspan="4" class="text-right"><b>Supplier Name:</b> {{$report[0]->master_name}}</td>
									</tr>
									<tr>
										<td><b>Item Code</b></td>
							...
							<table class="table" border="0">
								...
								<body>
								<?php 		
									$total_net = $net_amount = $total_vat = $total_gross = 0;?>
							...
							<table class="table" border="0">
								...
								<body>
								<?php $total_net = $net_amount = $total_vat = $total_gross = 0;?>
									@foreach($reports as $row)
									<?php 
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('purchase_order/export') }}">
