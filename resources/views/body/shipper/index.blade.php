                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>Shipper List
                        </h3>
                        <div class="pull-right">
                            <a href="{{ url('shipper/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="tableShipper">
                                <thead>
                                    <tr>
                                        <th>Shipper Name</th>
                                        <th>Phone Number</th>
                                            ...
                                            <td>
                                                <p>
                                                    <button class="btn btn-primary btn-xs"
                                                        onClick="location.href='{{ url('shipper/edit/' . $row->id) }}'">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title custom_align" id="Heading5">Delete Shipper</h4>
                    </div>
...
<script type="text/javascript" src="{{asset('assets/vendors/datatables/js/dataTables.scroller.js')}}"></script>
	...
	var dtInstance = $("#tableShipper").DataTable({
        ...
        function funDelete(id) {
            var con = confirm('Are you sure delete this Shipper?');
            if (con == true) {
                var url = "{{ url('shipper/delete/') }}";
