                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Edit Shipper
                        </h3>

                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" name="frmShipper" id="frmShipper"
                            action="{{ url('shipper/update/' . $sedit->id) }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="shipper_id" value="<?php echo $sedit->id; ?>">

                            <div class="form-group">
                                <label for="input-text" class="col-sm-2 control-label">Shipper Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Name" value="{{ $sedit->shipper_name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="address" id="address" class="form-control " placeholder="Address">{{ $sedit->address }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" id="phone" name="phone"
                                        placeholder="Phone no:" value="{{ $sedit->phone }}">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            $('#frmShipper').bootstrapValidator({
                fields: {
                    ...
                    name: {
                        validators: {
                            notEmpty: {
                                message: 'The shipper name is required and cannot be empty!'
                            },
                         remote: {
                            url: urlname,
                            ...
                            return {
                                ...
                                id: validator.getFieldElements('shipper_id').val(),
                            };
                        },
