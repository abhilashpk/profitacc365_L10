                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Settlement Contract 
                            </h3>
                        </div>
						...
						<div class="panel-body">
							...
							<div class="bs-example">
                                <ul class="nav nav-tabs" style="margin-bottom: 15px;">
									...
									<li {{(Session::get('active')=="settle") ? "class=active" : ""}}>
                                        <a href="#settle" data-toggle="tab">Settlement</a>
                                    </li>
                                </ul>
									...
									<div class="tab-pane fade {{(Session::get('active')=='home') ? ' active in' : '' }}" id="home">
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_1" name="acname[]" value="{{($acrow[0])?$acrow[0]->acname:''}}" readonly>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_2" name="acname[]" value="{{($acrow[1])?$acrow[1]->acname:''}}" readonly>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_3" name="acname[]" value="{{($acrow[2])?$acrow[2]->acname:''}}" readonly>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_4" name="acname[]" value="{{($acrow[3])?$acrow[3]->acname:''}}" readonly>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_5" name="acname[]" value="{{($acrow[4])?$acrow[4]->acname:''}}" readonly>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_6" name="acname[]" value="{{($acrow[5])?$acrow[5]->acname:''}}" readonly>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_7" name="acname[]" value="{{($acrow[6])?$acrow[6]->acname:''}}" readonly>
									...
									<div class="tab-pane fade {{(Session::get('active')=='deposit') ? ' active in' : '' }}" id="deposit">
										...
										<fieldset>
											...
											<div class="col-xs-15">
												...
												<div class="col-xs-2" style="width:10%;">
													<span class="small">Amount</span> <input type="number" id="damount_1" value="{{(isset($payacnts[1])?$payacnts[1]->amount:'')}}" placeholder="Amount" readonly autocomplete="off" step="any" name="amount[]" class="form-control">
												</div>
...
" >
									...
									<div class="tab-pane fade {{(Session::get('active')=='settle') ? ' active in' : '' }}" id="settle">
										<form class="form-horizontal" role="form" method="POST" name="frmSettlement" action="{{url('contractbuilding/save_settlement')}}">
										<input type="hidden" name="con_id" value="{{$crow->id}}">
										<input type="hidden" name="settle_id" value="{{($settle)?$settle->id:''}}">
										<input type="hidden" name="_token" value="{{ csrf_token() }}">
										<br/>
										...
										<div class="form-group">
											<label for="input-text" class="col-sm-2 control-label">Contract No.</label>
											<div class="col-sm-2">
												<input type="text" class="form-control" name="con_no" id="con_no" readonly value="{{$crow->contract_no}}">
											</div>
											<label for="input-text" class="col-sm-1 control-label">Flat No.</label>
											<div class="col-sm-2" style="width:12%;">
												<input type="text" class="form-control" id="flat_no" name="flat_no" readonly placeholder="{{$crow->flat}}">
											</div>
											
											<label for="input-text" class="col-sm-1 control-label">Tenant</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" name="tenant" readonly value="{{($crow)?$crow->master_name:''}}">
												<input type="hidden" name="tenant_id" readonly value="{{($crow)?$crow->customer_id:''}}">
												<input type="hidden" name="inc_acid" id="inc_acid" value="{{($incmac)?$incmac->rental_income:''}}">
												<input type="hidden" name="inc_acnam" value="{{($incmac)?$incmac->acname14:''}}">
												<input type="hidden" name="ra_amount" value="{{($crow)?$crow->rent_amount:''}}">
												<input type="hidden" name="deposit_id" value="{{($acrow[1])?$acrow[1]->account_id:''}}">
												<input type="hidden" name="deposit_nam" value="{{($acrow[1])?$acrow[1]->acname:''}}">
												<input type="hidden" name="waterele_id" value="{{($acrow[2])?$acrow[2]->account_id:''}}">
												<input type="hidden" name="waterele_nam" value="{{($acrow[2])?$acrow[2]->acname:''}}">
												<input type="hidden" name="waterele_amt" value="{{($acrow[2])?$acrow[2]->amount:''}}">
												<input type="hidden" name="commsn_id" value="{{($acrow[3])?$acrow[3]->account_id:''}}">
												<input type="hidden" name="commsn_nam" value="{{($acrow[3])?$acrow[3]->acname:''}}">
												<input type="hidden" name="commsn_amt" value="{{($acrow[3])?$acrow[3]->amount:''}}">
												<input type="hidden" name="othdepo_id" value="{{($acrow[4])?$acrow[4]->account_id:''}}">
												<input type="hidden" name="othdepo_nam" value="{{($acrow[4])?$acrow[4]->acname:''}}">
												<input type="hidden" name="othdepo_amt" value="{{($acrow[4])?$acrow[4]->amount:''}}">
												<input type="hidden" name="parking_id" value="{{($acrow[5])?$acrow[5]->account_id:''}}">
												<input type="hidden" name="parking_nam" value="{{($acrow[5])?$acrow[5]->acname:''}}">
												<input type="hidden" name="parking_amt" value="{{($acrow[5])?$acrow[5]->amount:''}}">
											</div>	
										</div>
										<hr/>
										
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Settlement Date</label>
												<div class="col-sm-2">
													<input type="text" class="form-control pull-right" name="settlement_date" id="settlement_date" value="{{($settle)?date('d-m-Y', strtotime($settle->settle_date)):date('d-m-Y')}}" autocomplete="off" data-language='en' readonly >
												</div>
												
												<label for="input-text" class="col-sm-2 control-label">Vacating Date</label>
												<div class="col-sm-2">
													<input type="text" readonly  class="form-control" id="vacating_date" name="vacating_date" autocomplete="off" data-language='en' value="{{($settle)?date('d-m-Y', strtotime($settle->vacate_date)):date('d-m-Y')}}" readonly>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													@if(!$settle)<button type="submit" class="btn btn-primary">Settle & Close</button>@endif
...
$('#vacating_date').datepicker( { autoClose: true,dateFormat: 'dd-mm-yyyy' } );
$('#settlement_date').datepicker( { autoClose: true,dateFormat: 'dd-mm-yyyy' } );
$('#jv_date').datepicker( { autoClose: true,dateFormat: 'dd-mm-yyyy' } );
...
$(document).on('keyup', '.feeAmt', function(e) {
	grandTotalSettle();
});
...
function grandTotalSettle() {
	let amount=0; let total=0; 
	$( '.feeAmt' ).each(function() {
	...
	$('#totalChrg').val(total.toFixed(2));
	var payable = ($('#payable').val()=='')?0:parseFloat($('#payable').val());
	var depoAmt  = ($('#dep_amount').val()=='')?0:parseFloat($('#dep_amount').val());
	var pdcAmt = parseFloat( ($('#pdc_amount').val()=='')?0:$('#pdc_amount').val());
	var netPayable = payable + depoAmt - total;
	$('#refundAmount').val(netPayable.toFixed(2));
	$('#recAmount').val( (pdcAmt - netPayable).toFixed(2) );
	$('#jvamount').val((pdcAmt - netPayable).toFixed(2));
}
...
$(document).on('click', '.btn-calcu', function(e) {
	
	let sdate = $('#start_date').val();
	let edate = '{{date('d-m-Y', strtotime($crow->end_date))}}';
	let vdate = $('#vacating_date').val();
	let amt = $('#total_rent').val();
	let dur = parseFloat({{$crow->duration}});
	$.ajax({
		url: "{{ url('contractbuilding/rent_calculate/') }}",
		type: 'get',
		data: 'sdate='+sdate+'&amount='+amt+'&vdate='+vdate+'&edate='+edate+'&duration='+dur,
		success: function(data) { console.log(data);
			data = $.parseJSON(data);
			$('#actual_rent').val(data.amount.toFixed(2));
			var payable = parseFloat($('#total_rent').val()) - ($('#actual_rent').val());
			$('#payable').val(payable.toFixed(2));
			$('#stay_days').val(data.nod);
			//$('#res_allocate').html(data);
			//return true;
		}
	});
	...
	//..........
	/* let duration = parseFloat({{$crow->duration}});
	let end_date = '{{date('d-m-Y', strtotime($crow->end_date))}}';
	let isday = {{$crow->is_day}};
	if(isday==0) 
		duration = duration * 30;
	let arr = $('#start_date').val().split('-'); 
	let startDate = new Date(arr[1]+'-'+arr[0]+'-'+arr[2]);
	let arr2 = $('#vacating_date').val().split('-'); 
	let endDate = new Date(arr2[1]+'-'+arr2[0]+'-'+arr2[2]);
	const diffTime = Math.abs(endDate - startDate);
	const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24)); 
	$('#stay_days').val(diffDays+1);
	if($('#vacating_date').val()==end_date) {
		let perDayRent = parseFloat($('#total_rent').val()) / duration;
		$('#actual_rent').val($('#total_rent').val());
		var payable = parseFloat($('#total_rent').val()) - ($('#actual_rent').val());
		$('#payable').val(payable.toFixed(2));
	} else {

		let perDayRent = parseFloat($('#total_rent').val()) / duration;
		$('#actual_rent').val((perDayRent*(diffDays+1)).toFixed(2));
		var payable = parseFloat($('#total_rent').val()) - (perDayRent*(diffDays+1));
		$('#payable').val(payable.toFixed(2));
	} */
	grandTotalSettle();
})
...
$(document).on('click', '.accountRow', function(e) {
	...
	$('#settle #acid_'+num).val( $(this).attr("data-id") );
	$('#settle #acname_'+num).val( $(this).attr("data-name") );
});
</script>
@stop
