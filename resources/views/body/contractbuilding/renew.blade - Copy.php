                                ...
                                <div id="myTabContent" class="tab-content">
									<div class="tab-pane fade active in" id="home">
										...
										<div class="form-group">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Deposit <input type="checkbox"  name="check[{{($acrow[1])?$acrow[1]->account_id:''}}]" value="1"></label> 
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Security Deposit <input type="checkbox"  name="check[{{($acrow[2])?$acrow[2]->account_id:''}}]" value="1"></label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Commission <input type="checkbox"  name="check[{{($acrow[3])?$acrow[3]->account_id:''}}]" value="1"></label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Other Deposit A/c. <input type="checkbox"  name="check[{{($acrow[4])?$acrow[4]->account_id:''}}]" value="1"></label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Parking Income A/c. <input type="checkbox"  name="check[{{($acrow[5])?$acrow[5]->account_id:''}}]" value="1"></label>
												<div class="col-sm-5" >
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Ejarie Fee A/c. <input type="checkbox"  name="check[{{($acrow[6])?$acrow[6]->account_id:''}}]" value="1"></label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="number" class="form-control" id="gtotal_rw" step="any" name="grand_total_rw" value="{{($crow)?$crow->grand_total:''}}" readonly placeholder="Grand Total">
