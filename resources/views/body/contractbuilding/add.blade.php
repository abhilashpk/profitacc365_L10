									...
									<div class="tab-pane fade active in" id="home">
										<form class="form-horizontal" role="form" method="POST" name="frmContract" id="frmContract" action="{{url('contractbuilding/save')}}">
											...
											<div class="form-group">
												...
												<input type="hidden" id="increment_no" name="increment_no">
												<div class="col-sm-4">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select class="form-control select2" name="flat_no" id="flat_id" />
													@if($crow)
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="number" class="form-control" id="rent_total" step="any" name="rent_total" autocomplete="off" placeholder="Total Rent">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="number" class="form-control" id="rent_amount" readonly step="any" name="rent_amount" autocomplete="off" placeholder="Rent Amount">
											</div>
										</div>
										@else
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control preincome" id="acname_1" name="acname[]" value="{{$acrow[0]->acname ?? ''}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_1" name="acid[]" value="{{$acrow[0]->account_id ?? ''}}">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" id="acamt_1" step="any" name="acamount[]" value="{{$acrow[0]->amount ?? ''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" id="actax_1" step="any" name="actax[]" value="{{$acrow[0]->tax_amount ?? ''}}" placeholder="Tax">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_2" name="acname[]" value="{{$acrow[1]->acname ?? ''}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_2" name="acid[]" value="{{$acrow[1]->account_id ?? ''}}">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_2" name="acamount[]" value="{{$acrow[1]->amount ?? ''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" step="any" id="actax_2" name="actax[]" value="{{$acrow[1]->tax_amount ?? ''}}" placeholder="Tax">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_3" name="acname[]" value="{{$acrow[2]->acname ?? ''}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_3" name="acid[]" value="{{$acrow[2]->account_id ?? ''}}">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_3" name="acamount[]" value="{{$acrow[2]->amount ?? ''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" step="any" id="actax_3" name="actax[]" value="{{$acrow[2]->tax_amount ?? ''}}" placeholder="Tax">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_4" name="acname[]" value="{{$acrow[3]->acname ?? ''}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_4" name="acid[]" value="{{$acrow[3]->account_id ?? ''}}">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_4" name="acamount[]" value="{{$acrow[3]->amount ?? ''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" step="any" id="actax_4" name="actax[]" value="{{$acrow[3]->tax_amount ?? ''}}" placeholder="Tax">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_5" name="acname[]" value="{{$acrow[4]->acname ?? ''}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_5" name="acid[]" value="{{$acrow[4]->account_id ?? ''}}">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_5" name="acamount[]" value="{{$acrow[4]->amount ?? ''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" step="any" id="actax_5" name="actax[]" value="{{$acrow[4]->tax_amount ?? ''}}" placeholder="Tax">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_6" name="acname[]" value="{{$acrow[5]->acname ?? ''}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_6" name="acid[]" value="{{$acrow[5]->account_id ?? ''}}">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_6" name="acamount[]" value="{{$acrow[5]->amount ?? ''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" step="any" id="actax_6" name="actax[]" value="{{$acrow[5]->tax_amount ?? ''}}" placeholder="Tax">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_7" name="acname[]" value="{{$acrow[6]->acname ?? ''}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_7" name="acid[]" value="{{$acrow[6]->account_id ?? ''}}">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_7" name="acamount[]" value="{{$acrow[6]->amount ?? ''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" step="any" id="actax_7" name="actax[]" value="{{$acrow[6]->tax_amount ?? ''}}" placeholder="Tax">
	...
	var urltype = "{{ url('contra_type/check_type/') }}";
     $('#frmContract').bootstrapValidator({
         fields: {
			 ...
			 flat_no: {              // 👈 use name="flat_no" here
                selector: '#flat_id', // 👈 optional but good to be explicit
                validators: {
                    notEmpty: {
...
$(document).on('change', '#building_id', function(e) {
	...
	$.get("{{ url('contra_type/get_details/') }}/" + bid, function(data) {
		...
		if(det.prefix=='') {
			...
			$('#increment_no').val(det.type+det.increment_no);
		} else {
			$('#contract_no').val(det.prefix+det.increment_no);
			$('#increment_no').val(det.prefix+det.increment_no);
		}
	...
	$.get("{{ url('contra_type/get_flat/') }}/" + bid, function(data) {
		...
		let $flat = $('#flat_id');
		$flat.empty(); // remove all old options

		// 🔹 Add NULL / default option
...
$(document).on('click', '.datepicker--cell-day', function(e) {
	...
	if ($('#chkedit').is(':checked')) {
		...
		var arr = vdate.split('-'); 
		var someDate = new Date(arr[1]+'-'+arr[0]+'-'+arr[2]);
		var numberOfDaysToAdd = parseInt(dur)-1; 
		someDate.setDate(someDate.getDate() + numberOfDaysToAdd); 
		var dd = someDate.getDate();
		var mm = someDate.getMonth() + 1;
		var y = someDate.getFullYear();
		...
		var dur = $('#duration option:selected').val();//console.log('der '+dur)
		if (typeof dur != 'undefined') {
			$.get("{{ url('contractbuilding/get_enddate/') }}/"+sdate+"/"+dur, function(data) {
