                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Renew Contract 
                            </h3>
							...
							<div class="bs-example">
                                ...
                                <div id="myTabContent" class="tab-content">
									<div class="tab-pane fade active in" id="home">
										<form class="form-horizontal" role="form" method="POST" name="frmContract" id="frmContract" action="{{url('contractbuilding/renew_save')}}">
											<input type="hidden" name="_token" value="{{ csrf_token() }}">
											<input type="hidden" name="conid" value="{{$crow->id}}">
											<br/>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" name="contract_no" id="contract_no" value="{{$incmac->type.$incmac->increment_no}}" readonly >
												</div>
												
												<label for="input-text" class="col-sm-2 control-label">SI. No.</label>
												<div class="col-sm-4">
													<input type="text" class="form-control" name="si_no" readonly value="{{$sirow->voucher_no}}">
												</div>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control pull-right" value="{{($crow)?date('d-m-Y',strtotime('+ 1 days',strtotime($crow->end_date))):''}}" name="start_date" autocomplete="off" data-language='en' readonly id="start_date" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-3" id="durM">
												...
												<option value="{{$dur->duration_month}}">{{$dur->duration_month}} Months</option>
												@endforeach
												</select>
											</div>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="hidden"  name="check[{{($acrow[0])?$acrow[0]->account_id:''}}]" value="1">
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Deposit <input type="checkbox" id="chk_2" name="check[{{($acrow[1])?$acrow[1]->account_id:''}}]" value="2" onClick='check_uncheck_checkbox(this.checked);'></label> 
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Security Deposit <input type="checkbox" id="chk_3" name="check[{{($acrow[2])?$acrow[2]->account_id:''}}]" value="3" onClick='check_uncheck_checkbox(this.checked);'></label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Commission <input type="checkbox" id="chk_4" name="check[{{($acrow[3])?$acrow[3]->account_id:''}}]" value="4" onClick='check_uncheck_checkbox(this.checked);'></label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Other Deposit A/c. <input type="checkbox" id="chk_5" name="check[{{($acrow[4])?$acrow[4]->account_id:''}}]" value="5" onClick='check_uncheck_checkbox(this.checked);'></label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Parking Income A/c. <input type="checkbox" id="chk_6" name="check[{{($acrow[5])?$acrow[5]->account_id:''}}]" value="6" onClick='check_uncheck_checkbox(this.checked);'></label>
												<div class="col-sm-5" >
													<input type="text" class="form-control preincome" id="acname_6" name="acname[]" value="{{($acrow[5])?$acrow[5]->acname:''}}" data-toggle="modal" data-target="#ac_modal" readonly>
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Ejarie Fee A/c. <input type="checkbox" id="chk_7" name="check[{{($acrow[6])?$acrow[6]->account_id:''}}]" value="7" onClick='check_uncheck_checkbox(this.checked);'></label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="number" class="form-control" id="total" step="any" name="total" value="{{$contotal}}"  readonly placeholder="Total">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="number" class="form-control" id="gtotal" step="any" name="grand_total" value="{{($txtotal+$contotal)}}" readonly placeholder="Grand Total">
												</div>
											</div>
									...
									<div class="tab-pane fade" id="receipt">
										...
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input type="number" class="form-control" id="installment" step="any" name="installment">
											</div>
									...
									<div class="tab-pane fade" id="deposit">
										...
										<div class="form-group">
											<label for="input-text" class="col-sm-1 control-label">RV No.</label>
											<div class="col-sm-1">
												<input type="text" class="form-control" name="rv_no" id="drv_no" readonly value="{{$rvrow->voucher_no}}">
											</div>
											<label for="input-text" class="col-sm-1 control-label">RV Date</label>
											<div class="col-sm-2" style="width:12%;">
												<input type="text" class="form-control" id="drv_date" name="rv_date" placeholder="{{date('d-m-Y')}}">
											</div>
											<label for="input-text" class="col-sm-1 control-label">Amount</label>
											<div class="col-sm-2" style="width:12%;">
												<input type="number" class="form-control" step="any" id="drv_amount" name="rv_amount" placeholder="Amount">
											</div>
											<label for="input-text" class="col-sm-1 control-label">Tenant(Cr)</label>
											<div class="col-sm-4">
									...
									<div class="tab-pane fade" id="otherrv">
										...
										<div class="form-group">
											...
											<label for="input-text" class="col-sm-1 control-label">RV Date</label>
											<div class="col-sm-2" style="width:12%;">
												<input type="text" class="form-control" id="orv_date" name="rv_date" value="{{date('d-m-Y')}}">
											</div>
											<label for="input-text" class="col-sm-1 control-label">Amount</label>
											<div class="col-sm-2" style="width:12%;">
												<input type="number" class="form-control" step="any" id="orv_amount" name="rv_amount" placeholder="Amount">
											</div>
											<label for="input-text" class="col-sm-1 control-label">Tenant(Cr)</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" name="tenant" readonly value="{{($crow)?$crow->master_name:''}}">
...
function grandTotal() {
	let total=parseFloat($('#acamt_1').val()); let txtotal=parseFloat($('#actax_1').val()); let amount=txtotal+total;
	
	$('input:checkbox').each(function() { 
		if($(this).is(':checked')) {
			//chkTotal += parseFloat($('#acamt_'+this.value).val());
			//chkTxtotal += parseFloat($('#actax_'+this.value).val());
		   var no = this.value;
		   let tax = ($('#actax_'+no).val()=='')?0:parseFloat($('#actax_'+no).val());
		   let amt = ($('#acamt_'+no).val()=='')?0:parseFloat($('#acamt_'+no).val());
		   total = total + amt;
		   txtotal = txtotal + tax;
...
$(document).on('click', '.accountRow', function(e) {
	...
	$('#chk_'+num).attr('name', 'check['+$(this).attr("data-id")+']');
});
