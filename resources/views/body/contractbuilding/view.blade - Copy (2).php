							...
							<div class="bs-example">
                                ...
                                <div id="myTabContent" class="tab-content">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<button type="submit" class="btn btn-primary">Submit</button>
													 ...
													 <a href="{{ url('contractbuilding/printsi/'.(($crow)?$crow->id:'')) }}" target="_blank" class="btn btn-info">Print Invoice</a>
												</div>
											</div>
											@endif
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label"></label>
												<div class="col-sm-10">
													<a href="{{ url('contractbuilding/printcontr/'.(($crow)?$crow->id:'')) }}" target="_blank" class="btn btn-info">Print Contract</a>
													<a href="{{ url('contractbuilding/printinvo/'.(($crow)?$crow->id:'')) }}" target="_blank" class="btn btn-info">Print Invoice</a> 
												</div>
											</div>
										...
										<fieldset>
											...
											<div class="col-xs-15">
												...
												<div class="col-xs-1" style="width:7%;">
													<span class="small">P.Mode</span> 
													<select id="dtrtype_1" class="form-control dtrtype" style="width:100%" name="tr_type[]">
														<option value="C" {{($drow->cheque_no=='')?'selected':''}}>C</option>
														<option value="B" {{($drow->cheque_no!='')?'selected':''}}>B</option>
														<option value="P" {{($drow->cheque_no!='')?'selected':''}}>P</option>
													</select>
												</div>
												<div class="col-xs-2" style="width:10%;">
												...
												<div class="col-xs-3" style="width:10%;">
													<span class="small">Cheque Date</span> <input type="text" autocomplete="off" id="dchkdate_1" name="cheque_date[]" value="{{date('d-m-Y',strtotime($drow->cheque_date))}}" class="form-control chqdate" data-language='en'>
												</div>
									...
									<div class="tab-pane fade {{(Session::get('active')=='payment') ? ' active in' : '' }}" id="payment">
										<div class="controls"> 
										<form class="form-horizontal" role="form" method="POST" name="frmDeposit" action="{{url('contractbuilding/save_payment')}}">
										<input type="hidden" name="_token" value="{{ csrf_token() }}">
										<input type="hidden" name="con_id" id="conid" value="{{($crow)?$crow->id:''}}">
										<input type="hidden" name="cash_ac" id="cash_ac" value="{{($rvrow)?$rvrow->cash:''}}">
										<input type="hidden" name="cash_acid" id="cash_acid" value="{{($rvrow)?$rvrow->cashid:''}}">
