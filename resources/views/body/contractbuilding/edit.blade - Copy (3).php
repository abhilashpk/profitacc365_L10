									...
									<div class="tab-pane fade {{(Session::get('active')=='deposit') ? ' active in' : '' }}" id="deposit">
										...
										<fieldset>
											...
											<div class="col-xs-15">
												...
												<div class="col-xs-3" style="width:10%;">
													<span class="small">Cheque Date</span> <input type="text" autocomplete="off" value="{{date('d-m-Y',strtotime($drow->cheque_date))}}" id="dchkdate_1" name="cheque_date[]" class="form-control chqdate" data-language='en'>
												</div>
									...
									<div class="tab-pane fade {{(Session::get('active')=='otherrv') ? ' active in' : '' }}" id="otherrv">
										...
										<div class="form-group">
											...
											<div class="col-sm-3" style="width:12%;">
												<input type="text" class="form-control" name="orv_date" id="orv_date" value="{{($orvs)?$orvs[0]->voucher_date:date('d-m-Y')}}" autocomplete="off" data-language='en' readonly />
											</div>
