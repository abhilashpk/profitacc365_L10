									...
									<div class="tab-pane fade {{(Session::get('active')=='home') ? ' active in' : '' }}" id="home">
										...
										<div class="form-group">
											...
											<div class="col-sm-3" id="durM">
												...
												<option value="181" {{($crow)?(($crow->duration==181)?'selected':''):''}}>6 Months</option>
												<option value="364" {{($crow)?(($crow->duration==364)?'selected':''):''}}>12 Months</option>
												<option value="729" {{($crow)?(($crow->duration==729)?'selected':''):''}}>24 Months</option>
												<option value="1094" {{($crow)?(($crow->duration==1094)?'selected':''):''}}>36 Months</option>
												<option value="1459" {{($crow)?(($crow->duration==1459)?'selected':''):''}}>48 Months</option>
												<option value="1824" {{($crow)?(($crow->duration==1824)?'selected':''):''}}>60 Months</option>
												</select>
											</div>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_2" name="acamount[]" value="{{($acrow)?(isset($acamt[$acrow->deposit]['amount'])?$acamt[$acrow->deposit]:''):''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_3" name="acamount[]" value="{{($acrow)?(isset($acamt[$acrow->other_deposit])?$acamt[$acrow->other_deposit]['amount']:''):''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" step="any" id="actax_3" name="actax[]" value="{{($acrow)?(isset($acamt[$acrow->other_deposit])?$acamt[$acrow->other_deposit]['tax']:''):''}}" placeholder="Tax">
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="number" class="form-control txtAmt" step="any" id="acamt_5" name="acamount[]" value="{{($acrow)?(isset($acamt[$acrow->commission])?$acamt[$acrow->commission]['amount']:''):''}}" placeholder="Amount">
												</div>
												<div class="col-sm-2">
													<input type="number" class="form-control txtPer" step="any" id="actax_5" name="actax[]" value="{{($acrow)?(isset($acamt[$acrow->commission])?$acamt[$acrow->commission]['tax']:''):''}}" placeholder="Tax">
										...
										<fieldset>
											...
											<div class="itemdivPrntDr">
											  <div class="itemdivChldDr">
												<div class="col-xs-15">
													<div class="col-xs-3" style="width:15%;">
														<span class="small">Debit A/c.</span> <input type="text" id="rvOdracname_1" value="{{($rvrow)?$rvrow->cash:''}}" autocomplete="off" name="drac_name[]" class="form-control">
													...
													<div class="col-xs-3" style="width:15%;">
														<span class="small">Description</span> 
														<input type="text" id="ddesc_1" name="Ddescription[]" value="{{($crow)?('Deposit/'.$crow->contract_no.'/'.$crow->master_name):''}}" autocomplete="off" class="form-control">
													</div>
													...
													<div class="col-xs-2" style="width:10%;">
														<span class="small">Amount</span> <input type="number" id="drdamount_1" placeholder="Amount" autocomplete="off" step="any" name="Damount[]" class="form-control">
													</div>

													<div class="col-sm-2" style="width:10%;"> 
														<span class="small">Cheque No</span><input type="text" autocomplete="off" id="dchkno_1" name="Dcheque_no[]" class="form-control" >
													</div>

													<div class="col-xs-3" style="width:10%;">
														<span class="small">Cheque Date</span> <input type="text" autocomplete="off" id="dchkdate_1" name="Dcheque_date[]" class="form-control chqdate" data-language='en'>
													</div>
													...
													<!--<div class="col-xs-1 abc" style="width:3%;"><br/>
														<button type="button" class="btn-danger btn-remove-item-dr" >
															<i class="fa fa-fw fa-minus-square"></i>
														 </button>
														 <button type="button" class="btn-success btn-add-item-dr" >
													...
													<div class="itemdivPrnt">
														<div class="itemdivChld">							
															<div class="form-group" style="margin-bottom: 1px;">
																...
																<input type="text" id="craccount_1" name="account_name[]" class="form-control acname" value="{{($crow)?$crow->master_name:''}}" autocomplete="off" data-toggle="modal" data-target="#account_modal">
																...
																<div class="col-xs-15 divchq">
																	<div class="col-xs-2" style="width:25%;">
																		<span class="small">Description/Reference</span> <input type="text" id="crdescr_1" autocomplete="off" name="description[]" class="form-control desc-bill" data-toggle="modal" data-target="#reference_modal">
																	</div>
																	<div class="col-xs-2" style="width:25%;">
																		<span class="small">Contract No</span> 
																		<div id="refdata_1" class="refdata">
																		<input type="text" id="crref_1" name="reference[]" value="{{($crow)?$crow->contract_no:''}}" autocomplete="off" class="form-control">
																		</div>
																	...
																	<div class="col-xs-2" style="width:20%;">
																		<span class="small">Amount</span> <input type="number" id="ramount_1" autocomplete="off" step="any" name="line_amount[]" class="form-control">
																	</div>
																</div>	
															</div>
