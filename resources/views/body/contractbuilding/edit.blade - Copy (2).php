                                ...
                                <div id="myTabContent" class="tab-content">
									...
									<div class="tab-pane fade {{(Session::get('active')=='otherrv') ? ' active in' : '' }}" id="otherrv">
										...
										<div class="form-group">
											...
											<label for="input-text" class="col-sm-1 control-label">Amount</label>
											<div class="col-sm-2" style="width:12%;">
												<input type="number" class="form-control" step="any" id="orv_amount" name="rv_amount" value="{{($orvs)?$orvs[0]->amount:$oramt}}" placeholder="Amount">
											</div>
											<label for="input-text" class="col-sm-1 control-label">Tenant(Cr)</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" name="tenant" readonly value="{{($crow)?$crow->master_name:''}}">
										...
										<br/>
										<h5 class="ORVD"><a href="">View Details</a></h5>
											...
											<table class="table table-bordered table-hover">
												...
												@foreach($payacnts as $k => $row)
													...
													<tr>
														...
														<td>{{number_format($row->amount,2)}}<input type="hidden" name="line_amount[]" value="{{round($row->amount,2)}}"></td>
													</tr>
													@endif
												@endforeach
												@foreach($payacnts as $k => $row)
													...
													<tr>
														...
														<td>{{number_format($row->tax_amount,2)}}<input type="hidden" name="line_amount[]" value="{{round($row->amount,2)}}"></td>
													</tr>
													@endif
												@endforeach
											...
											@if($orow->entry_type=='Dr')
												...
												@else
													<div class="itemdivPrnt">
														<div class="itemdivChld">							
															<div class="form-group" style="margin-bottom: 1px;">
																<div class="col-sm-2" style="width:16%;"> <span class="small">Account Name</span>
