							...
							<div class="bs-example">
                                ...
                                <div id="myTabContent" class="tab-content">
									<div class="tab-pane fade {{(Session::get('active')=='home') ? ' active in' : '' }}" id="home">
										<form class="form-horizontal" role="form" method="POST" name="frmContract" id="frmContract" action="{{url('contractbuilding/update_renew/'.$crow->id)}}">
										...
										<div class="form-group">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Deposit @if($crow && $crow->renew_id!='')<input type="checkbox" id="chk_2" {{ (isset($payacnts[1]) && $payacnts[1]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[1])?$acrow[1]->account_id:''}}]" value="2" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Security Deposit @if($crow && $crow->renew_id!='')<input type="checkbox" id="chk_3" {{ (isset($payacnts[2]) && $payacnts[2]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[2])?$acrow[2]->account_id:''}}]" value="3" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Commission @if($crow && $crow->renew_id!='')<input type="checkbox" id="chk_4" {{ (isset($payacnts[3]) && $payacnts[3]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[3])?$acrow[3]->account_id:''}}]" value="4" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Other Deposit A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" id="chk_5" {{ (isset($payacnts[4]) && $payacnts[4]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[4])?$acrow[4]->account_id:''}}]" value="5" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Parking Income A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" id="chk_6" {{ (isset($payacnts[5]) && $payacnts[5]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[5])?$acrow[5]->account_id:''}}]" value="6" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Ejarie Fee A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" id="chk_7" {{ (isset($payacnts[6]) && $payacnts[6]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[6])?$acrow[6]->account_id:''}}]" value="7" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
										...
										<fieldset>
											...
											<div class="col-xs-15" id="receipt_add">
												...
												<div class="col-xs-3" style="width:15%;">
													<span class="small">Debit A/c.1</span> <input type="text" id="dracname_{{$i}}" value="{{$row->master_name}}" autocomplete="off" name="drac_name[]" class="form-control" data-toggle="modal" data-target="#accounts_modal">
											...
											<fieldset>
												...
												@foreach($orvs as $orow)
												  ...
												  <div class="itemdivChldDr">
													<div class="col-xs-15">
														<div class="col-xs-3" style="width:15%;">
															<span class="small">Debit A/c.</span> <input type="text" id="rvOdracname_{{$i}}" value="{{($rvrow)?$rvrow->cash:$orow->master_name}}" autocomplete="off" name="drac_name[]" class="form-control" data-toggle="modal" data-target="#accounts_modal">
...
var acurl = "{{ url('account_master/get_debitaccounts/') }}";
...
//new change.................
$(document).on('click', '.accountRowdebit', function(e) { 
	var num = $('#num').val(); var vatasgn = $(this).attr("data-vatassign");
