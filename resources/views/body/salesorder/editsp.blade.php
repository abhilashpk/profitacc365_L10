    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="#">Submission of Payment Certificate</a>
                </li>
                <li class="active">
                    Edit
                </li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							@permission('so-print')
							 <a href="{{ url('sales_order/print/'.$orderrow->id) }}" target="_blank" class="btn btn-info btn-sm">
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											...
											<div style="float:left;">
												Amount in % <input type="text" style="width:50px;" id="per_{{$j}}" name="per[]" class="perc" value="{{old('per')[$i]}}"/> <input type="text" style="width:250px;" placeholder="Description..." value="{{old('perdesc')[$i]}}" id="perdesc_{{$j}}" name="perdesc[]"/>
											</div>
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="11%">
													<input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" class="form-control line-total" readonly value="{{$item->pay_amount}}">
