								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										<td colspan="2" align="center">
											...
											<body>
												<?php $total_net = $discount = $total_vat = $total_gross = $i =$total=$total_amt= 0;?>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										<td colspan="2" align="center">
											...
											<body>
												<?php $total_net = $discount = $total_vat = $total_gross = $i =$total=$total_amt=$discount= 0;?>
												@foreach($reports as $row)
												<?php $i++;
												$total=$row['total']-$row['discount'];
												$discount+=$row['discount'];
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											@php $i++; @endphp
											<tr>
												<td><b>SI.No:</b> {{$i}} &nbsp; <b>SO.#:</b> {{$report[0]->voucher_no}} &nbsp; <b>SO Date</b> {{date('d-m-Y', strtotime($report[0]->voucher_date))}}</td>
												<td><b>SO.Ref.#:</b> {{$report[0]->reference_no}}</td>
											...
											<tr>
												...
												<td class="text-right"><b>SO.Qty.</b></td>
						...
						<?php } elseif($type=="detail_pending") { ?>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											<body>
											<?php $amount_total = $vat_amount = $discount = $poqty_total = $ponet_total = $invqty_total = $pndqty_total = $pndnet_total = $total = $nettotal = $netdiscount = $netvat_amount = $net_amount_total = 0; ?>
											@foreach($reports as $report)
											<tr>
												<td><b>SI.No:</b> {{$report[0]->voucher_no}} &nbsp; <b>SO.#:</b> {{$report[0]->voucher_no}} &nbsp; <b>SO Date</b> {{date('d-m-Y', strtotime($report[0]->voucher_date))}}</td>
												<td><b>SO.Ref.#:</b> {{$report[0]->reference_no}}</td>
									...
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												...
												<td ><b>Job No.</b> {{$report[0]->jobcode}}</td>
												<td ><b>Salesman:</b> {{$report[0]->salesman}}</td>
												<td  class="text-right"><b>Customer:</b> {{$report[0]->master_name}}</td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
												<td><b>Description</b></td>
