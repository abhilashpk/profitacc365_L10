                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="{{ url('sales_order/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="sorder_id" readonly name="sorder_id" placeholder="Copy from existing Order" autocomplete="off" onclick="getSalesOrder()">
                                    </div>
                                </div>
								<?php } else { ?>
									<input type="hidden" name="sorder_id" id="sorder_id">
								<?php } ?>
								...
								<?php } else { ?>
								<input type="hidden" name="po_doc" id="po_doc">
								<?php } ?>
...
function submitDraft() {
    $('#is_draft').val(1);
    document.frmSalesOrder.action="{{ url('sales_order/save_draft') }}";
...
function getSalesOrder() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "{{ url('sales_order/get_salesorder/') }}";
