                    ...
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								...
								<tr>
									<td colspan="2" align="center"><h4><b><u>Submission of Payment Application</u></b></h4></td>
								</tr>
								<tr>
									...
									<td align="left" >
										<div>
											<b>PC. No: {{$details->voucher_no}}</b><br/>
								...
								<tr style="border:1px solid black;">
									...
									<table border="0" style="width:100%;" class="table table-bordered">
										<tr>
											...
											<td width="10%" class="text-right"><b>Unit</b></td>
											<td width="12%" class="text-right"><b>Rate</b></td>
								...
								<tr style="border:1px solid black;">
									<td colspan="2" align="center">
										...
										<tr>
											...
											<p>Total Amount Invoice<?php if($fc) echo ' ('.$details->currency.')'?>: </p>
