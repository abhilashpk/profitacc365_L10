                            ...
                            <div class="table-responsive m-t-10">
                                ...
                                <table class="table horizontal_table table-striped" id="tableAcnts">
                                    ...
                                    <tr>
										...
										@elseif($num=='debit')
											<td><a href="" class="acnts" data-id="{{$account->id}}" data-code="{{$account->account_id}}" data-name="{{$account->master_name}}" onclick="selectDebit(this)">{{$account->account_id}}</a></td>
											<td><a href="" class="acnts" data-id="{{$account->id}}" data-code="{{$account->account_id}}" data-name="{{$account->master_name}}" onclick="selectDebit(this)">{{$account->master_name}}</a></td>
                                       @elseif($num=='credit')
											<td><a href="" class="acnts" data-id="{{$account->id}}" data-code="{{$account->account_id}}" data-name="{{$account->master_name}}" onclick="selectCredit(this)">{{$account->account_id}}</a></td>
											<td><a href="" class="acnts" data-id="{{$account->id}}" data-code="{{$account->account_id}}" data-name="{{$account->master_name}}" onclick="selectCredit(this)">{{$account->master_name}}</a></td>
