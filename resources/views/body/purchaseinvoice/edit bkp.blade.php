											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="8%" class="itcodmp">
														<input type="number" id="itmmpqty_1" autocomplete="off" step="any" name="mpquantity[]" class="form-control line-mpquantity" value="{{$item->mp_qty}}" placeholder="MP Qty.">
													</td>
													@endif
													<td width="8%">
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="7%">
														...
														<input type="number" name="oc_rate[]" id="ocrate_{{$i}}" step="any" value="{{($row->currency_rate==0)?'':$row->currency_rate}}" readonly class="form-control oc-rate" placeholder="Rate">
													</td>
													<td width="10%">
