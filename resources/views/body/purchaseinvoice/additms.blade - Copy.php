                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" enctype="multipart/form-data" action="{{ url('purchase_invoice/save') }}">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
                                           <option value="">Select Voucher...</option>
											...
											<option value="{{ $voucher['id'] }}" <?php if($docrow->voucher_id==$voucher['id']) echo 'selected';?>>{{ $voucher['voucher_name'] }}</option>
											@endforeach
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="voucher_no" readonly name="voucher_no" value="{{$docrow->voucher_no}}">
                                    </div>
                                </div>
								<input type="hidden" name="curno" id="curno" value="{{$docrow->voucher_no}}"> <input type="hidden" name="vat_no">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" name="reference_no" autocomplete="off" value="<?php echo (old('reference_no'))?old('reference_no'):$docrow->reference_no; ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="voucher_date" readonly data-language='en' id="voucher_date" value="{{$docrow->voucher_date}}"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_no" autocomplete="off" name="lpo_no" value="{{old('lpo_no')}}" placeholder="LPO No.">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_date" autocomplete="off" name="lpo_date" readonly data-language='en' value="{{(old('lpo_date'))?old('lpo_date'):$docrow->lpo_date}}">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="purchase_account" id="purchase_account" class="form-control" readonly value="{{$docrow->purchase_account}}">
										<input type="hidden" name="account_master_id" id="account_master_id" class="form-control" value="{{$docrow->account_master_id}}">
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="<?php echo (old('supplier_name'))?old('supplier_name'):$docrow->supplier_name; ?>" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="document" readonly name="document" value="{{old('document')}}" autocomplete="off" onclick="getDocument()">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<option value="{{ $term['id'] }}" <?php if($docrow->terms_id==$term['id']) echo 'selected';?>>{{ $term['description'] }}</option>
											@endforeach
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										...
										<div class="col-xs-5">
											<input type="text" name="currency_rate" autocomplete="off" id="currency_rate" class="form-control" value="{{$docrow->currency_rate}}" placeholder="Currency Rate">
										</div>
									</div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="17%">
													...
													<span class="small <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>">Item Code</span><input type="text" id="itmcod_{{$j}}" name="item_code[]" class="form-control <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>" autocomplete="off" value="{{$item}}">
												</td>
												<td width="30%">
												...
												<td width="5%">
													...
													<span class="small <?php if($errors->has('quantity.'.$i)) echo 'form-error';?>">Quantity</span> <input type="number" id="itmqty_{{$j}}" name="quantity[]" autocomplete="off" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" value="{{ old('quantity')[$i]}}">
												</td>
												<td width="6%">
								...
								<?php $i++; } } else { $total = $vattotal = $nettotal = 0; ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="17%">
													...
													<span class="small">Item Code</span><input type="text" id="itmcod_{{$i}}" name="item_code[]" class="form-control" autocomplete="off" value="{{$poitem->item_code}}">
												</td>
												<td width="30%">
													<span class="small">Item Description</span><input type="text" name="item_name[]" id="itmdes_{{$i}}" autocomplete="off" class="form-control" data-toggle="modal" data-target="#item_modal" value="{{$poitem->item_name}}">
												</td>
												<td width="7%">
												...
												<td width="5%">
													<span class="small">Quantity</span> <input type="number" id="itmqty_{{$i}}" autocomplete="off" name="quantity[]" value="{{$poitem->quantity}}" class="form-control line-quantity">
												</td>
												<td width="6%">
													<span class="small">Cost/Unit</span> <input type="number" id="itmcst_{{$i}}" autocomplete="off" step="any" name="cost[]" value="{{$poitem->cost}}" class="form-control line-cost">
												</td>
												<td width="6%">
													<span class="small">Tx.Code</span><select id="taxcode_{{$i}}" class="form-control select2 tax-code" style="width:100%" name="tax_code[]"><option value="SR">SR</option><option value="RC">RC</option></select>
												</td>
												<td width="6%">
													<span class="small">Tx.Inc.</span><br/>
													<select id="txincld_{{$i}}" class="form-control select2 taxinclude" style="width:100%" name="tax_include[]"><option value="0">No</option><option value="1">Yes</option></select>
												</td>
												<?php
													$lntotal = $poitem->quantity * $poitem->cost;
													$vat = number_format(($lntotal * 5 )/100,2);
													$total += $lntotal;
													$vattotal += $vat;
												...
												<td width="10%">
													<span class="small">VAT Amt.</span>
													<input type="hidden" id="hidunit_{{$i}}" name="hidunit[]" class="hidunt">
													<input type="hidden" id="packing_{{$i}}" name="packing[]" value="1">
													<input type="text" id="vatdiv_{{$i}}" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="{{$poitem->vat.'% - '.$vat}}"><!--<div class="h5" id="vatdiv_1"></div>--> 
													<input type="hidden" id="vat_{{$i}}" name="line_vat[]" class="form-control vat" value="{{$poitem->vat}}">
													<input type="hidden" id="vatlineamt_{{$i}}" name="vatline_amt[]" class="form-control vatline-amt" value="{{$poitem->vat}}">
													<input type="hidden" id="itmdsnt_{{$i}}" name="line_discount[]">
												</td>
												<td width="12%">
													<span class="small">Total</span> <input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" value="{{$lntotal}}" class="form-control line-total" readonly >
													<input type="hidden" id="itmtot_{{$i}}" name="item_total[]" value="{{$lntotal}}">
												</td>
												<td width="1%">
													<br/>@if($num==$i)
														<button type="button" class="btn-success btn-add-item" >
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="5%">
														...
														<option value="SR">SR</option></select>
													</td>
													<td width="15%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" step="any" name="total_fc" class="form-control" value="{{round($total*$docrow->currency_rate,2)}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control discount-cal" autocomplete="off" value="{{(old('discount'))}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" class="form-control" autocomplete="off" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal" name="subtotal" class="form-control" readonly value="{{$total}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control" value="{{round($total*$docrow->currency_rate,2)}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control" value="{{round(($vattotal*$docrow->currency_rate),2)}}" readonly>
										</div>
									</div>
                                </div>
								
								<input type="hidden" step="any" id="other_cost" name="other_cost" readonly class="form-control" value="{{old('other_cost')}}" placeholder="0">
								<input type="hidden" step="any" id="other_cost_fc" name="other_cost_fc" readonly class="form-control" value="{{old('other_cost_fc')}}" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control" value="{{round($total + $vattotal,2)}}" readonly>
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control" readonly value="{{round($total + $vattotal,2)}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control" readonly value="{{round(($total+$vattotal)*$docrow->currency_rate,2)}}">
										</div>
									</div>
                                </div>
								<hr/>
...
$(document).ready(function () { 
	...
	<?php if($docrow->is_fc==0) { ?>
		...
		$("#fc_label").toggle(); $("#c_label").toggle(); $("#total_fc").toggle(); $('#other_cost_fc').toggle();$("#discount_fc").toggle(); $("#net_amount_fc").toggle();$("#vat_fc").toggle();$("#subtotal_fc").toggle();
	<?php } else { ?>
	...
	$('.locPrntItm').toggle();
	$('.infodivPrnt').toggle(); $('.infodivPrntItm').toggle();  $('.OCdivPrnt').toggle(); 
...
$(function() {	
    ...
    { 
        ...
        var controlForm = $('.controls .OCdivPrnt'),
			...
			newEntry.find($('input[name="vat_oc[]"]')).attr('id', 'vatocamt_' + rowNum);
			newEntry.find('input').val(''); 
			$('#vatocamt_' + rowNum).val(5);
