                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('purchase_invoice/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' autocomplete="off" value="{{date('d-m-Y',strtotime($orderrow->voucher_date))}}" id="voucher_date" placeholder="PI. Date"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_no" name="lpo_no" autocomplete="off" placeholder="LPO No." value="{{(old('lpo_no'))?old('lpo_no'):$orderrow->lpo_no}}">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="hidden" name="old_account_master_id" id="old_account_master_id" value="{{$orderrow->account_master_id}}">
										<div class="input-group">
											<input type="text" name="purchase_account" id="purchase_account" class="form-control" value="{{$orderrow->account}}" readonly>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="document_type" class="form-control select2" style="width:100%" name="document_type">
										   ...
										   <option value="MR" <?php if($orderrow->document_type=='MR') echo 'selected';?>>MaterialRequisition</option>
										   <option value="SDO" <?php if($orderrow->document_type=='SDO') echo 'selected';?>>Supplier Delivery Order</option>
                                       </select>
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document" readonly name="document_no" value="{{$orderrow->document_no}}" placeholder="Document#" autocomplete="off">
                                        <input type="hidden" id="document_id" name="document_id" value="{{$orderrow->document_id}}">
                                    </div>
                                </div>
								<?php } else { ?>
    								<input type="hidden" id="document" name="document_no" value="{{$orderrow->document_no}}">
								    <input type="hidden" id="document_id" name="document_id" value="{{$orderrow->document_id}}">
								<?php } ?>
								...
								<div class="form-group">
									...
									<input type="hidden" name="dr_account_id" id="dr_account_id" value="{{$orderrow->supplier_id}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="po_no" name="po_no" placeholder="Purchase Order No" value="<?php echo (old('po_no'))?old('po_no'):$orderrow->po_no; ?>" autocomplete="off">
                                    </div>
                                </div>
								<?php } else { ?>
									...
									<div class="itemdivChld">
										<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="29%">
														<input type="text" name="item_name[]" id="itmdes_{{$j}}" autocomplete="off" class="form-control" value="{{old('order_item_id')[$i]}}">
													</td>
													<td width="7%">
													...
													<td width="6%">
														...
														<input type="hidden" name="tax_code_old[]" value="{{old('tax_code')[$i]}}">
													</td>
													<td width="6%">
											...
											<!--<input type="hidden" id="othrcst_{{$j}}" value="{{old('othr_cost')[$i]}}" step="any" name="othr_cost[]" class="form-control" readonly>
											<input type="hidden" id="netcst_{{$j}}" step="any" value="{{old('net_cost')[$i]}}" name="net_cost[]" class="form-control" readonly>-->
															...
															<div class="col-xs-4">
																<table class="table table-bordered table-hover">
																	...
																	<tr>
																		<td>{{ $row->name }}</td>
																		<td>{{ $cqty }}</td>
																		<td class="num"><input type="number" name="locqty[<?php echo $i-1;?>][]" class="loc-qty-{{$i}}" data-id="{{$i}}">
																		<input type="hidden" name="locid[<?php echo $i-1;?>][]" value="{{$location_id}}"/>
																		<input type="hidden" name="editid[<?php echo $i-1;?>][]" /></td>
																	</tr>
																	<?php } ?>
																	</tbody>
																</table>
								...
								<div class="itemdivChld">							
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="8%">
														...
														<input type="number" id="itmqty_{{$i}}" autocomplete="off"step="any"  name="quantity[]" class="form-control line-quantity" value="{{$item->quantity}}" {{($orderrow->is_editable == 1)?'readonly':''}}>
														<input type="hidden" name="max_quantity[]" id="itmaxqty_{{$i}}" value="{{$max_quantity}}"><!--APR25-->
													</td>
													<td width="8%">
														<input type="number" id="itmcst_{{$i}}" autocomplete="off" step="any" name="cost[]" {{($orderrow->is_editable == 1)?'readonly':''}} class="form-control <?php if($errors->has('cost.'.$i)) echo 'form-error';?> line-cost" value="{{($orderrow->is_fc==1)?$item->unit_price_fc:$item->unit_price}}">
													</td>
													<td width="6%">
														...
														<option value="RC" <?php if($item->tax_code=="RC") echo 'selected'; ?>>RC</option>
														<option value="ZR" <?php if($item->tax_code=="ZR") echo 'selected'; ?>>ZR</option>
														<option value="EX" <?php if($item->tax_code=="EX") echo 'selected'; ?>>EX</option>
														</select>
													...
													<td width="9%">
														...
														<input type="text" id="vatdiv_{{$i}}" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="{{$item->vat.'% - '}}{{($orderrow->is_fc==1)?$item->vat_amount_fc:$item->vat_amount}}"><!--<div class="h5" id="vatdiv_1"></div>--> 
														<input type="hidden" id="vat_{{$i}}" name="line_vat[]" class="form-control vat" value="{{$item->vat}}">
														<input type="hidden" id="vatlineamt_{{$i}}" name="vatline_amt[]" class="form-control vatline-amt" value="{{($orderrow->is_fc==1)?$item->vat_amount_fc:$item->vat_amount}}">
														<input type="hidden" id="itmdsnt_{{$i}}" name="line_discount[]" >
													</td>
													<td width="11%">
														<input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" class="form-control line-total" readonly value="{{($orderrow->is_fc==1)?$item->total_price_fc:$item->total_price}}">
											...
											<?php if($formdata['more_info']==1) { ?>
											<!--<input type="hidden" id="othrcst_{{$i}}" value="{{$item->othercost_unit}}" step="any" name="othr_cost[]" class="form-control" readonly>
											<input type="hidden" id="netcst_{{$i}}" step="any" value="{{$item->netcost_unit}}" name="net_cost[]" class="form-control" readonly>-->
											<div id="moreinfo" style="float:left;padding-right:5px;">
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="8%">
														...
														<input type="hidden" name="oc_amount_old[]" value="{{($row->is_fc==1)?$row->oc_fc_amount:$row->oc_amount}}"><!--4KIM-->
													</td>
													<td width="7%">
														<span class="small">Rate</span>
														<input type="number" name="oc_rate[]" id="ocrate_{{$i}}" step="any" value="{{($row->currency_rate==0)?1:$row->currency_rate}}"  class="form-control oc-rate" placeholder="Rate">
													</td>
													<td width="10%">
													...
													<td width="5%">
														...
														<input type="hidden" name="vat_oc_old[]" value="{{$row->oc_vat}}">
													</td>
													<td width="5%">
														<span class="small">Tx.Code</span>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency {{$bcurrency}}</span><input type="text" id="total_fc" step="any" name="total_fc" class="form-control spl" value="{{(old('total_fc'))?old('total_fc'):$orderrow->total}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="hidden" id="discount_old" name="discount_old" value="{{(old('discount'))?old('discount'):(($orderrow->is_fc==1)?$orderrow->discount_fc:$orderrow->discount)}}">
										</div>
										<div class="col-xs-2">
								...
								<?php if(isset($formdata['pv_entry']) && $formdata['pv_entry']==1) { ?>
								<div class="form-group">
									<label for="input-text" class="col-sm-2 control-label">Payment Voucher Entry</label>
                                    <div class="col-sm-10">
                                        <label class="radio-inline iradio">
											<input type="checkbox" class="pv_icheck" id="is_pv" name="is_pv" <?php if($orderrow->is_pventry==1) echo 'checked';?> value="1">
								...
								<div id="pv_form">
									<input type="hidden" id="rvdraccount" value="{{$pvvoucher['account_name']}}">
									<input type="hidden" id="rvdraccountid" value="{{$pvvoucher['id']}}">
									<input type="hidden" name="rvid" value="{{$pvvoucher['rid']}}">
									...
									<div class="RVdivPrnt">
										...
										@if($rowrv->entry_type=='Cr')
											@php $i++; @endphp
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													<td width="10%">
														<input type="hidden" id="rvvoucher_{{$i}}" name="rv_voucher[]" value="{{$pvid}}"/>
										...
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													<td width="10%">
														<input type="hidden" id="rvvoucher_1" name="rv_voucher[]" value="{{$pvid}}"/>
														<span class="small">Voucher Type</span>
													...
													<td width="10%">
														<span class="small">Voucher No</span>
														<input type="text" name="rv_voucher_no[]" value="{{$pvvoucher['voucher_no']}}" id="rvvoucherno_1" autocomplete="off" class="form-control">
													</td>
													<td width="20%">
														<span class="small">Debit Account</span>
														<input type="text" name="rv_dr_account[]" id="rvdraccount_1" autocomplete="off" data-toggle="modal" data-target="#customer_modalRV" value="{{$pvvoucher['account_name']}}">
														<input type="hidden" id="rvdraccountid_1" name="rv_dr_account_id[]" value="{{$pvvoucher['id']}}">
													</td>
													<td width="15%">
														<span class="small">Amount</span> 
								...
								<?php } else { ?>
								<input type="hidden" name="is_pv" id="is_pv">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('purchase_invoice/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	<?php if($orderrow->is_pventry==0) { ?>
		$('#pv_form').toggle(); $('#cheque_no').hide(); $('#cheque_date').hide(); $('#bank_id').hide(); $('.pdcr').hide();
	<?php } ?>
	...
	$('.oc').toggle(); $('.sedePrntItm').toggle(); $('.dimnInfodivPrntItm').toggle();
	...
	$('.import').on('ifUnchecked', function(event){
		...
		$(document).on('ifChecked', '.pv_icheck', function(event){  //$('.rv_icheck').on('ifChecked', function(event){ 
		$('#pv_form').toggle(); $('#rv_amount').val( parseFloat( ($('#net_amount').val()=='') ? '' : $('#net_amount').val() ) );
...
//calculation item net total, tax and discount...
	function getNetTotal() {
		...
		$( '.line-total' ).each(function() { 
		  ...
		  amt = (amt * 100).toFixed(0) / 100; 
		  lineTotal = lineTotal + parseFloat(amt);
		 
		});
		//console.log('lineTotal: '+lineTotal);
		lineTotal = (lineTotal * 100).toFixed(0) / 100; 
		$('#total').val(lineTotal);
		...
		vatcur = (vatcur * 100).toFixed(0) / 100; 
		$('#vat').val(vatcur);
		...
		netTotal = (netTotal * 100).toFixed(0) / 100; 
		...
		if( $('#is_fc').is(":checked") ) { 
			...
			fcTotal = (fcTotal * 100).toFixed(0) / 100; 
			$('#total_fc').val(fcTotal);
			fcDiscount = (fcDiscount * 100).toFixed(0) / 100; 
			$('#discount_fc').val(fcDiscount);
			var subfc = lineTotal * rate;
			subfc = (subfc * 100).toFixed(0) / 100; 
			$('#subtotal_fc').val(subfc);
			var fcTax = vat * rate;
			var fcNetTotal = (fcTotal - fcDiscount) + fcTax;
			fcTax = (fcTax * 100).toFixed(0) / 100; 
			$('#vat_fc').val(fcTax);
			fcNetTotal = (fcNetTotal * 100).toFixed(0) / 100; 
			$('#net_amount_fc').val(fcNetTotal);
		}
	...
	function getLineTotal(n) {
		...
		if($('#txincld_'+n+' option:selected').val()==1 ) {
			...
			taxLineCost = (taxLineCost * 100).toFixed(0) / 100; 
		$('#vatdiv_'+n).val(lineVat+'% - '+taxLineCost); //val(lineVat+'% - '+taxLineCost.toFixed(2));
			lineTotal = (lineTotal * 100).toFixed(0) / 100; 
		$('#itmttl_'+n).val(lineTotal);
		$('#vat').val(taxLineCost);//(taxLineCost + vatcur).toFixed(2)
		$('#vatlineamt_'+n).val(taxLineCost);
			lineTotalTx = (lineTotalTx * 100).toFixed(0) / 100; 
		$('#itmtot_'+n).val( lineTotalTx);
	...
	function getAutoPrice(curNum) {
		...
		if($('#sales_type option:selected').val()=='normal') {
			...
			$.ajax({
				...
				type: 'get',
				data: 'item_id='+item_id+'&unit_id='+unit_id+'&cr='+cr,
				success: function(data) {
					if(cst=='') //NW
						$('#itmcst_'+curNum).val((data==0)?'':data);
					else
	...
	function calculateTaxInclude(curNum)
	{
		...
		var ln_total_amt = ln_total - vat_amt;
			ln_total = (ln_total * 100).toFixed(0) / 100;
		$('#itmttl_'+curNum).val( ln_total);
		...
		$('#net_amount_hid').val( (parseFloat( ($('#net_amount_hid').val()=='')?0:$('#net_amount_hid').val() ) - vat_amt).toFixed(2) );
			ln_total_amt = (ln_total_amt * 100).toFixed(0) / 100;
		$('#itmtot_'+curNum).val( ln_total_amt);
	}
		...
		var vatTotal = parseFloat( ($('#vat').val()=='') ? 0 : $('#vat').val() );
			...
			$( '.line-total' ).each(function() {
			  ...
			  amountNet = amountNet + amountTotal;
				vatLine = (vatLine * 100).toFixed(0) / 100;
			  vatLine = parseFloat(vatLine);
			  
			  vatnet = parseFloat(vatnet + vatLine); 
			  $('#vatdiv_'+curNum).val(vat+'% - '+vatLine);
			  $('#vatlineamt_'+curNum).val(vatLine);
				discountAmt = (discountAmt * 100).toFixed(0) / 100;
			  $('#itmdsnt_'+curNum).val(discountAmt);
			...
			$('#subtotal').val(subtotal);
				vatnet = (vatnet * 100).toFixed(0) / 100;
			$('#vat').val(vatnet);
			
			if(taxinclude==true && discount==0) {
				$('#subtotal').val( (subtotal - vatnet));
				$('#subttle').html('(VAT Exclude)');
				$('#net_amount').val( subtotal);
...
function calculateDueDate(days) {
	   ...
	   const dateStr = $('#due_date').val(); // DD-MM-YYYY
      const [day, month, year] = dateStr.split('-').map(Number);

       // Create date in local time
       const date = new Date(year, month - 1, day, 12, 20, 26); // Hours:Minutes:Seconds

        //console.log(date.toString()); 
        const today = new Date(year, month - 1, day, 12, 20, 26);
         const dueDate = new Date(year, month - 1, day, 12, 20, 26);
        //console.log(dueDate);
...
$(function() {	
	...
	$(document).on('blur', '.line-quantity', function(e) {
		...
		/*if(parseFloat(this.value) > parseFloat( $('#itmaxqty_'+curNum).val() )) {
			alert('Quantity should not exceed than Quotation/PO/SDO.');
	...
	function checkDocQty(curNo) {
	    var qtval = $('#itmqty_'+curNo).val();
		if(parseFloat(qtval) > parseFloat( $('#itmaxqty_'+curNo).val() )) {
			alert('Quantity should not exceed than Quotation/PO/SDO.');
			$('#itmqty_'+curNo).val( $('#itmaxqty_'+curNo).val() );
			return false;
		}
		
		var isPrice = getAutoPrice(curNo);
		var res = getLineTotal(curNo); 
		if(res) {
			var call = getOtherCost();
			if(call)
				getNetTotal();
	...
	/* $(document).on('click', '.loc-info', function(e) { 
	   ...
	   var curNum = res[1];  
	   var item_id = $('#itmid_'+curNum).val();
	   var pi_id = $('#purchase_invoice_id').val();
	   if(item_id!='') {
		   var locUrl = "{{ url('itemmaster/get_locinfo/') }}/"+item_id+"/"+curNum+"/"+pi_id+"/PI";
	...
	$(document).on('click', '.loc-info', function(e) { 
	   ...
	   var curNum = res[1];  
	   var item_id = $('#itmid_'+curNum).val();
	   var pi_id = ($('#p_orditmid_'+curNum).val()=='')?0:$('#p_orditmid_'+curNum).val();
	   if(item_id!='') {
		   var locUrl = "{{ url('itemmaster/get_locinfo/') }}/"+item_id+"/"+curNum+"/"+pi_id+"/PI";
    ...
    $(document).on('keyup', '.num :input[type="number"]', function(e) {
		...
		//MAY25
		if(parseFloat(itQty) > parseFloat( $('#itmaxqty_'+curNum).val() )) {
			alert('Quantity should not exceed than Quotation/PO/SDO.');
			//$('#itmqty_'+curNo).val( $('#itmaxqty_'+curNo).val() );
			$(this).val(lqy);
			//lqy = '';
	...
	//RV Entry
		...
		var res = this.id.split('_');
	    var curNum = res[1];
		var vchr = e.target.value; console.log('v '+vchr);
