								...
								<tr style="border:1px solid black;">
									...
									<table border="0" style="width:100%;" class="table table-bordered">
										<tr>
											...
											<td width="5%" class="text-right"><b>Unit</b></td>
											<td width="5%" class="text-right"><b>Qty.</b></td>
											<td width="10%" class="text-right"><b>Unt.Price</b></td>
											<td width="8%" class="text-right"><b>VAT</b></td>
											<td width="12%" class="text-right"><b>Total</b></td>
										</tr>
										<?php $i = 0;?>
