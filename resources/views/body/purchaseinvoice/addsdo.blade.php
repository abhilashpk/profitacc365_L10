                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" action="{{ url('purchase_invoice/save/'.$docrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="voucher_date" readonly data-language='en' id="voucher_date" value="{{($voucherdt=='')?date('d-m-Y'):$voucherdt}}"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_date" autocomplete="off" name="lpo_date" readonly data-language='en' value="{{(old('lpo_date'))?old('lpo_date'):$lpodt}}">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="<?php echo (old('supplier_name'))?old('supplier_name'):$docrow->supplier; ?>" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_{{$i}}" name="item_code[]" class="form-control" autocomplete="off" value="{{$poitem->item_code}}" data-toggle="modal" data-target="#item_modal">
												</td>
												<td width="29%">
								...
								<?php } ?>
											...
											<div class="form-group oc" id="othrcstItm_{{$i}}">
												...
												<div class="col-xs-10">
													...
													<div class="col-xs-2">
														<span class="small">Other Cost/Unit</span> <input type="text" id="othrcst_{{$i}}" value="{{$poitem->othercost_unit}}" step="any" name="othr_cost[]" class="form-control" readonly><!--MY27-->
													</div>
													<div class="col-xs-2">
														<span class="small">Net Cost/Unit</span> <input type="text" id="netcst_{{$i}}" step="any" value="{{$poitem->netcost_unit}}" name="net_cost[]" class="form-control" readonly>
													</div>
													<div class="col-xs-1">
								...
								<fieldset>
									...
									<div class="OCdivPrnt">
										<?php 
										if(count($ocrow) > 0) { $ocnum = count($ocrow); ?>
										<input type="hidden" id="ocrowNum" value="{{$ocnum}}">
										<?php $i = 0; foreach($ocrow as $row) { $i++; ?>
										<div class="OCdivChld">
											<table border="0" class="table-dy-row">
												<tr>
													<td width="15%">
													...
													<td width="7%">
														...
														<input type="number" name="oc_rate[]" id="ocrate_{{$i}}" step="any" value="{{($row->currency_rate==0)?'':$row->currency_rate}}"  class="form-control oc-rate" placeholder="Rate">
													</td>
													<td width="10%">
								...
								<?php } ?>
								<input type="hidden" step="any" id="other_cost" name="other_cost" value="{{$docrow->other_cost}}" readonly class="form-control" placeholder="0">
								<input type="hidden" step="any" id="other_cost_fc" name="other_cost_fc" value="{{$docrow->other_cost_fc}}" readonly class="form-control spl" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency {{$bcurrency}}</span>	<input type="number" id="total_fc" step="any" name="total_fc" class="form-control spl" value="{{(old('total_fc'))?old('total_fc'):$docrow->total}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control spl discount-cal" autocomplete="off" value="{{(old('discount'))?old('discount'):$docrow->discount}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" value="{{(old('vat'))?old('vat'):intval($vattotal*100)/100}}" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" value="{{(old('vat_fc'))?old('vat_fc'):intval($vattotal_dh*100)/100}}" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="{{(old('net_amount')?old('net_amount'):$docrow->is_fc==1)?$docrow->net_amount_fc:$docrow->net_amount}}">
										</div>
										<div class="col-xs-2">																								
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" readonly value="{{(old('net_amount_fc'))?old('net_amount_fc'):$docrow->net_total}}">
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="radio-inline iradio">
											<input type="checkbox" class="pv_icheck" id="is_pv" name="is_pv" value="1">
                                    </div>
                                </div>
                                	<div id="pv_form">
										...
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="20%">
														<span class="small">Debit Account</span>
														<input type="text" name="rv_dr_account[]" id="rvdraccount_1" autocomplete="off" data-toggle="modal" data-target="#customer_modalRV" class="form-control" value="{{$pvvoucher['account_name']}}">
...
$('.dimnInfodivPrntItm').toggle();
	...
	$('.infodivPrnt').toggle(); $('.infodivPrntItm').toggle(); 
		$('#pv_form').toggle(); $('#chequeno_1').hide(); $('#chequedate_1').hide(); $('#bankid_1').hide(); $('.lbban_1').hide();$('.lbchq_1').hide();$('.lbchqd_1').hide();
	<?php if($docrow->other_cost != 0 || $docrow->other_cost_fc != 0) { ?>
	...
	$('.import').on('ifUnchecked', function(event){
		...
		$(document).on('ifChecked', '.pv_icheck', function(event){ 
...
$(function() {	
    ...
    { 
        ...
        var controlForm = $('.controls .OCdivPrnt'),
            ...
            newEntry = $(currentEntry.clone()).appendTo(controlForm); //MY27
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "{{ url('purchase_invoice/checkvchrno/') }}", 
			type: 'get',
