                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" action="{{ url('purchase_invoice/save/'.$docrow->id) }}">
								...
								<input type="text" step="any" id="other_cost" name="other_cost" value="{{$docrow->other_cost}}" readonly class="form-control" placeholder="0">
								<input type="text" step="any" id="other_cost_fc" name="other_cost_fc" value="{{$docrow->other_cost_fc}}" readonly class="form-control spl" placeholder="0">
