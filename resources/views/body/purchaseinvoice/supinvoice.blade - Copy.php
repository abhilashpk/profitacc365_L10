                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="{{ url('purchase_invoice/update/'.$orderrow->id) }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="purchase_account" id="purchase_account" class="form-control" value="{{$orderrow->account}}" readonly onclick="getAccount(this)">
										<input type="hidden" name="account_master_id" id="account_master_id" value="{{$orderrow->account_master_id}}" class="form-control" >
									</div>
                                </div>
								...
								<?php if($orderrow->is_fc==1) {
										 ...
										 $total_price = $item->total_price / $orderrow->currency_rate;
										 $vat_amount = round($item->vat_amount / $orderrow->currency_rate,2);
										 $total = $orderrow->total_fc;// / $orderrow->currency_rate;
									...
									<div class="itemdivChld">							
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="8%">
														<input type="number" id="itmcst_{{$i}}" autocomplete="off" step="any" name="cost[]" class="form-control <?php if($errors->has('cost.'.$i)) echo 'form-error';?> line-cost" value="{{$unit_price}}">
													</td>
													<td width="6%">
													...
													<td width="9%">
														...
														<input type="hidden" id="vatlineamt_{{$i}}" name="vatline_amt[]" class="form-control vatline-amt" value="{{intval($vat_amount*100)/100}}">
														<input type="hidden" id="itmdsnt_{{$i}}" name="line_discount[]" >
													</td>
													<td width="11%">
														<input type="number" id="itmttl_{{$i}}" step="any" name="line_total[]" class="form-control line-total" readonly value="{{$item->item_total}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span><input type="text" id="total" step="any" name="total" class="form-control spl" readonly value="{{(old('total'))?old('total'):intval($total*100)/100}}">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span><input type="text" id="total_fc" step="any" name="total_fc" class="form-control spl" value="{{(old('total_fc'))?old('total_fc'):intval($orderrow->total*100)/100}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" autocomplete="off" class="form-control spl discount-cal" value="{{(old('discount'))?old('discount'):$orderrow->discount_fc}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal" name="subtotal" class="form-control spl" readonly value="{{(old('subtotal'))?old('subtotal'):$total}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control spl" readonly value="{{(old('subtotal'))?old('subtotal'):intval($orderrow->subtotal*100)/100}}" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" value="{{(old('vat'))?old('vat'):intval($vat_amount_net*100)/100}}" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" value="{{(old('vat_fc'))?old('vat_fc'):intval($orderrow->vat_amount*100)/100}}" placeholder="0" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="{{(old('net_amount'))?old('net_amount'):intval($net_amount*100)/100}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" value="{{(old('net_amount_fc'))?old('net_amount_fc'):intval($orderrow->net_amount*100)/100}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								<hr/>
	...
	function getOtherCost() {
		...
		if( $('.OCdivPrnt').is(":visible") ) { 
			$( '.oc-line' ).each(function() { 
				...
				otherCostTx = otherCostTx + parseFloat(ocamt_ln) + ocvatamt; console.log('oct1: '+ocrate);
