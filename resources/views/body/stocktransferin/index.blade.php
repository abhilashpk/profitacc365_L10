...
@section('content')
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="{{ url('stock_transferin/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableLocation">
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('stock_transferin/edit/'.$stock->id) }}'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>
										</td>
											<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('stock_transferin/viewonly/'.$stock->id) }}'">
												<span class="glyphicon glyphicon-eye-open"></span></button>
											</p>
										</td>
										<td>
											<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $stock->id }}','{{ $stock->is_mfg }}')"><span class="glyphicon glyphicon-trash"></span></button>
											</p>
										</td>
										<td>
											<p><a href="{{url('stock_transferin/print/'.$stock->id)}}" target = "_blank" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span></a></p>
										</td>
                                    </tr>
									@endforeach
        ...
        <section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="{{ url('stock_transferin/search') }}">
			 ...
			 <div class="col-lg-12">
					<div class="panel panel-info">
						<div class="panel-heading clearfix">
							<h3 class="panel-title pull-left m-t-6">
								<i class="fa fa-fw fa-list-alt"></i> Sales TransferIn Report
							</h3>
						</div>
						<div class="panel-body">
								<div class="row">
...
function funDelete(id,m) {
	if(m=='0') {
		...
		if(con==true) {
			var url = "{{ url('stock_transferin/delete/') }}";
