                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							@endcan
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="15%">
														...
														<input type="hidden" id="othrcst_1" step="any" name="othr_cost[]" class="form-control" readonly>
														<input type="hidden" id="netcst_1" step="any" name="net_cost[]" class="form-control" readonly>
													</td>
													<td width="3%"><br/>
								...
								<input type="hidden" id="total" step="any" name="total_hd" readonly>
								<div class="form-group">
...
$(function() {	
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "{{ url('stock_transferin/checkvchrno/') }}", 
			type: 'get',
