...
<head>
	...
	<title>Profit ACC 365 ERP - Design Report</title>

	<!-- Report Office2013 style -->
	<link href="{{asset('css/stimulsoft.viewer.office2013.whiteteal.css')}}" rel="stylesheet">
	<link href="{{asset('css/stimulsoft.designer.office2013.lightgrayteal.css')}}" rel="stylesheet">
	...
	<script src="{{asset('scripts/stimulsoft.designer.js')}}" type="text/javascript"></script>
