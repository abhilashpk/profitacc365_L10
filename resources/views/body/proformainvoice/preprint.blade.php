        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										<td colspan="2" align="center">
											...
											<body>
												<?php $total_net = $discount = $total_vat = $total_gross = $i = 0;?>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											@php $i++; @endphp
											<tr>
												<td><b>SI.No:</b> {{$i}} &nbsp; <b>SO.#:</b> {{$report[0]->voucher_no}}</td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											@foreach($reports as $report)
											<tr>
												<td><b>SI.No:</b> {{$report[0]->voucher_no}} &nbsp; <b>SO.#:</b> {{$report[0]->voucher_no}}</td>
												<td><b>SO.Ref.#:</b> {{$report[0]->reference_no}}</td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="{{ url('proforma_invoice/export') }}">
