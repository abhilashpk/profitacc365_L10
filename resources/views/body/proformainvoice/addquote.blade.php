                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> New Proforma Invoice
                            </h3>
                        </div>
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="{{ url('proforma_invoice/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="description" autocomplete="on" name="description" value="<?php echo (old('description'))?old('description'):$quoterow->description; ?>">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="less_description" autocomplete="on" value="<?php echo (old('less_description'))?old('less_description'):$quoterow->subject; ?>" name="less_description" placeholder="Subject">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<span class="small" id="fc_label">Currency</span>
											<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="{{(old('total'))?old('total'):(($quoterow->is_fc==1)?$quoterow->total_fc:$total)}}">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control spl discount-cal" value="{{(old('discount'))?old('discount'):(($quoterow->is_fc==1)?$quoterow->discount_fc:$quoterow->discount)}}" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" class="form-control spl" value="{{(old('discount_fc'))?old('discount_fc'):$quoterow->discount}}" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal" name="subtotal" class="form-control spl" readonly value="{{(old('subtotal'))?old('subtotal'):(($quoterow->is_fc==1)?$quoterow->subtotal_fc:$total)}}">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control spl" value="{{(old('subtotal_fc'))?old('subtotal_fc'):$quoterow->subtotal}}" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" placeholder="0" value="{{(old('vat'))?old('vat'):(($quoterow->is_fc==1)?$quoterow->vat_amount_fc:$vattotal)}}" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" value="{{(old('vat_fc'))?old('vat_fc'):$quoterow->vat_amount}}" placeholder="0" readonly>
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('proforma_invoice') }}" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "{{ url('proforma_invoice/checkrefno/') }}";
...
$(function() {	
	...
	var custurl = "{{ url('proforma_invoice/customer_data/') }}";
	...
	var supurl = "{{ url('proforma_invoice/salesman_data/') }}";
	...
	var itmurl = "{{ url('proforma_invoice/item_data/') }}";
	...
	$('#customer_name').on('blur', function(e){
		...
		$.ajax({
			url: "{{ url('proforma_invoice/set_session/') }}",
			type: 'get',
