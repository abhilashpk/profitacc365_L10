					...
					<div class="panel panel-success filterable" id="newCustomerFrm">
						...
						<button type="button" class="btn btn-primary viewall">View All</button>
							...
							<div class="col-xs-10">
								...
								<?php if($formdata['customer_department']==1) { ?>
									<div class="form-group">
										<label for="input-text" class="col-sm-5 control-label">Department</label>
										<div class="col-sm-7">
											<input type="text" class="form-control" id="custDpt" name="custDpt" readonly placeholder="Department">
										</div>
									</div>
									<?php } else { ?>
								         <input type="hidden" name="custDpt" id="custDpt">
								    <?php } ?>
