            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
						...
						@can('vat-create')
                             <a href="{{ url('vat_master/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableVat Master">
                                    ...
                                    <tbody>
									@foreach($vatmasters as $vatmaster)
                                    <tr>
                                        <td>{{ $vatmaster->code }}</td>
										<td>{{ $vatmaster->name }}</td>
										<td>{{ $vatmaster->percentage }}</td>
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('vat_master/edit/'.$vatmaster->id) }}'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>
										</td>
										<td>@can('vat-delete')
											<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $vatmaster->id }}')"><span
