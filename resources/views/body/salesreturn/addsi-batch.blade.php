									...
									<div class="itemdivChld">	
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="13%">
													<select id="itmcat_{{$i}}" class="form-control select2" style="width:100%" name="cat_id[]">
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_{{$i}}" name="quantity[]" step="any" autocomplete="off" class="form-control line-quantity" min="1" value="{{($item->balance_quantity > 0)?$item->balance_quantity:$item->quantity}}" {{($item->batch_req==1)?'readonly':''}}>
												</td>
												<td width="8%">
