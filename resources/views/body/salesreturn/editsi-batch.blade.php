                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Sales Return
                            </h3>
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesReturn" id="frmSalesReturn" action="{{ url('sales_return/update/'.$orderrow->id) }}">
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="13%">
													...
													<option value="{{$cat->id}}" {{($item->cat_id==$cat->id)?'selected':''}} >{{$cat->category_name}}</option>
													@endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('sales_return/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
