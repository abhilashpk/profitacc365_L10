									 ...
									 <div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="6%">
													<select id="txincld_1" class="form-control select2 taxinclude" style="width:100%" name="tax_include[]"><option value="0">No</option><option value="1" selected="selected">Yes</option></select>
												</td>
												<td width="9%">
...
$(document).ready(function () { 
	...
	$("#currency_id").prop('disabled', true);$('.locPrntItm').toggle();
	$("#fc_label").toggle(); $("#c_label").toggle(); $("#total_fc").toggle(); $("#discount_fc").toggle(); $("#net_amount_fc").toggle(); $("#vat_fc").toggle();
	$('.infodivPrntItm').toggle(); $("#subtotal_fc").toggle(); $('#roundoff_fc').toggle();
	$('.sedePrntItm').toggle();
