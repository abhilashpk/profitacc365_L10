                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i>  Division  List
                        </h3>
                        <div class="pull-right">
                             <a href="{{ url('division/add') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableDivision">
                                    <thead>
                                    <tr>
                                        <th>Division Code</th>
										<th>Division Name</th>
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('division/edit/'.$division->id) }}'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>
										</td>
										<td>
											<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $division->id }}')"><span
...
function funDelete(id) {
	var con = confirm('Are you sure delete this division?');
	if(con==true) {
		var url = "{{ url('division/delete/') }}";
