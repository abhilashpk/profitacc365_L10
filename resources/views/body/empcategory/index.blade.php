                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> Employee Category List
                        </h3>
                        <div class="pull-right">
							<a href="{{ url('emp_category/add') }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>
											<button class="btn btn-primary btn-xs" onClick="location.href='{{ url('emp_category/edit/'.$category->id) }}'"><span
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "{{ url('emp_category/delete/') }}";
