...
class StiEmailSettings {
	...
	public $from = 'accounts@numaktech.com';

	/** Name and surname of the sender */
	public $name = "Numaktech";
	...
	public $host = 'mail.numaktech.com';
	...
	public $login = 'accounts@numaktech.com';

	/** Password */
	public $password = 'accountsnumaktech@123';
}
